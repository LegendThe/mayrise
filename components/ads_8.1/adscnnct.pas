...
{$ENDIF}
               ...
               ftAutoInc:
               begin
                  ACECheck( nil, ACE.AdsSetString( StmtHandle, ADSFIELD( I + 1 ), PAceChar( AnsiString( Params[i].AsString ) ),
               ...
               begin
                  ...
                  ACECheck( nil, ACEUNPUB.AdsSetTimeStampRaw( StmtHandle, ADSFIELD( I + 1 ),
                                                    PAceChar( @stDateType ),
                                                    sizeof( stDateType )));
               end;
               ...
               ftCurrency,
               ftFloat:
                  ACECheck( nil, AdsSetDouble( StmtHandle, ADSFIELD( I + 1 ),
                                          Params[i].AsFloat ));
...
*                 object.
*****************************************************************************}
procedure TAdsConnection.SetHandle( hConnection : ADSHANDLE );
var aucConnectPath : array[0..ADS_MAX_PATH] of AceChar;
    usLen : UNSIGNED16;
    ulLen : UNSIGNED32;
    ulRetVal : UNSIGNED32;
begin
