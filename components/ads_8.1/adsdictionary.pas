...
{$ENDIF}
   ...
   published
      ...
      property IsConnected:  Boolean read FConnected write SetConnected;
...
{$ENDIF}
            ...
            if (( usConnectionType <> ADS_DATABASE_CONNECTION ) and
                ( usConnectionType <> ADS_SYS_ADMIN_CONNECTION )) then
            begin
