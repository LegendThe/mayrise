...
type
   ...
   protected
      ...
      FNumCachedTables:       ShortInt;
      FNumCachedCursors:      ShortInt;
      ...
      procedure SetNumCachedTables( Value : ShortInt ); virtual;
      procedure SetNumCachedCursors( Value : ShortInt ); virtual;
   ...
   published
      ...
      property NumDecimals:  ShortInt read FNumDecimals write SetNumDecimals;
      property SetDelphiDate: Boolean read FSetDelphiDate write SetFSetDelphiDate;
      property ShowDeleted:  Boolean read FShowDeleted write SetShowDeleted;
      property AdsServerTypes: TAdsServerTypes read FAdsServerTypes write SetAdsServerTypes;
      property NumCachedTables: ShortInt read FNumCachedTables write SetNumCachedTables;
      property NumCachedCursors: ShortInt read FNumCachedCursors write SetNumCachedCursors;
...
*  Description    :
*******************************************************************************}
procedure TAdsSettings.SetNumCachedTables( Value : ShortInt );
var
   ulRetVal : UNSIGNED32;
begin
   if ( Value < 0 ) then
      raise Exception.Create( 'NumCachedTables value must be greater than zero.' );
...
*  Description    :
*******************************************************************************}
procedure TAdsSettings.SetNumCachedCursors( Value : ShortInt );
var
   ulRetVal : UNSIGNED32;
begin
   if ( Value < 0 ) then
      raise Exception.Create( 'NumCachedCursors value must be greater than zero.' );
