{
//
// Components : TwwPrpEdtiComboList - Design time
//
...
uses Windows, Classes, Graphics, Forms, Controls, Buttons,
  StdCtrls, Grids, dialogs, sysutils, wwstr, ExtCtrls;
...
Function wwEditComboList(AItems: TStrings;
          var AMapList: boolean): boolean;
...
//          combobox:= combo;
          ...
          if (showModal = mrOK) then begin
             AMapList := SeparateStoredList.checked;
             if Amaplist then begin
                with stringGrid1 do begin
                   Items.clear;
...
begin
   ...
   if MapList then with StringGrid1 do begin
