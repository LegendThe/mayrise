...
//
//
// 1/25/99 -  Support View Summary caption.  Previously it was set in
//            the wrong method/event.
}
unit Wwfltvw;
{$i wwIfDef.pas}
...
begin
   ...
   with TwwFilterDialogView.create(Application) do begin
      ...
      // 1/25/99 -  Support View Summary caption. 
      {$ifdef wwdelphi4up}
      if wwInternational.FilterDialog.SummaryCaption<>'' then
         Caption:= wwInternational.FilterDialog.SummaryCaption;
      {$endif}
