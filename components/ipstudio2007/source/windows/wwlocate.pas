...
type
  ...
  TwwLocateSelectFieldEvent = procedure(Dialog: TwwLocateDlg; SearchField: string) of object;
  TwwLocateDlgOption = (ldoCaseSensitiveBelow, ldoCloseOnMatch, ldoPreserveSearchText);
  TwwLocateDlgOptions = Set of TwwLocateDlgOption;
...
//     FUseLocateMethod: boolean;
  ...
  published
     ...
     property Options : TwwLocateDlgOptions read FOptions write FOptions default [ldoCloseOnMatch];
