...
begin
  ...
  SetWindowPos(FListbox.Handle, 0, 0, 0, 0, 0, SWP_NOZORDER or {HWND_TOPMOST or} // Remove topmost
...
begin
  inherited;
  CloseUp(True);
  if assigned(FHistoryList) and FHistoryList.Enabled and Modified then
  begin
     AddItem(Text, True);
     HistoryList.Save;
  end
