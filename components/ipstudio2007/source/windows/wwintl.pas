...
begin
   ...
   {$ifdef IPTRIAL}
   FIPVersion:= 'IPStudioWin 5.0.3.4 Trial ';
   {$else}
   FIPVersion:= 'IPStudioWin 5.0.3.4';
   {$endif}
   ...
   if csDesigning in ComponentState then begin
      ...
      FRegistrationNo:=
         ipreg.ReadString('\Software\Woll2Woll\InfoPower2007', 'Reg. No.', '');
      ipreg.free;
   end;
   {$endif}
   ...
   begin
      ...
      FPrintPreviewButtonHint := 'Print Preview | Print Preview the active document';      
      ...
      FFormatCaptionHint:= 'Format | Formats the current selection';
