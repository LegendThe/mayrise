...
protected:
	...
	HIDESBASE virtual void __fastcall SetSelText(AnsiString value);
...
public:
	...
	int ClickTime;
	int TotalPages;
	HIDESBASE virtual int __fastcall FindText(const AnsiString SearchStr, int StartPos, int Length, Comctrls::TSearchTypes Options);
	...
	void __fastcall StartMSWordMonitoring(AnsiString TempFileName);
