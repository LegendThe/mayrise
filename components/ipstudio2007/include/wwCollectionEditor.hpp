...
// (DO NOT EDIT: machine generated header) 'Wwcollectioneditor.pas' rev: 11.00
...
protected:
	...
	AnsiString __fastcall GetItemText(Wwcollection::_di_IwwCollectionItem Item);
...
//-- var, const, procedure ---------------------------------------------------
#define swwInvalidParameter "Parameter %s of %s cannot be %s"
extern PACKAGE TwwCollectionEditorForm* wwCollectionEditorForm;
extern PACKAGE void __fastcall wwExecuteCollectionEditor(AnsiString ACaption, Designintf::_di_IDesigner ADesigner, Wwcollection::_di_IwwCollection ACollection, TwwCollectionCustomizeEvent CustomizeEvent);
