...
// (DO NOT EDIT: machine generated header) 'Wwdbigrd.pas' rev: 11.00
...
typedef Set<TwwDittoOption, wwdoSkipBlobFields, wwdoSkipHiddenFields>  TwwDittoOptions;
...
typedef void __fastcall (__closure *TwwDittoEvent)(System::TObject* Sender, Db::TDataSet* DataSet, Db::TField* Field, AnsiString &DittoValue, bool &AllowDitto);
