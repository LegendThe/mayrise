...
// (DO NOT EDIT: machine generated header) 'Wwintl.pas' rev: 11.00
...
private:
	...
	AnsiString FPrintPreviewCaption;
...
__published:
	...
	__property AnsiString PrintPreviewCaption = {read=FPrintPreviewCaption, write=FPrintPreviewCaption};
...
private:
	...
	AnsiString FPrintPreviewButtonHint;
...
__published:
	...
	__property AnsiString PrintPreviewButtonHint = {read=FPrintPreviewButtonHint, write=FPrintPreviewButtonHint};
	...
	__property AnsiString FormatCaptionHint = {read=FFormatCaptionHint, write=FFormatCaptionHint};
