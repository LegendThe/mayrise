...
// (DO NOT EDIT: machine generated header) 'Wwprppic.pas' rev: 11.00
...
__published:
	...
	void __fastcall wwLookupDialog1UserButton1Click(System::TObject* Sender, Db::TDataSet* LookupTable);
