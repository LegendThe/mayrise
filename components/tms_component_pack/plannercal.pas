...
uses
  ...
  Forms, ExtCtrls, AdvStyleIF, AdvImage;
...
type
  ...
  published
    ...
    property EventFont: TFont read FEventFont write SetFont;
...
procedure TCustomCalendarPanel.SetFont(const Value: TFont);
begin
