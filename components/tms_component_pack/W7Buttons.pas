...
begin
  ...
  begin
    DestRect := Rect(Width div 2 - TotalWidth div 2 + IconDelta + PushedDelta, Height div 2 - TextHeight div 2 + PushedDelta - 1, Width div 2 - TotalWidth div 2 + IconDelta + PushedDelta + TextWidth, Height div 2 + TextHeight div 2 + PushedDelta);
  end;
