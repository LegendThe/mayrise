...
uses
  ...
  AdvGDIP, axCtrls, ImgList, GDIPPictureContainer;
...
begin
  ...
  begin
    ...
    begin
      ARect.Bottom := ARect.Bottom - Round(GetFooterRect.Height);
      ARect.Top := ARect.Top + Round(GetHeaderRect.Height);
    end;
  end;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            TAdvSmoothPage(FPages[PageIndex]).BringToFront;
          end;
        end;
      end;
    end;
