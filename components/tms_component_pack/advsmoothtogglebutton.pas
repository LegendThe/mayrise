...
begin
  ...
  begin
    path := CreateRoundRectangle(MakeRect(x, y, w, h), Appearance.Rounding-1, rtBoth, false);
  ...
  begin
    path := CreateRoundRectangle(MakeRect(x, y, w - 1, h - 1), Appearance.Rounding-1, rtBoth, false);
