...
type
  ...
  published
    ...
    property AnimationFactor: Integer read FAnimationFactor write SetAnimationFactor default 1;
...
begin
  ...
  begin
    frmC.AlphaBlendValue := max(0, frmC.AlphaBlendValue - AnimationFactor);
...
begin
  ...
  begin
    frmC.AlphaBlendValue := min(255, frmC.AlphaBlendValue + AnimationFactor);
    frm.UpdateMainWindow;
    Sleep(1);
