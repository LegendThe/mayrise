...
uses
  ...
  AdvHintInfo, AdvGlowButton, ACXPVS, AdvDWM, AdvStyleIf;
...
begin
  ...
  begin
    ...
    begin
      ...
      ActItem := FAdvOfficeTabs.Items[i];
      InvalidateTab(-1);
      ...
      begin
        ...
        begin
          ...
          if FAdvOfficeTabs.Items[ActTabIndex].FCloseButton <> nil then
          begin
            FAdvOfficeTabs.Items[ActTabIndex].FCloseButton.Free;
            FAdvOfficeTabs.Items[ActTabIndex].FCloseButton := nil;
          end;

          if FAdvOfficeTabs.Items[ActTabIndex].FCloseButtonChrome <> nil then
          begin
            FAdvOfficeTabs.Items[ActTabIndex].FCloseButtonChrome.Free;
            FAdvOfficeTabs.Items[ActTabIndex].FCloseButtonChrome := nil;
          end;
        ...
        begin
          ...
          if (FAdvOfficeTabs.Items[ActTabIndex].FCloseButton = Sender) then
          begin
            RemoveControl(Sender as TAdvGlowButton);
            FAdvOfficeTabs.Items[ActTabIndex].FCloseButton := nil;
          end;

          if (FAdvOfficeTabs.Items[ActTabIndex].FCloseButtonChrome = Sender) then
          begin
      ...
      begin
        ...
        if CloseOnTab then
        begin
          if Assigned(FAdvOfficeTabs.Items[ActTabIndex].FCloseButton) then
            FAdvOfficeTabs.Items[ActTabIndex].FCloseButton.Visible := false;

          if Assigned(FAdvOfficeTabs.Items[ActTabIndex].FCloseButtonChrome) then
            FAdvOfficeTabs.Items[ActTabIndex].FCloseButtonChrome.Visible := false;
        end;
        UpdateClosedListButton;
      end;
