  ...
  begin
    ...
    begin
      ...
      try
        ...
        AFill.BorderColor := clNone;
        AFill.BorderWidth := 0;
        AFill.Fill(g, MakeRect(0, 0, Round(tr.Width - pw), 0 + Texth));
      finally
        AFill.Free;
      end;
    end;
...
begin
  ...
  if (pt.y < 20) and (pt.x < r.right) and (pt.X > r.Left) and (Msg.Result = htClient) and FCanMove then
  begin
    MouseMove([],pt.X,pt.Y);
