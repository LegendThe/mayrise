...
uses
  ...
  GDIPPictureContainer, ImgList, Math, Messages, Forms, AdvGDIP, ExtCtrls;
...
begin
  ...
  begin
    ...
    pth := CreateRoundRectangle(rpr, 4, rtBoth, False);
    g.SetClip(pth);
...
//  app.BackGroundFill.FocusColor := app.BackGroundFill.BorderColor;
  ...
  begin
    pth := CreateRoundRectangle(MakeRect(r.X, r.Y, r.Width, r.Height), FOwner.Appearance.LayoutRounding, rtBoth, False);
