...
begin
  ...
  begin
    ...
    if FSliderDownPt.X < PtX then
      ref := FSliderDownPt.X  - GetThumbPointerPos{Thumb.Width div 2}
    else
      ref := FSliderDownPt.X;
  ...
  begin
    ...
    if FSliderDownPt.Y < PtY then
      ref := FSliderDownPt.Y
    else
      ref := FSliderDownPt.Y  + GetThumbPointerPos{Thumb.Width div 2};
