...
begin
  ...
  begin
    //if (Parent as TAdvToolBarPager).Caption.Visible then
      //Result := (Parent as TAdvToolBarPager).Caption.Height;
    if IsWin7 then
    begin
      if (Parent as TAdvToolBarPager).Caption.Visible then
...
begin
  ...
  if FIsAeroVista  then
    ...
    Result := (Parent as TAdvToolBarPager).Parent.Height - (Height + c + Top {GetSystemMetrics(SM_CYCAPTION)} + GetSystemMetrics(SM_CXSIZEFRAME) * 2 + bw * 2);
