...
uses
  ...
  Commctrl, Forms, PictureContainer, Dialogs, Printers, Comobj, ActiveX
{$IFDEF TMSCODESITE}
  , CSIntf
{$ENDIF}
{$IFDEF DELPHI6_LVL}
...
const
  ...
  BLD_VER = 0; // Build nr.
  DATE_VER = 'May, 2012'; // Month version
...
begin
  ...
  SendMessage(TAdvListView(Item1.ListView).Handle, LVM_GETCOLUMNORDERARRAY, iCount, longint(@parr));
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            taCenter: rect.Left := rect.Left + ((Columns[parr[i + 1]].Width - SmallImages.Width - (FCanvas.TextWidth(s))) div 2);
            taRightJustify: rect.Left := rect.Left + Columns[parr[i + 1]].Width - SmallImages.Width - FCanvas.TextWidth(s) - 2;
            end;
        ...
        begin
          ...
          begin
            DrawTextEx(FCanvas.Handle, PChar(s), Length(s), DrwRect,
              ...
              or fValign) or Alignments[Columns[parr[i + 1]].Alignment], @dtp);
          end;
        end;
      ...
      try
        ...
        begin
          ...
          HTMLDraw(FCanvas, s, r, TImagelist(smallimages),
            0, 0, true, true, false, false, true, 0.0, fURLColor, anchor, stripped, xsize, ysize);
          s := Stripped;
        end;
