...
begin
  ...
  0:begin
      ...
      MessageDlg(Component.ClassName+' version '+ (Component as TCustomPlanner).VersionString + ' for ' + compiler + #13#10#13#10'© 1999-2012 by TMS software'#13#10'http://www.tmssoftware.com',
