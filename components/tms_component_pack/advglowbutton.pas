...
function DrawVistaButton(Owner: TControl; Canvas: TCanvas; r: TRect; CFU, CTU, CFB, CTB, PC: TColor;
   ...
   Images: TCustomImageList; ImageIndex: Integer; EnabledImage: Boolean; Layout: TButtonLayout;
   ...
   Trimming: TStringTrimming;Notes: TStringList; NotesFont: TFont;Checked, Down, TranspHover, GDIPArrow: boolean): TSize;
var
  graphics : TGPGraphics;
  w,h,h2,h2d: Integer;
...
begin
  ...
  begin
   ...
   // stringFormat.SetAlignment(StringAlignmentCenter);
    ...
    if HideAccelFlag(Owner) = DT_HIDEPREFIX then
    ...
    begin
      ...
      begin
        ...
        notesRect.Right := notesRect.Left + round(rectf.Width);
...
//              ImgY := round(sizeRect.Y);
      ...
      begin
        ...
        begin
          ...
          if Caption <> '' then
            DrawText(Canvas.Handle, PChar(Caption), Length(Caption), tdrect, uformat or HideAccelFlag(Owner))
          else
            DrawTextW(Canvas.Handle, PWideChar(WideCaption), Length(WideCaption), tdrect, uformat or HideAccelFlag(Owner));
  ...
  //            PenColor := BlendColor(BorderColorDown, BorderColorChecked, FStepPush);
      ...
      begin
        ...
        sz := DrawVistaButton(Self, Canvas, ClientRect, GradColor, GradColorTo, GradColorMirror, GradColorMirrorTo,
          ...
          DrawDwLn, Enabled, DrawFocused, DropDownPosition, Pic, FIcon, PicSize, AntiAlias, FDefaultPicDrawing, bmp, BD, FStaticButton or Transparent and not (FMouseEnter or DrawFocusedHot or (State = absDown)), FMouseEnter, Position, DropDownSplit, CanDrawBorder,
          FOverlappedText, FWordWrap, True, FRounded, FDropDownDirection = ddDown, FSpacing, FTrimming, FNotes, FNotesFont, FDownChecked, FDroppedDown, TranspHover and Transparent, InternalIsOnGlassQAT);
      ...
      sz := DrawVistaButton(Self, Canvas,ClientRect,GradColor, GradColorTo, GradColorMirror, GradColorMirrorTo,
        ...
        False, FRounded, FDropDownDirection = ddDown, FSpacing, FTrimming, FNotes, FNotesFont, FDownChecked, FDroppedDown, TranspHover and Transparent, InternalIsOnGlassQAT);
...
begin
  Appearance.TranspHover := (AStyle in [tsOffice2010Blue, tsOffice2010Silver, tsOffice2010Black]);
