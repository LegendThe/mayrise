...
begin
  ...
  begin
    ...
    {DecodeTime(FDateTimePicker.DateTime, h, m, s, ms);
    FAdvWatch.FInternalCall := True;
    FAdvWatch.SetMinute(m);
    FAdvWatch.SetHour(h);
    FAdvWatch.FInternalCall := False;
    }
  end;
end;
...
begin
  ...
  //OutputDebugString(PChar('Time........... ' + Text+':'+inttostr(length(Trim(text)))));
      ...
      begin
        ...
        begin
          ...
          try
            ...
            try
              path.AddLine(CP.X - 1 - (Sin((h * 30 + m / 12 * 6) * PI / 180)) * rd * 0.1,
                          CP.Y + 3 - (-Cos((h * 30 + m / 12 * 6) * PI / 180)) * rd * 0.1,
        ...
        try
          ...
          try
            path.AddLine(CP.X - (Sin((h * 30 + m / 12 * 6) * PI / 180)) * rd * 0.1,
                        CP.Y - (-Cos((h * 30 + m / 12 * 6) * PI / 180)) * rd * 0.1,
        ...
        begin
          ...
          try
            ...
            try
              path.AddLine(CP.X - (Sin(m * 6 * PI / 180)) * rd * 0.1,
                          CP.Y + 3- (-Cos(m * 6 * PI / 180)) * rd * 0.1,
