...
uses
  Classes, Windows, Graphics, Messages, Controls, Forms, SysUtils, AdvStyleIF, AppEvnts;
...
begin
  ...
  begin
    ...
    DrawText(Canvas.Handle,PChar(Text),Length(Text), R2, DT_CALCRECT or DT_TOP or DT_LEFT or DT_SINGLELINE);
