  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            FImage.GDIPDraw(g, Bounds(SaveRound(r.X), SaveRound(R.Y), SaveRound(R.Width), SaveRound(R.Height)));
    ...
    begin
      ...
      begin
        ...
        if Assigned(FImage) and not FImage.Empty then
          FImage.GDIPDraw(g, Bounds(SaveRound(r.X - r.Width / 2), SaveRound(r.Y - R.Height / 2), SaveRound(R.Width), SaveRound(R.Height)));
      end;
    end;
    //
    foc.free;
...
begin
  ...
  begin
    ...
    i := Max(0, Min(Items.Count - 1, FSel));
    ...
    Fsel := Max(0, Min(Items.Count - 1, i));
