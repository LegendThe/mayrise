...
begin
  ...
  begin
    ...
    pth := CreateRoundRectangle(plr, phbr, rtBoth, false);
    plrinner := MakeRect(plr.X + phbw, plr.Y + phbw, plr.Width - phbw * 2,
      plr.Height - phbw * 2);
    pthinner := CreateRoundRectangle(plrinner, phbr, rtBoth, false);
...
begin
  ...
  if (csDesigning in ComponentState) and (FAdvPolyPages.Count = 0) then
  begin
