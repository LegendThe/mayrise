...
begin
  ...
  begin
    ...
    begin
      ...
      Canvas.Draw(x, R.Top + (R.Bottom - R.Top - Items[Index].Image.Height) div 2, Items[Index].Image.Graphic);
    ...
    begin
      ...
      Images.Draw(Canvas, x, R.Top + (R.Bottom - R.Top - Images.Height) div 2, Items[Index].ImageIndex);
