...
#pragma option push -b-
enum TCaptionPosition { cpTop, cpLeft, cpRight };
#pragma option pop
...
public:
	...
	tagSIZE __fastcall GetHTMLSize();
	void __fastcall BeginUpdate(void);
	void __fastcall EndUpdate(void);
	...
	__property Imglist::TImageIndex ImageIndex = {read=FImageIndex, write=FImageIndex, nodefault};
...
private:
	...
	int FOldWidth;
	int FOldHeight;
	Classes::TNotifyEvent FOnArrangedControls;
	HIDESBASE MESSAGE void __fastcall WMSize(Messages::TMessage &Msg);
...
protected:
	...
	virtual void __fastcall DoArrangedControls(void);
...
__published:
	...
	__property Classes::TNotifyEvent OnArrangedControls = {read=FOnArrangedControls, write=FOnArrangedControls};
public:
	#pragma option push -w-inl
