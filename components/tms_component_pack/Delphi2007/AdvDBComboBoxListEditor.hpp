...
// (DO NOT EDIT: machine generated header) 'Advdbcomboboxlisteditor.pas' rev: 11.00
...
__published:
	...
	void __fastcall sg_ComboListKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
