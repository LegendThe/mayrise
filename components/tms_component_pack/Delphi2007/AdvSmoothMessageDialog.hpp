...
// (DO NOT EDIT: machine generated header) 'Advsmoothmessagedialog.pas' rev: 11.00
...
typedef void __fastcall (__closure *TAdvSmoothMessageDialogAnchorClick)(System::TObject* Sender, AnsiString Anchor);
...
private:
	...
	void __fastcall SetMaximumHeight(const int Value);
	void __fastcall SetMaximumWidth(const int Value);
	void __fastcall SetTimeOut(const int Value);
...
protected:
	...
	void __fastcall ShowForm(System::TObject* Sender);
	void __fastcall FillChanged(System::TObject* Sender);
	void __fastcall ButtonsChanged(System::TObject* Sender);
	void __fastcall Fontchanged(System::TObject* Sender);
	AnsiString __fastcall DrawHTMLText(Advgdip::TGPGraphics* g, TAdvSmoothMessageDialogHTMLText* HTML, const Advgdip::TGPRectF &r, AnsiString str, bool DoAnchor = false, int fX = 0xffffffff, int fY = 0xffffffff);
	...
	AnsiString __fastcall GetAnchorAt(Advgdip::TGPGraphics* g, int X, int Y, const Types::TRect &R);
	...
	bool __fastcall HasCancel(void);
...
public:
	...
	TAdvSmoothMessageDialogForm* __fastcall GetForm(void);
	void __fastcall CloseDialog(void);
	
__published:
	__property int MaximumWidth = {read=FMaximumWidth, write=SetMaximumWidth, default=10000};
	__property int MaximumHeight = {read=FMaximumHeight, write=SetMaximumHeight, default=10000};
	__property bool Modal = {read=FModal, write=SetModal, default=1};
	__property Forms::TFormStyle FormStyle = {read=FFormStyle, write=SetFormStyle, default=0};
...
extern PACKAGE int __fastcall SmoothMessageDlg(const AnsiString Title, const AnsiString Msg, Dialogs::TMsgDlgType DlgType, Dialogs::TMsgDlgButtons Buttons, int HelpCtx, Advstyleif::TTMSStyle AStyle = (Advstyleif::TTMSStyle)(0x4))/* overload */;
extern PACKAGE int __fastcall SmoothMessageDlg(const AnsiString Title, const AnsiString Msg, Dialogs::TMsgDlgType DlgType, Dialogs::TMsgDlgButtons Buttons, int HelpCtx, Dialogs::TMsgDlgBtn DefaultButton, Advstyleif::TTMSStyle AStyle = (Advstyleif::TTMSStyle)(0x4))/* overload */;
extern PACKAGE int __fastcall SmoothMessageDlgPos(const AnsiString Title, const AnsiString Msg, Dialogs::TMsgDlgType DlgType, Dialogs::TMsgDlgButtons Buttons, int HelpCtx, int X, int Y, Advstyleif::TTMSStyle AStyle = (Advstyleif::TTMSStyle)(0x4))/* overload */;
extern PACKAGE int __fastcall SmoothMessageDlgPos(const AnsiString Title, const AnsiString Msg, Dialogs::TMsgDlgType DlgType, Dialogs::TMsgDlgButtons Buttons, int HelpCtx, int X, int Y, Dialogs::TMsgDlgBtn DefaultButton, Advstyleif::TTMSStyle AStyle = (Advstyleif::TTMSStyle)(0x4))/* overload */;
extern PACKAGE void __fastcall ShowSmoothMessage(const AnsiString Msg, Advstyleif::TTMSStyle AStyle = (Advstyleif::TTMSStyle)(0x4));
