...
#pragma option push -b-
enum TTimeIndicatorType { tiLine, tiGlyph, tiLineGlyph };
#pragma option pop
...
public:
	...
	AnsiString __fastcall GetGroupCaption(int Pos);
...
private:
	...
	void __fastcall SetCompletionFormat(const AnsiString value);
...
__published:
	...
	__property AnsiString CompletionFormat = {read=FCompletionFormat, write=SetCompletionFormat};
...
protected:
	...
	bool __fastcall MatchItem(TPlannerItem* Item, AnsiString s, TFindTextParams Param);
...
public:
	...
	TPlannerItem* __fastcall FindKey(AnsiString DBKey);
	TPlannerItem* __fastcall HeaderFirst(int ItemPos);
	TPlannerItem* __fastcall HeaderNext(int ItemPos);
	TPlannerItem* __fastcall FindText(TPlannerItem* StartItem, AnsiString s, TFindTextParams Param);
...
private:
	...
	int FWidth;
	AnsiString FSidebarFontTag;
	AnsiString FHeaderFontTag;
	AnsiString FCellFontTag;
...
__published:
	...
	__property AnsiString CellFontTag = {read=FCellFontTag, write=FCellFontTag};
	__property Graphics::TFontStyles CellFontStyle = {read=FCellFontStyle, write=FCellFontStyle, nodefault};
	__property AnsiString HeaderFontTag = {read=FHeaderFontTag, write=FHeaderFontTag};
	__property Graphics::TFontStyles HeaderFontStyle = {read=FHeaderFontStyle, write=FHeaderFontStyle, nodefault};
	__property AnsiString SidebarFontTag = {read=FSidebarFontTag, write=FSidebarFontTag};
...
typedef void __fastcall (__closure *TSidebarHintEvent)(System::TObject* Sender, int Index, AnsiString &AHint);

typedef void __fastcall (__closure *THeaderEditEvent)(System::TObject* Sender, int SectionIndex, AnsiString &Text);
...
typedef void __fastcall (__closure *THeaderAnchorEvent)(System::TObject* Sender, int SectionIndex, AnsiString Anchor);
...
private:
	...
	void __fastcall SaveToHTMLCol(AnsiString Filename, bool Unicode = false);
	void __fastcall SaveToHTMLRow(AnsiString Filename, bool Unicode = false);
...
protected:
	...
	virtual void __fastcall CreateWnd(void);
	virtual void __fastcall Paint(void);
	virtual AnsiString __fastcall GetDayName(int WeekDay);
	...
	virtual void __fastcall HeaderAnchorEnter(System::TObject* Sender, int SectionIndex, AnsiString Anchor);
	virtual void __fastcall HeaderAnchorClick(System::TObject* Sender, int SectionIndex, AnsiString Anchor);
	virtual void __fastcall HeaderAnchorLeave(System::TObject* Sender, int SectionIndex, AnsiString Anchor);
	...
	void __fastcall DoHeaderHint(System::TObject* Sender, int Index, AnsiString &HintStr);
	void __fastcall DoFooterHint(System::TObject* Sender, int Index, AnsiString &HintStr);
	...
	virtual AnsiString __fastcall HTMLDBReplace(TPlannerItem* APlannerItem, System::TObject* Data);
...
public:
	...
	void __fastcall SaveToHTML(AnsiString Filename, bool Unicode = false);
	void __fastcall SaveToBMP(AnsiString Filename, const tagSIZE &Size);
	...
	void __fastcall LoadFromFile(AnsiString Filename);
	void __fastcall InsertFromFile(AnsiString Filename);
	void __fastcall SavePositionToFile(AnsiString Filename, int Position);
	void __fastcall LoadPositionFromFile(AnsiString Filename, int Position);
	void __fastcall SaveLayerToFile(AnsiString Filename, int Layer);
	void __fastcall LoadLayerFromFile(AnsiString Filename, int Layer);
	...
	AnsiString __fastcall PlanTimeToStr(int MinutesValue);
	void __fastcall PlanTimeToStrings(int MinutesValue, AnsiString &HoursString, AnsiString &MinutesString, AnsiString &AmPmString);
	...
	void __fastcall MarkInItem(TPlannerItem* APlannerItem, AnsiString AText, bool DoCase);
	void __fastcall MarkInPositon(int Pos, AnsiString AText, bool DoCase);
	void __fastcall MarkInItems(AnsiString AText, bool DoCase);
	...
	void __fastcall HilightInItem(TPlannerItem* APlannerItem, AnsiString AText, bool DoCase);
	void __fastcall HilightInPositon(int Pos, AnsiString AText, bool DoCase);
	void __fastcall HilightInItems(AnsiString AText, bool DoCase);
...
public:
	virtual bool __fastcall HandleAlarm(AnsiString Address, AnsiString Message, int Tag, int ID, TPlannerItem* Item);
public:
	#pragma option push -w-inl
...
private:
	...
	AnsiString __fastcall GetItemText();
	void __fastcall SetWordWrap(const bool value);
	void __fastcall SetAttachement(const AnsiString value);
	...
	AnsiString __fastcall GetStrippedItemText();
	...
	AnsiString __fastcall GetNotes();
	...
	void __fastcall SetWideText(const WideString value);
	void __fastcall SetWideCaption(const WideString value);
...
protected:
	...
	Types::TRect __fastcall GetGridRect();
	Types::TRect __fastcall GetItemRect();
	Types::TRect __fastcall GetItemPaintRect();
	...
	void __fastcall SetControlVal(AnsiString ID, AnsiString AValue);
	AnsiString __fastcall GetControlVal(AnsiString ID);
...
public:
	...
	WideString __fastcall GetWideCaptionString();
	...
	__property AnsiString ControlValue[AnsiString index] = {read=GetControlVal, write=SetControlVal};
	...
	__property AnsiString ItemText = {read=GetItemText};
	__property AnsiString StrippedItemText = {read=GetStrippedItemText};
	...
	__property AnsiString LinkedDBKey = {read=FLinkedDBKey, write=FLinkedDBKey};
	...
	__property AnsiString NotesText = {read=GetNotes};
...
__published:
	...
	__property AnsiString Attachement = {read=FAttachement, write=SetAttachement};
	...
	__property WideString WideCaption = {read=FWideCaption, write=SetWideCaption};
	__property WideString WideText = {read=FWideText, write=SetWideText};
...
static const Shortint BLD_VER = 0xf;
#define DATE_VER "Nov, 2012"
#define s_QuickConfig "Quick config"
#define s_HTimeAxis "Horizontal time axis"
#define s_VTimeAxis "Vertical time axis"
#define s_ShowDesignItem "Show design item"
#define s_HideDesignItem "Hide design item"
extern PACKAGE AnsiString s_Modes[6];
extern PACKAGE Word CF_PLANNERITEM;
...
extern PACKAGE AnsiString __fastcall PlannerGetIdCol(TCustomPlanner* Planner, int Index, int Position);
