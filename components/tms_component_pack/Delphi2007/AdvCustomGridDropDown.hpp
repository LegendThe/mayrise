...
// (DO NOT EDIT: machine generated header) 'Advcustomgriddropdown.pas' rev: 11.00
...
typedef void __fastcall (__closure *TGetCellTextEvent)(System::TObject* Sender, int Column, int Row, AnsiString &Text);
...
#pragma option push -b-
enum TLookupMethod { lmLookup, lmNarrowDown, lmNone };
#pragma option pop
...
private:
	...
	void __fastcall OnColGridKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	...
	void __fastcall SetBands(const Advobj::TBands* Value);
...
protected:
	...
	virtual void __fastcall DoGridAnchorClick(System::TObject* Sender, int ARow, int ACol, AnsiString Anchor, bool &AutoHandle);
	virtual void __fastcall DoGridAnchorEnter(System::TObject* Sender, int ARow, int ACol, AnsiString Anchor);
	virtual void __fastcall DoGridAnchorExit(System::TObject* Sender, int ARow, int ACol, AnsiString Anchor);
	virtual void __fastcall DoGridAnchorHint(System::TObject* Sender, int ARow, int ACol, AnsiString &Anchor);
	...
	virtual void __fastcall DoGridCustomCompare(System::TObject* Sender, AnsiString str1, AnsiString str2, int &Res);
	...
	virtual void __fastcall DoGridCellBalloon(System::TObject* Sender, int ACol, int ARow, AnsiString &ATitle, AnsiString &AText, int &AIcon);
	...
	virtual void __fastcall DoGridGetFloatFormat(System::TObject* Sender, int ACol, int ARow, bool &IsFloat, AnsiString &FloatFormat);
	...
	virtual void __fastcall DoGridEllipsClick(System::TObject* Sender, int ACol, int ARow, AnsiString &S);
	virtual void __fastcall DoGridGetDisplText(System::TObject* Sender, int ACol, int ARow, AnsiString &Value);
	virtual void __fastcall DoGridGetFormat(System::TObject* Sender, int ACol, Advobj::TSortStyle &AStyle, AnsiString &aPrefix, AnsiString &aSuffix);
	virtual void __fastcall DoGridHint(System::TObject* Sender, int ARow, int ACol, AnsiString &hintstr);
	...
	virtual void __fastcall DoGridKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	virtual void __fastcall DoGridKeyUp(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	virtual void __fastcall DoGridKeyPress(System::TObject* Sender, char &Key);
	virtual void __fastcall DoGridRightClickCell(System::TObject* Sender, int ARow, int ACol);
	virtual void __fastcall DoGridScrollHint(System::TObject* Sender, int ARow, AnsiString &hintstr);
	virtual void __fastcall DoGridTopLeftChanged(System::TObject* Sender);
	virtual void __fastcall DoGridSearchEditChange(System::TObject* Sender, AnsiString Value, bool &DefaultSearch);
	...
	bool __fastcall LookupInColumn(AnsiString Value, AnsiString &lookup, int &Row);
	int __fastcall DoKeyLookup(char ch);
