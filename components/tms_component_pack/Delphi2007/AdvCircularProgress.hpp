...
// (DO NOT EDIT: machine generated header) 'Advcircularprogress.pas' rev: 11.00
...
private:
	Advgdip::TGPGraphicsPath* FSegPath[12];
...
protected:
	...
	Types::TRect __fastcall GetInnerCircleRect();
