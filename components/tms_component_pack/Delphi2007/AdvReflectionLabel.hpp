...
// (DO NOT EDIT: machine generated header) 'Advreflectionlabel.pas' rev: 11.00
...
public:
	...
	void __fastcall SaveToFile(AnsiString FileName, TImageType ImageType = (TImageType)(0x0));
