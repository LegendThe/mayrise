...
public:
	...
	__property bool TranspHover = {read=FTranspHover, write=FTranspHover, nodefault};
...
__published:
	...
	__property Graphics::TColor TextColorHot = {read=FTextColorHot, write=SetTextColorHot, default=0};
...
private:
	...
	bool FInternalIsOnGlassQAT;
	Advstyleif::TTMSStyle FCompStyle;
...
protected:
	...
	__property bool InternalIsOnGlassQAT = {read=FInternalIsOnGlassQAT, write=FInternalIsOnGlassQAT, nodefault};
	...
	__property bool KeepDown = {read=FKeepDown, write=FKeepDown, nodefault};
