...
// (DO NOT EDIT: machine generated header) 'Advfocushelper.pas' rev: 11.00
...
public:
	...
	virtual void __fastcall ShowHelperOnControl(const Types::TRect &R);
...
__published:
	...
	__property Byte Opacity = {read=FOpacity, write=FOpacity, default=180};
	__property Byte Rounding = {read=FRounding, write=FRounding, default=5};
