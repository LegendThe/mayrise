...
// (DO NOT EDIT: machine generated header) 'Advsmoothtimeline.pas' rev: 11.00
...
private:
	...
	int FScrollStep;
	bool FAutoDivisions;
	int FAutoDivisionSpacing;
	int FAutoSubDivisionSpacing;
	bool FAutoSubDivisions;
	...
	void __fastcall SetAutoDivisions(const bool Value);
	void __fastcall SetAutoDivisionSpacing(const int Value);
	void __fastcall SetAutoSubDivisions(const bool Value);
	void __fastcall SetAutoSubDivisionSpacing(const int Value);
...
__published:
	__property int AutoDivisionSpacing = {read=FAutoDivisionSpacing, write=SetAutoDivisionSpacing, default=10};
	__property bool AutoDivisions = {read=FAutoDivisions, write=SetAutoDivisions, default=0};
	__property bool AutoSubDivisions = {read=FAutoSubDivisions, write=SetAutoSubDivisions, default=0};
	__property int AutoSubDivisionSpacing = {read=FAutoSubDivisionSpacing, write=SetAutoSubDivisionSpacing, default=10};
...
private:
	...
	AnsiString FDivisionFormat;
	AnsiString FSubDivisionFormat;
	int FIndentSpacing;
	...
	void __fastcall SetDivisionFormat(const AnsiString Value);
	void __fastcall SetSubDivisionFormat(const AnsiString Value);
...
__published:
	...
	__property AnsiString DivisionFormat = {read=FDivisionFormat, write=SetDivisionFormat};
	__property AnsiString SubDivisionFormat = {read=FSubDivisionFormat, write=SetSubDivisionFormat};
...
typedef void __fastcall (__closure *TAdvSmoothTimeLineDivisionText)(System::TObject* Sender, System::TDateTime DivisionValue, AnsiString &DivisionValueString);
...
typedef void __fastcall (__closure *TAdvSmoothTimeLineIndicatorHint)(System::TObject* Sender, TAdvSmoothTimeLineBarIndicator* indicator, AnsiString &Hint);
...
typedef void __fastcall (__closure *TAdvSmoothTimeLineIndicatorPositionCanChange)(System::TObject* Sender, TAdvSmoothTimeLineBarIndicator* indicator, System::TDateTime Position, bool &CanChange);

typedef void __fastcall (__closure *TAdvSmoothTimeLineSectionPositionCanChange)(System::TObject* Sender, TAdvSmoothTimeLineBarSection* section, System::TDateTime StartTime, System::TDateTime EndTime, bool &CanChange);
...
private:
	int FDrawDivisions;
	int FDrawSubDivisions;
	int FPrevHandle;
	int FStartIndent;
	TTimeLineValue FOldStartVal;
	int FTotalIndent;
	DynamicArray<TTimeLineValue >  FTimeLineValues;
	...
	TAdvSmoothTimeLineIndicatorClick FOnIndicatorDblClick;
	TAdvSmoothTimeLineIndicatorPositionCanChange FOnIndicatorPositionCanChange;
	TAdvSmoothTimeLineSectionPositionCanChange FOnSectionPositionCanChange;
	...
	void __fastcall IndicatorDblClick(void);
...
protected:
	...
	Advgdip::TGPRectF __fastcall GetTimeLineBarRect();
	Advgdip::TGPRectF __fastcall GetTimeLineRect();
	...
	void __fastcall DoBuildTimeLineValues(int &ADivisions, int &ASubDivisions);
	void __fastcall BuildSections(bool ForceRebuild = false);
	...
	virtual void __fastcall DoIndicatorDblClick(TAdvSmoothTimeLineBarIndicator* indicator);
...
__published:
	...
	__property TAdvSmoothTimeLineIndicatorPositionCanChange OnIndicatorPositionCanChange = {read=FOnIndicatorPositionCanChange, write=FOnIndicatorPositionCanChange};
	__property TAdvSmoothTimeLineSectionPositionCanChange OnSectionPositionCanChange = {read=FOnSectionPositionCanChange, write=FOnSectionPositionCanChange};
	...
	__property TAdvSmoothTimeLineIndicatorClick OnIndicatorDblClick = {read=FOnIndicatorDblClick, write=FOnIndicatorDblClick};
...
private:
	...
	Byte FAnnotationOpacity;
	Byte FAnnotationLineOpacity;
	...
	void __fastcall SetAnnotation(const AnsiString Value);
	...
	void __fastcall SetAnnotationLineOpacity(const Byte Value);
	void __fastcall SetAnnotationOpacity(const Byte Value);
...
public:
	...
	Advgdip::TGPRectF __fastcall GetIndicatorRect();
	Advgdip::TGPRectF __fastcall GetAnnotationRect();
	__property AnsiString DBKeyValue = {read=FDBKeyValue};
	
__published:
	__property AnsiString Annotation = {read=FAnnotation, write=SetAnnotation};
	...
	__property Byte AnnotationOpacity = {read=FAnnotationOpacity, write=SetAnnotationOpacity, default=255};
	__property Graphics::TColor AnnotationLineColor = {read=FAnnotationLineColor, write=SetAnnotationLineColor, default=0};
	__property Byte AnnotationLineOpacity = {read=FAnnotationLineOpacity, write=SetAnnotationLineOpacity, default=255};
...
private:
	...
	Byte FSizeHandleOpacity;
	Byte FSizeHandleOpacityTo;
	TAdvSmoothTimeLine* FOwner;
...
protected:
	...
	void __fastcall FillChanged(System::TObject* Sender);
	void __fastcall FontChanged(System::TObject* Sender);
	Advgdip::TGPRectF __fastcall GetSectionRect();
