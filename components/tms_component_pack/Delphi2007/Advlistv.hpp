...
__published:
	...
	__property TPrintBorders Borders = {read=FBorders, write=FBorders, default=0};
	__property Graphics::TPenStyle BorderStyle = {read=FBorderStyle, write=FBorderStyle, default=0};
	__property bool Centered = {read=FCentered, write=FCentered, default=0};
	__property bool RepeatHeaders = {read=FRepeatHeaders, write=FRepeatHeaders, default=0};
...
__published:
	__property bool Save = {read=FSave, write=SetSave, default=0};
	...
	__property TSizeStorage Storage = {read=FStorage, write=FStorage, default=0};
};
...
__published:
	__property Graphics::TColor ColorFrom = {read=FColorFrom, write=SetColorFrom, default=12632256};
	__property Graphics::TColor FontColorFrom = {read=FFontColorFrom, write=SetFontColorFrom, default=0};
	__property Graphics::TColor ColorTo = {read=FColorTo, write=SetColorTo, default=16777215};
	__property Graphics::TColor FontColorTo = {read=FFontColorTo, write=SetFontColorTo, default=8421504};
...
private:
	...
	void __fastcall CutFunc(bool select);
...
public:
	...
	void __fastcall RepaintHeader(void);
...
__published:
	...
	__property bool ClipboardEnable = {read=FClipboardEnable, write=FClipboardEnable, default=0};
	...
	__property int FilterTimeOut = {read=FFilterTimeOut, write=SetFilterTimeOut, default=500};
	...
	__property bool HeaderHotTrack = {read=FHeaderHotTrack, write=SetHeaderHotTrack, default=0};
	__property bool HeaderDragDrop = {read=FHeaderDragDrop, write=SetHeaderDragDrop, default=0};
	__property bool HeaderFlatStyle = {read=FHeaderFlatStyle, write=SetHeaderFlatStyle, default=0};
	__property bool HeaderOwnerDraw = {read=FHeaderOwnerDraw, write=SetHeaderOwnerDraw, default=0};
	__property int HeaderHeight = {read=FHeaderHeight, write=SetHeaderHeight, default=13};
	...
	__property int HoverTime = {read=FHoverTime, write=SetHoverTime, default=-1};
	...
	__property bool ScrollHint = {read=FScrollHint, write=FScrollHint, default=0};
	...
	__property bool SortShow = {read=FSortShow, write=SetSortShow, default=0};
	__property TSortIndicator SortIndicator = {read=FSortIndicator, write=FSortIndicator, default=0};
	...
	__property bool StretchColumn = {read=FStretchColumn, write=SetStretchColumn, default=0};
	__property bool SubImages = {read=FSubImages, write=SetSubImages, default=0};
	__property bool SubItemEdit = {read=FSubItemEdit, write=FSubItemEdit, default=0};
	__property bool SubItemSelect = {read=FSubItemSelect, write=FSubItemSelect, default=0};
	...
	__property int ItemHeight = {read=FItemHeight, write=SetItemHeight, default=13};
	__property bool SaveHeader = {read=FSaveHeader, write=FSaveHeader, default=0};
	__property bool LoadHeader = {read=FLoadHeader, write=FLoadHeader, default=0};
	__property bool ReArrangeItems = {read=FReArrangeItems, write=FReArrangeItems, default=0};
...
__published:
	...
	__property bool SplitLine = {read=FSplitLine, write=SetSplitLine, default=0};
};
