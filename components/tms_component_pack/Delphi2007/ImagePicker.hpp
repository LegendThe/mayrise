...
// (DO NOT EDIT: machine generated header) 'Imagepicker.pas' rev: 11.00
...
private:
	...
	AnsiString __fastcall GetCaption(AnsiString Value);
...
public:
	...
	void __fastcall SelectByCaption(const AnsiString Value);
...
public:
	...
	int __fastcall IndexOf(AnsiString s);
public:
	#pragma option push -w-inl
