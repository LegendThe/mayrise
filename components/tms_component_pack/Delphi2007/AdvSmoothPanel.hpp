...
// (DO NOT EDIT: machine generated header) 'Advsmoothpanel.pas' rev: 11.00
...
__published:
	...
	__property Graphics::TColor ColorStart = {read=FStartColor, write=SetStartColor, default=11563548};
	__property Graphics::TColor ColorEnd = {read=FEndColor, write=SetEndColor, default=10446362};
