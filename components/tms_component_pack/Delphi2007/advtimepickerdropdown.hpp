...
// (DO NOT EDIT: machine generated header) 'Advtimepickerdropdown.pas' rev: 11.00
...
private:
	...
	void __fastcall SetHourPointerSize(const Byte Value);
	void __fastcall SetMinutePointerSize(const Byte Value);
	void __fastcall SetSecondPointerSize(const Byte Value);
	...
	void __fastcall SetCenterPointSize(const Byte Value);
	...
	void __fastcall SetHourMarkLength(const Byte Value);
	void __fastcall SetMinuteMarkLength(const Byte Value);
	void __fastcall SetHourMarkWidth(const Byte Value);
	void __fastcall SetMinuteMarkWidth(const Byte Value);
...
__published:
	...
	__property Byte CenterPointSize = {read=FCenterPointSize, write=SetCenterPointSize, default=4};
	...
	__property Byte HourMarkLength = {read=FHourMarkLength, write=SetHourMarkLength, default=0};
	__property Byte HourMarkWidth = {read=FHourMarkWidth, write=SetHourMarkWidth, default=1};
	...
	__property Byte HourPointerSize = {read=FHourPointerSize, write=SetHourPointerSize, default=4};
	...
	__property Byte MinutePointerSize = {read=FMinutePointerSize, write=SetMinutePointerSize, default=3};
	__property Byte MinuteMarkLength = {read=FMinuteMarkLength, write=SetMinuteMarkLength, default=0};
	__property Byte MinuteMarkWidth = {read=FMinuteMarkWidth, write=SetMinuteMarkWidth, default=1};
	...
	__property Byte SecondPointerSize = {read=FSecondPointerSize, write=SetSecondPointerSize, default=1};
...
#pragma option push -b-
enum TWatchStyle { wsClassic, wsTower, wsFluorescent, wsEmerald, wsBlueStar, wsFuchsia, wsBlack, wsBlackWhite, wsGray, wsSuperNova, wsSports, wsSmooth };
#pragma option pop
...
protected:
	...
	Types::TRect __fastcall GetWatchRect();
	int __fastcall GetWatchBorderWidth(void);
	Types::TRect __fastcall GetInnerRect();
	Types::TRect __fastcall GetAMPMRect();
	Types::TPoint __fastcall GetCenterPoint();
	System::TDateTime __fastcall GetDisplayTime(void);
	void __fastcall InvalidateWatch(void);
	void __fastcall HandleKey(char Key);
...
public:
	...
	void __fastcall SetMinute(Byte Value);
	void __fastcall SetHour(Byte Value);
...
private:
	...
	void __fastcall OnDateTimePickerKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	void __fastcall OnDateTimePickerKeyUp(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	void __fastcall OnDateTimePickerKeyPress(System::TObject* Sender, char &Key);
	void __fastcall SetMinute(Byte Value);
	void __fastcall SetHour(Byte Value);
	void __fastcall SetSecond(Byte Value);
	AnsiString __fastcall GetFormattedTimeString(Word h, Word m, Word s);
...
protected:
	...
	virtual void __fastcall OnDropDownFormKeyPress(char &Key);
	virtual void __fastcall OnDropDownFormKeyDown(Word &Key, Classes::TShiftState Shift);
	virtual void __fastcall OnDropDownFormKeyUp(Word &Key, Classes::TShiftState Shift);
	virtual void __fastcall DoHideDropDown(bool Canceled);
	virtual void __fastcall SetText(AnsiString Value);
	DYNAMIC void __fastcall Change(void);
	virtual void __fastcall OnDropDownControlKeyDown(Word &Key, Classes::TShiftState Shift);
	virtual void __fastcall OnDropDownControlKeyUp(Word &Key, Classes::TShiftState Shift);
	virtual void __fastcall OnDropDownControlKeyPress(char &Key);
