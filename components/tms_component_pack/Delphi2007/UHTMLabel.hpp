...
// (DO NOT EDIT: machine generated header) 'Uhtmlabel.pas' rev: 11.00
...
typedef void __fastcall (__closure *TAnchorClick)(System::TObject* Sender, WideString Anchor);

typedef void __fastcall (__closure *TAnchorHintEvent)(System::TObject* Sender, WideString &Anchor);
...
class DELPHICLASS TUniHTMLabel;
class PASCALIMPLEMENTATION TUniHTMLabel : public Stdctrls::TCustomLabel 
{
...
private:
	...
	bool FHintShowFull;
	bool FHTMLHint;
	void __fastcall SetHTMLText(WideString Value);
...
protected:
	...
	virtual WideString __fastcall GetDisplText();
	virtual void __fastcall UpdateDisplText(void);
	virtual bool __fastcall HTMLPaint(Graphics::TCanvas* Canvas, WideString s, const Types::TRect &fr, Controls::TImageList* FImages, int xpos, int ypos, int focuslink, int hoverlink, int shadowoffset, bool checkhotspot, bool checkheight, bool print, bool selected, bool blink, bool hoverstyle, double resfactor, Graphics::TColor urlcolor, Graphics::TColor hovercolor, Graphics::TColor hoverfontColor, Graphics::TColor shadowcolor, WideString &anchorval, WideString &stripval, WideString &focusanchor, int &xsize, int &ysize, int &hyperlinks, int &mouselink, Types::TRect &hoverrect);
	
public:
	__fastcall virtual TUniHTMLabel(Classes::TComponent* AOwner);
	__fastcall virtual ~TUniHTMLabel(void);
...
__published:
	...
	__property WideString HTMLText = {read=FHTMLText, write=SetHTMLText};
