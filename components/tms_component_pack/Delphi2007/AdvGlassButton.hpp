...
// (DO NOT EDIT: machine generated header) 'Advglassbutton.pas' rev: 11.00
...
#pragma option push -b-
enum TBackGroundSymbol { bsArrowLeft, bsArrowRight, bsArrowUp, bsArrowDown, bsPlay, bsPause, bsStop, bsFastForward, bsForward, bsBackward, bsFastBackward, bsSpeaker, bsNoSpeaker, bsNone, bsRecord, bsCustom };
#pragma option pop
...
typedef void __fastcall (__closure *TCustomBackgroundSymbolEvent)(System::TObject* Sender, const Types::TRect &ARect, Advgdip::TGPGraphics* AGraphics);
...
private:
	...
	TCustomBackgroundSymbolEvent FOnCustomBackgroundSymbol;
...
protected:
	...
	virtual void __fastcall DoCustomBackgroundSymbol(Advgdip::TGPGraphics* Graphics, const Types::TRect &ARect);
	...
	__property TCustomBackgroundSymbolEvent OnCustomBackgroundSymbol = {read=FOnCustomBackgroundSymbol, write=FOnCustomBackgroundSymbol};
...
__published:
	...
	__property Visible  = {default=1};
	__property OnClick ;
	__property OnCustomBackgroundSymbol ;
	__property OnDblClick ;
	__property OnKeyDown ;
	__property OnKeyPress ;
	__property OnKeyUp ;
