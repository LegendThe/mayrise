...
// (DO NOT EDIT: machine generated header) 'Gdipdropdownitem.pas' rev: 11.00

#ifndef GdipdropdownitemHPP
#define GdipdropdownitemHPP
...
class PASCALIMPLEMENTATION TDropDownItem : public Gdipimagetextbuttonitem::TImageTextButtonItem 
{
...
public:
	...
	__fastcall virtual TDropDownItem(Classes::TComponent* AOwner);
...
using namespace Gdipdropdownitem;
#pragma pack(pop)
#pragma option pop

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// Gdipdropdownitem
