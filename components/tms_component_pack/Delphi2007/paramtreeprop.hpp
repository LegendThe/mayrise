...
// (DO NOT EDIT: machine generated header) 'Paramtreeprop.pas' rev: 11.00

#ifndef ParamtreepropHPP
#define ParamtreepropHPP
...
namespace Paramtreeprop
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS Tparamtreeeditor;
class PASCALIMPLEMENTATION Tparamtreeeditor : public Forms::TForm 
{
...
__published:
	...
	Paramtreeview::TParamTreeview* ParamTreeview1;
	...
	void __fastcall ParamTreeview1Click(System::TObject* Sender);
	void __fastcall SpeedButton4Click(System::TObject* Sender);
	void __fastcall ParamTreeview1Change(System::TObject* Sender, Comctrls::TTreeNode* Node);
	void __fastcall ParamTreeview1DragOver(System::TObject* Sender, System::TObject* Source, int X, int Y, Controls::TDragState State, bool &Accept);
	void __fastcall ParamTreeview1DragDrop(System::TObject* Sender, System::TObject* Source, int X, int Y);
...
public:
	__fastcall virtual Tparamtreeeditor(Classes::TComponent* aOwner);
	__fastcall virtual ~Tparamtreeeditor(void);
...
public:
	...
	/* TCustomForm.CreateNew */ inline __fastcall virtual Tparamtreeeditor(Classes::TComponent* AOwner, int Dummy) : Forms::TForm(AOwner, Dummy) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall Tparamtreeeditor(HWND ParentWindow) : Forms::TForm(ParentWindow) { }
	#pragma option pop
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE Tparamtreeeditor* paramtreeeditor;

}	/* namespace Paramtreeprop */
using namespace Paramtreeprop;
#pragma pack(pop)
#pragma option pop
