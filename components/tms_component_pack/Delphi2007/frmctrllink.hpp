...
// (DO NOT EDIT: machine generated header) 'Frmctrllink.pas' rev: 11.00
...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TSetEditorValueEvent)(System::TObject* Sender, Advgrid::TAdvStringGrid* Grid, AnsiString AValue);

typedef void __fastcall (__closure *TGetEditorValueEvent)(System::TObject* Sender, Advgrid::TAdvStringGrid* Grid, AnsiString &AValue);
