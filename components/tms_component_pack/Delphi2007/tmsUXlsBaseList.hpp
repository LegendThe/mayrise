...
// (DO NOT EDIT: machine generated header) 'Tmsuxlsbaselist.pas' rev: 11.00

#ifndef TmsuxlsbaselistHPP
#define TmsuxlsbaselistHPP
...
using namespace Tmsuxlsbaselist;
#pragma pack(pop)
#pragma option pop

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// Tmsuxlsbaselist
