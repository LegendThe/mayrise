...
// (DO NOT EDIT: machine generated header) 'Advverticalpolylist.pas' rev: 11.00

#ifndef AdvverticalpolylistHPP
#define AdvverticalpolylistHPP
...
namespace Advverticalpolylist
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TAdvVerticalPolyList;
class PASCALIMPLEMENTATION TAdvVerticalPolyList : public Customitemscontainer::TCustomItemsContainer 
{
	typedef Customitemscontainer::TCustomItemsContainer inherited;
	
public:
	__fastcall virtual TAdvVerticalPolyList(Classes::TComponent* AOwner);
...
public:
	...
	/* TCustomItemsContainer.Destroy */ inline __fastcall virtual ~TAdvVerticalPolyList(void) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TAdvVerticalPolyList(HWND ParentWindow) : Customitemscontainer::TCustomItemsContainer(ParentWindow) { }
	#pragma option pop
...
using namespace Advverticalpolylist;
#pragma pack(pop)
#pragma option pop

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// Advverticalpolylist
