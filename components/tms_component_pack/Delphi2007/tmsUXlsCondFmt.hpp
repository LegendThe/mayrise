...
// (DO NOT EDIT: machine generated header) 'Tmsuxlscondfmt.pas' rev: 11.00
...
public:
	...
	/* TBaseRecord.Create */ inline __fastcall virtual TCondFmtRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : Tmsuxlsotherrecords::TRangeRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	__fastcall virtual TCFRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize);
...
public:
	...
	virtual void __fastcall DeleteRowsOrCols(const Word aRow, const Word aCount, const Tmsxlsmessages::TSheetInfo &SheetInfo, const bool UseCols);
};
