...
// (DO NOT EDIT: machine generated header) 'Advcalculatordropdown.pas' rev: 11.00
...
protected:
	...
	virtual tagSIZE __fastcall GetMaxButtonSize();
...
private:
	...
	void __fastcall HandleKeyPress(char &Key);
