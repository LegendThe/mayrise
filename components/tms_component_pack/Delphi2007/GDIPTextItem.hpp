...
// (DO NOT EDIT: machine generated header) 'Gdiptextitem.pas' rev: 11.00
...
private:
	...
	Graphics::TFontStyles FCaptionFontStyle;
	Graphics::TFontStyles FDescriptionFontStyle;
	...
	void __fastcall SetCaptionOpacity(const Byte Value);
	...
	void __fastcall SetDescriptionOpacity(const Byte Value);
	...
	void __fastcall SetCaptionFontStyle(const Graphics::TFontStyles Value);
	void __fastcall SetDescriptionFontStyle(const Graphics::TFontStyles Value);
...
__published:
	...
	__property Byte CaptionOpacity = {read=FCaptionOpacity, write=SetCaptionOpacity, default=255};
	...
	__property Graphics::TFontStyles CaptionFontStyle = {read=FCaptionFontStyle, write=SetCaptionFontStyle, default=0};
	__property AnsiString Description = {read=FDescription, write=SetDescription};
	__property Graphics::TFontStyles DescriptionFontStyle = {read=FDescriptionFontStyle, write=SetDescriptionFontStyle, default=0};
	...
	__property Byte DescriptionOpacity = {read=FDescriptionOpacity, write=SetDescriptionOpacity, default=255};
