...
enum TColumnCalcType { acNONE, acSUM, acAVG, acCOUNT, acMIN, acMAX, acSPREAD, acCUSTOM, acDISTINCT, acSTDDEV };
#pragma option pop

typedef int TIObjType;
...
typedef void __fastcall (__closure *TAdvGridUndoRedoEvent)(System::TObject* Sender, TBaseGrid* Grid, int Col, int Row, AnsiString OrigValue, AnsiString NewValue);
...
#pragma option push -b-
enum THoverRowCell { hcNormal, hcFixed, hcSelected };
#pragma option pop

typedef Set<THoverRowCell, hcNormal, hcSelected>  THoverRowCells;
...
private:
	...
	Graphics::TColor FActiveRowColorTo;
	Graphics::TColor FActiveRowMirrorColor;
	Graphics::TColor FActiveRowMirrorColorTo;
	...
	void __fastcall SetActiveRowColorTo(const Graphics::TColor Value);
	void __fastcall SetActiveRowMirrorColor(const Graphics::TColor Value);
	void __fastcall SetActiveRowMirrorColorTo(const Graphics::TColor Value);
...
protected:
	...
	void __fastcall PaintCellInt(Graphics::TCanvas* ACanvas, int ACol, int ARow, const Types::TRect &ARect, Grids::TGridDrawState AState, bool Internal = true);
...
public:
	...
	void __fastcall PaintCell(Graphics::TCanvas* ACanvas, int ACol, int ARow, const Types::TRect &ARect, Grids::TGridDrawState AState);
	void __fastcall PaintCellExt(Graphics::TCanvas* ACanvas, int ACol, int ARow, const Types::TRect &ARect, Grids::TGridDrawState AState);
	...
	__property Graphics::TColor ActiveRowColorTo = {read=FActiveRowColorTo, write=SetActiveRowColorTo, default=536870911};
	__property Graphics::TColor ActiveRowMirrorColor = {read=FActiveRowMirrorColor, write=SetActiveRowMirrorColor, default=536870911};
	__property Graphics::TColor ActiveRowMirrorColorTo = {read=FActiveRowMirrorColorTo, write=SetActiveRowMirrorColorTo, default=536870911};
...
__published:
	...
	__property THoverRowCells HoverRowCells = {read=FHoverRowCells, write=FHoverRowCells, default=0};
