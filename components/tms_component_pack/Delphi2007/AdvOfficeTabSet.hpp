...
// (DO NOT EDIT: machine generated header) 'Advofficetabset.pas' rev: 11.00
...
private:
	...
	AnsiString FScrollButtonFirstHint;
	AnsiString FScrollButtonLastHint;
	bool FLastButton;
	bool FFirstButton;
	AnsiString FClosedListButtonHint;
...
__published:
	...
	__property AnsiString InsertButtonHint = {read=FInsertButtonHint, write=FInsertButtonHint};
	__property AnsiString TabListButtonHint = {read=FTabListButtonHint, write=FTabListButtonHint};
	__property AnsiString ClosedListButtonHint = {read=FClosedListButtonHint, write=FClosedListButtonHint};
	...
	__property AnsiString ScrollButtonFirstHint = {read=FScrollButtonFirstHint, write=FScrollButtonFirstHint};
	__property AnsiString ScrollButtonLastHint = {read=FScrollButtonLastHint, write=FScrollButtonLastHint};
...
typedef void __fastcall (__closure *TTabClickEvent)(System::TObject* Sender, int TabIndex);

typedef void __fastcall (__closure *TClosedListClick)(System::TObject* Sender, int X, int Y);

typedef void __fastcall (__closure *TTabEvent)(System::TObject* Sender, int TabIndex);
...
typedef void __fastcall (__closure *TTabItemEvent)(System::TObject* Sender, TOfficeTabCollectionItem* ATab);
...
private:
	...
	TArrowWindow* FArrow;
	int FFixedTabs;
	Graphics::TColor FTabRearrangeIndicatorColor;
	...
	int FOldMouseX;
	int FOldMouseY;
	TDbgList* FFloatingTabs;
	TOfficeTabCollectionItem* FDragingTab;
	TTabItemEvent FOnTabUnDock;
	bool FTabRoundEdges;
	bool FShadow;
	bool FShow3D;
	bool FItones;
	TTabAppearance* FTabAppearance;
	Advglowbutton::TGlowButtonAppearance* FGlowButtonAppearance;
	TTabItemEvent FOnTabInsert;
	bool FMultiLine;
	DynamicArray<Types::TPoint >  FTabRows;
	...
	AnsiString __fastcall GetSettings();
	void __fastcall SetSettings(const AnsiString Value);
...
protected:
	...
	Types::TRect __fastcall GetClosedListButtonRect();
	Types::TRect __fastcall GetTabScrollerRect();
	Types::TRect __fastcall GetTabScrollerFirstRect();
	Types::TRect __fastcall GetTabScrollerLastRect();
	...
	Types::TRect __fastcall GetInsertButtonRect();
	void __fastcall InvalidateInsertButton(void);
	void __fastcall DoInsertButtonClick(void);
	...
	void __fastcall BeginMove(Classes::TShiftState Shift, int X, int Y, TOfficeTabCollectionItem* Tab);
	...
	__property Graphics::TColor TabRearrangeIndicatorColor = {read=FTabRearrangeIndicatorColor, write=FTabRearrangeIndicatorColor, default=16711680};
	...
	__property bool TabRoundEdges = {read=FTabRoundEdges, write=FTabRoundEdges, default=1};
	__property bool Show3D = {read=FShow3D, write=FShow3D, default=1};
	__property bool Shadow = {read=FShadow, write=FShadow, default=1};
	...
	__property TTabItemEvent OnTabUnDock = {read=FOnTabUnDock, write=FOnTabUnDock};
	__property TTabItemEvent OnTabInsert = {read=FOnTabInsert, write=FOnTabInsert};
...
public:
	...
	void __fastcall SetFloating(int Index);
	virtual void __fastcall CloseAllTabs(void);
	void __fastcall OpenAllClosedTabs(void);
	bool __fastcall OpenClosedTab(TOfficeTabCollectionItem* ATab);
	void __fastcall AddTab(AnsiString Caption);
	void __fastcall SaveToFile(AnsiString FileName);
	void __fastcall LoadFromFile(AnsiString FileName);
	void __fastcall SetColorTones(const Advstyleif::TColorTones &ATones);
	__property AnsiString Settings = {read=GetSettings, write=SetSettings};
	TOfficeTabCollectionItem* __fastcall TabByName(AnsiString Value);
	TOfficeTabCollectionItem* __fastcall TabByCaption(AnsiString Value);
	TOfficeTabCollectionItem* __fastcall TabAtTabIndex(int Value);
public:
	#pragma option push -w-inl
...
private:
	...
	bool FGlass;
	TAdvCustomOfficeTabSet* FTabSet;
...
protected:
	void __fastcall Changed(void);
	__property TAdvCustomOfficeTabSet* TabSet = {read=FTabSet, write=FTabSet};
...
class DELPHICLASS TAdvTabSetButton;
class PASCALIMPLEMENTATION TAdvTabSetButton : public Controls::TGraphicControl 
{
...
public:
	__fastcall virtual TAdvTabSetButton(Classes::TComponent* AOwner);
	__fastcall virtual ~TAdvTabSetButton(void);
...
private:
	...
	TAdvTabSetButton* FCloseButtonChrome;
	AnsiString FCaption;
	bool FVisible;
	int FTag;
	int FImageIndex;
	...
	int FTabIndex;
	bool FLocked;
	TOfficeTabCollection* FParentCollection;
	bool FFloating;
...
typedef DynamicArray<Types::TPoint >  AdvOfficeTabSet__71;
...
__published:
	...
	__property OnClosedListClick ;
	__property OnTabInsert ;
	__property OnTabMouseEnter ;
	__property OnTabMouseLeave ;
	__property OnTabUnDock ;
public:
	#pragma option push -w-inl
...
public:
	...
	HIDESBASE TOfficeTabCollectionItem* __fastcall AddTab(Forms::TForm* ChildForm);
	void __fastcall RemoveTab(Forms::TForm* ChildForm);
...
extern PACKAGE Word WM_OTSDESTROYCLOSEBTN;
