...
// (DO NOT EDIT: machine generated header) 'Inspdd.pas' rev: 11.00
...
private:
	...
	AnsiString __fastcall SomeURL(Word Format);
...
enum TDropFormat { dfText, dfFile, dfURL };
#pragma option pop

typedef Set<TDropFormat, dfText, dfURL>  TDropFormats;

class DELPHICLASS TInspectorDropTarget;
class PASCALIMPLEMENTATION TInspectorDropTarget : public System::TInterfacedObject 
{
...
public:
	__fastcall TInspectorDropTarget(void);
	...
	__property bool AcceptURL = {read=FAcceptURL, write=FAcceptURL, nodefault};
	__property TDropFormats DropFormats = {read=FDropFormats, nodefault};
public:
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TInspectorDropTarget(void) { }
	#pragma option pop
...
class DELPHICLASS TInspectorDropSource;
class PASCALIMPLEMENTATION TInspectorDropSource : public System::TInterfacedObject 
{
	typedef System::TInterfacedObject inherited;
...
public:
	__fastcall TInspectorDropSource(void);
...
public:
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TInspectorDropSource(void) { }
	#pragma option pop
...
extern PACKAGE HRESULT __fastcall StartTextDoDragDrop(TInspectorDropSource* DropSource, AnsiString stxt, AnsiString srtf, int dwOKEffects, int &dwEffect);
extern PACKAGE HRESULT __fastcall StartColDoDragDrop(TInspectorDropSource* DropSource, int column, int dwOKEffects, int &dwEffect);

}	/* namespace Inspdd */
using namespace Inspdd;
#pragma pack(pop)
#pragma option pop
