...
// (DO NOT EDIT: machine generated header) 'Advsmoothdock.pas' rev: 11.00
...
public:
	Advgdip::TGPRectF __fastcall GetItemRect(bool Hover = true);
	Advgdip::TGPRectF __fastcall GetItemRectCenter(bool Hover = true);
	Advgdip::TGPRectF __fastcall GetHoverRect(bool Hover = true);
	Advgdip::TGPRectF __fastcall GetNormalRect(bool Hover = true);
	__fastcall virtual TAdvSmoothDockItem(Classes::TCollection* Collection);
	__fastcall virtual ~TAdvSmoothDockItem(void);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	__property AnsiString FilePath = {read=FFilePath, write=FFilePath};
...
private:
	...
	void __fastcall SetReflectionEnd(const Byte Value);
	void __fastcall SetReflectionStart(const Byte Value);
...
__published:
	...
	__property Byte ReflectionStart = {read=FReflectionStart, write=SetReflectionStart, default=100};
	__property Byte ReflectionEnd = {read=FReflectionEnd, write=SetReflectionEnd, default=0};
...
typedef void __fastcall (__closure *TAdvSmoothDockItemHint)(System::TObject* Sender, int ItemIndex, AnsiString &Hint);
...
typedef void __fastcall (__closure *TAdvSmoothDockDrawEvent)(System::TObject* Sender, Advgdip::TGPGraphics* g, const Advgdip::TGPRectF &R);
...
private:
	...
	DynamicArray<TAnimationPoint >  FSin;
	Gdipfill::TGDIPFill* FFill;
	bool FTransparent;
	...
	Byte FPlatForm3DOpacity;
	Byte FPlatForm3DOpacityTo;
	bool FDockOnDeskTop;
	bool FDockVisible;
	...
	TAdvSmoothDockDrawEvent FOnDraw;
	void __fastcall SetFill(const Gdipfill::TGDIPFill* Value);
	...
	void __fastcall SetPlatForm3DOpacity(const Byte Value);
	void __fastcall SetPlatForm3DOpacityTo(const Byte Value);
...
protected:
	...
	TAdvSmoothDockBounds __fastcall GetBounds();
	...
	double __fastcall GetTotalSize(bool Hover = true);
	...
	Advgdip::TGPRectF __fastcall GetItemsRectangle();
	Advgdip::TGPRectF __fastcall GetItemsMinimumRectangle();
	Advgdip::TGPRectF __fastcall GetArrowLeft();
	Advgdip::TGPRectF __fastcall GetArrowRight();
	bool __fastcall IsMouseOnArrow(int X, int Y);
	bool __fastcall PtInGPRect(const Advgdip::TGPRectF &r, const Types::TPoint &pt);
	Advgdip::TGPRectF __fastcall GetPlatFormRectangle();
	TCaptionSize __fastcall GetMaxSizeCaption();
...
public:
	TAdvSmoothDockForm* __fastcall GetForm(void);
	...
	void __fastcall AddImagesFromFolder(AnsiString AFolder, bool SetImageCaption = false);
	void __fastcall AddFilesFromFolder(AnsiString AFolder, bool SetImageCaption = false, bool SetFilePath = false, bool LoadIcon = false);
	...
	void __fastcall HoverXY(int X, int Y);
	
__published:
	__property TAdvSmoothDockDrawEvent OnDraw = {read=FOnDraw, write=FOnDraw};
	...
	__property Byte PlatForm3DOpacity = {read=FPlatForm3DOpacity, write=SetPlatForm3DOpacity, default=30};
	__property Byte PlatForm3DOpacityTo = {read=FPlatForm3DOpacityTo, write=SetPlatForm3DOpacityTo, default=100};
...
typedef DynamicArray<TAnimationPoint >  AdvSmoothDock__01;
