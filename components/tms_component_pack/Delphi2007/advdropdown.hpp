...
// (DO NOT EDIT: machine generated header) 'Advdropdown.pas' rev: 11.00
...
typedef void __fastcall (__closure *TGetTextEvent)(System::TObject* Sender, AnsiString &Text);
...
protected:
	...
	Types::TRect __fastcall GetButtonsCoveredRect();
...
private:
	...
	void __fastcall OnFormKeyPress(System::TObject* Sender, char &Key);
	void __fastcall OnFormKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	void __fastcall OnFormKeyUp(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	...
	void __fastcall OnControlKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	void __fastcall OnControlKeyUp(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	void __fastcall OnControlKeyPress(System::TObject* Sender, char &Key);
	...
	void __fastcall SetBorderColor(const Graphics::TColor Value);
	void __fastcall SetFocusBorderColor(const Graphics::TColor Value);
...
protected:
	...
	Types::TRect __fastcall GetEditRect();
	...
	HIDESBASE virtual void __fastcall SetText(AnsiString Value);
	...
	__property Graphics::TColor FocusBorderColor = {read=FFocusBorderColor, write=SetFocusBorderColor, default=536870911};
	__property Controls::TWinControl* FocusControl = {read=FFocusControl, write=FFocusControl};
	...
	__property AnsiString DropDownButtonHint = {read=FButtonHint, write=SetButtonHint};
	...
	__property AnsiString DropDownButtonCaption = {read=GetButtonCaption, write=SetButtonCaption};
	__property bool Etched = {read=FEtched, write=SetEtched, nodefault};
...
__published:
	...
	__property Graphics::TColor BorderColorHot = {read=FBorderColorHot, write=FBorderColorHot, default=536870911};
	__property Graphics::TColor BorderColorSelected = {read=FBorderColorSelected, write=FBorderColorSelected, default=536870911};
...
protected:
	...
	tagSIZE __fastcall GetItemPanelSize();
...
public:
	...
	bool __fastcall LookupItem(AnsiString s);
...
protected:
	...
	virtual Types::TRect __fastcall GetInnerRect();
...
extern PACKAGE void __fastcall DrawButtonContent(Graphics::TCanvas* Canvas, const Types::TRect &R, AnsiString Caption, Imglist::TCustomImageList* Images, int ImageIndex);
extern PACKAGE tagSIZE __fastcall GetTextSize(Graphics::TCanvas* Canvas, AnsiString Text);
extern PACKAGE AnsiString __fastcall GetTextOfSize(Graphics::TCanvas* Canvas, AnsiString Text, int cx, bool AddEllipsis = true);
extern PACKAGE tagSIZE __fastcall DrawHTMLEX(Graphics::TCanvas* Canvas, AnsiString s, const Types::TRect &R, Imglist::TCustomImageList* Images, bool RealDraw, unsigned WinHandle);
