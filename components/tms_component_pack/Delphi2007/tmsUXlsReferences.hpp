...
// (DO NOT EDIT: machine generated header) 'Tmsuxlsreferences.pas' rev: 11.00
...
public:
	...
	/* TBaseRecord.Create */ inline __fastcall virtual TExternNameRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : Tmsuxlsbaserecords::TBaseRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	__fastcall virtual TSupBookRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize);
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TExternSheetRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : Tmsuxlsbaserecords::TBaseRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
