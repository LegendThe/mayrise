...
// (DO NOT EDIT: machine generated header) 'Advcolorpickerdropdown.pas' rev: 11.00
...
protected:
	...
	void __fastcall HandleKey(Word Key, bool EditorEnabled, bool DroppedDown);
...
protected:
	...
	HIDESBASE void __fastcall SelectNext(void);
	void __fastcall SelectPrevious(void);
	virtual AnsiString __fastcall GetSelectedColorText();
...
public:
	...
	__property AnsiString SelectedColorText = {read=GetSelectedColorText};
