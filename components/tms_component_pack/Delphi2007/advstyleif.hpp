...
#pragma option push -b-
enum TOfficeVersion { ov2003, ov2007, ov2010 };
#pragma option pop

#pragma option push -b-
enum TOfficeTheme { ot2003Blue, ot2003Silver, ot2003Olive, ot2003Classic, ot2007Blue, ot2007Silver, ot2007Black, ot2010Blue, ot2010Silver, ot2010Black, otUnknown };
#pragma option pop

__interface ITMSTones;
typedef System::DelphiInterface<ITMSTones> _di_ITMSTones;
__interface  INTERFACE_UUID("{1F492643-6699-4F25-8B34-3233FA735036}") ITMSTones  : public IInterface 
{
...
extern PACKAGE TColorTones __fastcall DefaultMetroTones();
extern PACKAGE TColorTones __fastcall ClearTones();
extern PACKAGE bool __fastcall IsClearTones(const TColorTones &ATones);
extern PACKAGE AnsiString __fastcall GetMetroFont();
