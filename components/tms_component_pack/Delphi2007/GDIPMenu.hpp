...
// (DO NOT EDIT: machine generated header) 'Gdipmenu.pas' rev: 11.00
...
__interface  INTERFACE_UUID("{05B08D30-11B9-48D6-92A0-83904F27F19A}") ITMSMegaMenu  : public IInterface 
{
...
public:
	...
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	Advgdip::TGPRectF __fastcall GetTopLayerRect();
...
private:
	...
	void __fastcall SetHoverText(const AnsiString Value);
...
public:
	...
	Advgdip::TGPRectF __fastcall ItemRect();
...
__published:
	...
	__property bool Visible = {read=FVisible, write=SetVisible, default=1};
	__property AnsiString DetailText = {read=FHoverText, write=SetHoverText};
...
typedef void __fastcall (__closure *TGDIPMenuItemEditChanged)(System::TObject* Sender, AnsiString Text, TGDIPMenuSectionItem* item);

typedef void __fastcall (__closure *TGDIPMenuItemEvent)(System::TObject* Sender, TGDIPMenuSectionItem* Item, AnsiString Text);

typedef void __fastcall (__closure *TGDIPMenuItemAnchorEvent)(System::TObject* Sender, TGDIPMenuSectionItem* Item, AnsiString Anchor);
...
public:
	...
	AnsiString __fastcall GetStrippedHTMLText(AnsiString txt);
	AnsiString __fastcall DrawItemHTMLText(Advgdip::TGPGraphics* g, Advgdip::TGPRectF &htmlr, Graphics::TFont* f, TGDIPMenuHTMLText* HTML, const Advgdip::TGPRectF &r, AnsiString str, TGDIPMenuLocation Location, int TextLeft, int TextTop, bool DoCalculate = false, bool DoAnchor = false, int fX = 0xffffffff, int fY = 0xffffffff);
	AnsiString __fastcall DrawTopLayerHTMLText(Advgdip::TGPGraphics* g, Graphics::TFont* f, TGDIPMenuHTMLText* HTML, TGDIPMenuLocation Location, const Advgdip::TGPRectF &r, AnsiString str, bool DoAnchor = false, int fX = 0xffffffff, int fY = 0xffffffff);
	...
	__property AnsiString RootCaption = {read=FRootCaption, write=FRootCaption};
