...
// (DO NOT EDIT: machine generated header) 'Advmenus.pas' rev: 11.00
...
__interface IAdvMenu  : public IInterface 
{
...
public:
	...
	virtual Byte __fastcall GetOpacity(void) = 0 ;
	virtual void __fastcall SetOpacity(const Byte Value) = 0 ;
	...
	__property Byte Opacity = {read=GetOpacity, write=SetOpacity};
...
extern PACKAGE AnsiString __fastcall AdvShortCutToText(Classes::TShortCut ShortCut, bool Intl);
