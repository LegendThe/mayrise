...
// (DO NOT EDIT: machine generated header) 'Todolist.pas' rev: 11.00
...
__published:
	...
	__property AnsiString TotalTimeSuffix = {read=FTotalTimeSuffix, write=FTotalTimeSuffix};
public:
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* Exception.Create */ inline __fastcall EConversionFunctionException(const AnsiString Msg) : Sysutils::Exception(Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EConversionFunctionException(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EConversionFunctionException(const AnsiString Msg, int AHelpContext) : Sysutils::Exception(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EConversionFunctionException(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~EConversionFunctionException(void) { }
	#pragma option pop
	
};


typedef AnsiString TodoList__8[4];

typedef AnsiString TodoList__01[5];
...
public:
	...
	int __fastcall IndexInTodoOf(int col, AnsiString s);
...
static const Shortint STRSIZE = 0x1;
static const Shortint MAJ_VER = 0x1;
static const Shortint MIN_VER = 0x5;
static const Shortint REL_VER = 0x0;
static const Shortint BLD_VER = 0x0;
#define DATE_VER "May, 2010"
extern PACKAGE Word CF_TODOITEM;
...
extern PACKAGE void __fastcall SaveProperty(Classes::TStream* S, Byte ID, void * Buffer, Word Size);
...
extern PACKAGE Byte __fastcall ReadByte(Classes::TStream* S);
extern PACKAGE System::TDateTime __fastcall ReadDateTime(Classes::TStream* S);
extern PACKAGE AnsiString __fastcall ReadString(Classes::TStream* S, int Size);
