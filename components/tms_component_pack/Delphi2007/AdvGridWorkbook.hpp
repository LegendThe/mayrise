...
typedef TMetaClass* TAdvStringGridClass;
...
private:
	...
	Advgrid::TAdvStringGrid* __fastcall GetGrid(void);
	
protected:
	virtual void __fastcall Notification(Classes::TComponent* AComponent, Classes::TOperation AOperation);
	virtual void __fastcall SheetsChanged(System::TObject* Sender);
	virtual void __fastcall SetName(const AnsiString Value);
	void __fastcall RestoreSelection(int Col, int Row);
	virtual TMetaClass* __fastcall GetGridClass(void);
...
public:
	...
	__property Tabs::TTabSet* TabSet = {read=FTabSet};
	__property Advgrid::TAdvStringGrid* Grid = {read=GetGrid};
