...
// (DO NOT EDIT: machine generated header) 'Dbadvsmoothimagelistbox.pas' rev: 11.00
...
private:
	...
	void __fastcall SetImageField(const AnsiString Value);
...
__published:
	...
	__property AnsiString ImageField = {read=FImageField, write=SetImageField};
