...
typedef tagRGBTRIPLE TRGBTripleRow[30001];
...
__published:
	...
	Extctrls::TShape* Shape_ClickColor;
	Extctrls::TShape* Shape_HoverColor;
	Extctrls::TShape* Shape_SelectedColor;
	Extctrls::TShape* Shape_BlinkColor;
	...
	void __fastcall edtIDKeyPress(System::TObject* Sender, char &Key);
...
public:
	void __fastcall LoadSettings(AnsiString inifile);
	void __fastcall SaveSettings(AnsiString inifile);
...
extern PACKAGE DynamicArray<Hotspotimage::TRealPoint >  tmPoints;
