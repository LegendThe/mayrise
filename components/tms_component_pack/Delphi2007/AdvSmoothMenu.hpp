...
// (DO NOT EDIT: machine generated header) 'Advsmoothmenu.pas' rev: 11.00
...
private:
	...
	void __fastcall SetGlowOpacityDisabled(const Byte Value);
...
__published:
	...
	__property Byte GlowOpacityDisabled = {read=FGlowOpacityDisabled, write=SetGlowOpacityDisabled, default=100};
...
protected:
	...
	void __fastcall DrawPicture(Advgdip::TGPGraphics* g, Byte opacity, Advgdip::TAdvGDIPPicture* picture, Gdipfill::TFillPicturePosition location, int w, int h, const Types::TRect &r, int x, int y);
