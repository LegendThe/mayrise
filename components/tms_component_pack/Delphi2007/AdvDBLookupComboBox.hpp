...
typedef void __fastcall (__closure *TGridSelectCellEvent)(System::TObject* Sender, int Col, int Row, AnsiString Avalue, bool &CanSelect);
...
private:
	...
	void __fastcall SetInternalText(const AnsiString Value);
