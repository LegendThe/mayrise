...
// (DO NOT EDIT: machine generated header) 'Spbepc.pas' rev: 11.00
...
private:
	...
	AnsiString FPotentialTitle;
	AnsiString FTopCaption;
	AnsiString FBottomCaption;
	int FPenWidth;
	...
	AnsiString __fastcall GetCurrentTitle();
	void __fastcall SetCurrentTitle(const AnsiString Value);
	AnsiString __fastcall GetPotentialTitle();
	void __fastcall SetPotentialTitle(const AnsiString Value);
	void __fastcall SetBottomCaption(const AnsiString Value);
	void __fastcall SetTopCaption(const AnsiString Value);
	void __fastcall SetPenWidth(const int Value);
	AnsiString __fastcall GetBottomCaption();
	AnsiString __fastcall GetTopCaption();
	...
	void __fastcall MakeTextFit(Graphics::TCanvas* Canvas, Types::TRect &Rect, AnsiString Str);
...
__published:
	...
	__property AnsiString CurrentTitle = {read=GetCurrentTitle, write=SetCurrentTitle};
	__property AnsiString PotentialTitle = {read=GetPotentialTitle, write=SetPotentialTitle};
	__property AnsiString TopCaption = {read=GetTopCaption, write=SetTopCaption};
	__property AnsiString BottomCaption = {read=GetBottomCaption, write=SetBottomCaption};
