...
// (DO NOT EDIT: machine generated header) 'Advsmoothstepcontrol.pas' rev: 11.00
...
private:
	...
	TStepActionAppearance* FDisabledAppearance;
	Graphics::TFont* FDisabledCaptionFont;
	Graphics::TFont* FDisabledDescriptionFont;
	...
	void __fastcall SetDisabledAppearance(const TStepActionAppearance* Value);
	void __fastcall SetDisabledCaptionFont(const Graphics::TFont* Value);
	void __fastcall SetDisabledDescriptionFont(const Graphics::TFont* Value);
...
__published:
	...
	__property Graphics::TFont* DisabledCaptionFont = {read=FDisabledCaptionFont, write=SetDisabledCaptionFont};
	...
	__property Graphics::TFont* DisabledDescriptionFont = {read=FDisabledDescriptionFont, write=SetDisabledDescriptionFont};
	...
	__property TStepActionAppearance* DisabledAppearance = {read=FDisabledAppearance, write=SetDisabledAppearance};
...
#pragma option push -b-
enum TStepMode { mActive, mProcessed, mInactive, mDisabled };
#pragma option pop
...
typedef void __fastcall (__closure *TStepHintEvent)(System::TObject* Sender, int StepIndex, TStepMode StepMode, AnsiString &Hint);
...
typedef void __fastcall (__closure *TStepAnchorEvent)(System::TObject* Sender, int StepIndex, AnsiString Anchor);

typedef void __fastcall (__closure *TStepChangedEvent)(System::TObject* Sender, int StepIndex);
...
private:
	...
	bool FAnimation;
	TStepChangedEvent FOnStepChanged;
...
public:
	...
	int __fastcall XYToAnchorStep(int X, int Y);
	void __fastcall UseDefaultStyle(void);
	void __fastcall InitializeSteps(void);
	TStepMode __fastcall GetStepMode(int Item);
	void __fastcall SaveToImage(AnsiString Filename, Advgdip::TImageType ImageType = (Advgdip::TImageType)(0x1), int ImageQualityPercentage = 0x64);
...
__published:
	...
	__property TStepChangedEvent OnStepChanged = {read=FOnStepChanged, write=FOnStepChanged};
...
public:
	...
	AnsiString __fastcall GetAnchorAt(Advgdip::TGPGraphics* g, int X, int Y, const Advgdip::TGPRectF &R, Graphics::TFont* ft);
	AnsiString __fastcall DrawHTMLText(Advgdip::TGPGraphics* g, TStepActionContentHTMLText* HTML, const Advgdip::TGPRectF &r, Graphics::TFont* ft, AnsiString str, bool DoAnchor = false, int fX = 0xffffffff, int fY = 0xffffffff);
...
private:
	...
	bool FEnabled;
	TStepActionContent* FDisabledContent;
	...
	void __fastcall SetDisabledContent(const TStepActionContent* Value);
...
public:
	...
	bool __fastcall Processed(void);
...
__published:
	...
	__property TStepActionContent* DisabledContent = {read=FDisabledContent, write=SetDisabledContent};
