...
// (DO NOT EDIT: machine generated header) 'Advofficestatusbar.pas' rev: 11.00
...
__published:
	...
	__property int HTMLOffsetX = {read=FHTMLOffsetX, write=SetHTMLOffsetX, default=1};
	__property int HTMLOffsetY = {read=FHTMLOffsetY, write=SetHTMLOffseTY, default=1};
...
protected:
	...
	void __fastcall ChangedPerc(void);
...
__published:
	...
	__property ShowHint ;
	__property bool ShowSplitter = {read=FShowSplitter, write=SetShowSplitter, nodefault};
