...
// (DO NOT EDIT: machine generated header) 'Plannercal.pas' rev: 11.00
...
typedef void __fastcall (__closure *TCancelledKeyEvent)(System::TObject* Sender, Word Key);
...
#pragma option push -b-
enum TEventShape { evsRectangle, evsCircle, evsSquare, evsTriangle, evsNone, evsAMPMRectangle };
#pragma option pop
...
private:
	...
	void __fastcall SetColorPM(const Graphics::TColor Value);
...
public:
	...
	__property Graphics::TColor ColorPM = {read=FColorPM, write=SetColorPM, nodefault};
...
protected:
	...
	virtual void __fastcall EventFontChanged(System::TObject* Sender);
	
public:
	__fastcall virtual TCustomCalendarPanel(Classes::TComponent* AOwner);
	__fastcall virtual ~TCustomCalendarPanel(void);
	__property BorderWidth  = {default=0};
	__property BevelWidth  = {default=1};
	
__published:
	__property Graphics::TColor EventDayColor = {read=FEventDayColor, write=SetEventDayColor, nodefault};
	__property Graphics::TFont* EventFont = {read=FEventFont, write=SetFont};
...
public:
	...
	TSelDateItem* __fastcall ItemOnDate(System::TDateTime dt);
...
private:
	...
	Classes::TNotifyEvent FOnYearSelect;
	...
	void __fastcall PaintEventMarker(const Types::TRect &R, Graphics::TColor AColor, Graphics::TColor AColorPM, TEventShape AShape);
...
protected:
	...
	virtual void __fastcall DoDaySelect(System::TDateTime SelDate);
...
__published:
	...
	__property Classes::TNotifyEvent OnYearSelect = {read=FOnYearSelect, write=FOnYearSelect};
...
private:
	...
	void __fastcall SetFOnYearSelect(Classes::TNotifyEvent Value);
...
protected:
	...
	void __fastcall ThemeAdapt(void);
	void __fastcall CancelledKey(System::TObject* Sender, Word Key);
	virtual void __fastcall WndProc(Messages::TMessage &Msg);
...
__published:
	...
	__property Classes::TNotifyEvent OnYearSelect = {read=FOnYearSelect, write=SetFOnYearSelect};
