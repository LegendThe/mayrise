...
// (DO NOT EDIT: machine generated header) 'Advmulticolumndropdown.pas' rev: 11.00
...
public:
	...
	DYNAMIC Classes::TPersistent* __fastcall GetOwner(void);
	int __fastcall IndexInColumn(int Column, AnsiString Value);
	__property Classes::TNotifyEvent OnChange = {read=FOnChange, write=FOnChange};
public:
	#pragma option push -w-inl
...
public:
	...
	int __fastcall GetItemIndex(AnsiString value);
