...
// (DO NOT EDIT: machine generated header) 'Htmlchklist.pas' rev: 11.00
...
private:
	...
	int FLastHintPos;
	bool FShowFocus;
	bool FEnableCommentSelection;
	bool FReorder;
	bool FReorderComments;
	Graphics::TColor FCommentColor;
	Graphics::TFont* FCommentFont;
	...
	void __fastcall SetEnableCommentSelection(const bool Value);
	void __fastcall CommentFontChanged(System::TObject* Sender);
...
protected:
	...
	void __fastcall CheckAllInt(Stdctrls::TCheckBoxState AState)/* overload */;
	void __fastcall CheckAllInt(bool check = true)/* overload */;
...
__published:
	...
	__property bool EnableCommentSelection = {read=FEnableCommentSelection, write=SetEnableCommentSelection, default=1};
	...
	__property Graphics::TColor CommentColor = {read=FCommentColor, write=FCommentColor, default=536870911};
	__property Graphics::TFont* CommentFont = {read=FCommentFont, write=FCommentFont};
	...
	__property bool ReorderComments = {read=FReorderComments, write=FReorderComments, default=0};
