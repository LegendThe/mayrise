...
// (DO NOT EDIT: machine generated header) 'Advshapebutton.pas' rev: 11.00
...
private:
	...
	Classes::TNotifyEvent FOnShowMenuFrame;
	Classes::TNotifyEvent FOnHideMenuFrame;
	Graphics::TBitmap* FMenuShape;
	Graphics::TBitmap* FMenuShapeDisabled;
	Graphics::TBitmap* FMenuShapeHot;
	Graphics::TBitmap* FMenuShapeDown;
	bool FMenuShapeInvalid;
	bool FIsDataModeler;
	bool FItones;
	TAdvShapeButtonAppearance* FMetroAppearance;
	bool FOldAeroVista;
	...
	void __fastcall HideAllMenuShortCuts(void);
	void __fastcall SetTextAlignment(const Classes::TAlignment Value);
	void __fastcall BuildMenuShape(void);
	int __fastcall GetMyTop(void);
...
protected:
	...
	virtual void __fastcall DoHideMenuFrame(void);
	virtual void __fastcall DoShowMenuFrame(void);
	...
	void __fastcall SwitchMetro(bool Value);
	void __fastcall InvalidateMe(void);
	__property bool IsDataModeler = {read=FIsDataModeler, write=FIsDataModeler, nodefault};
	...
	__property Word TextOffset = {read=FTextOffset, write=FTextOffset, default=0};
...
public:
	...
	__property Classes::TNotifyEvent OnShowMenuFrame = {read=FOnShowMenuFrame, write=FOnShowMenuFrame};
	__property Classes::TNotifyEvent OnHideMenuFrame = {read=FOnHideMenuFrame, write=FOnHideMenuFrame};
public:
	#pragma option push -w-inl
...
__published:
	...
	__property TextOffset  = {default=0};
	...
	__property OnShowMenuFrame ;
	__property OnHideMenuFrame ;
