...
// (DO NOT EDIT: machine generated header) 'Advsmoothedit.pas' rev: 11.00
...
#pragma option push -b-
enum TAdvSmoothEditType { etString, etNumeric, etFloat, etUppercase, etMixedCase, etLowerCase, etPassword, etMoney, etRange, etHex, etAlphaNumeric, etValidChars };
#pragma option pop
...
class PASCALIMPLEMENTATION TAdvSmoothEdit : public Mask::TCustomMaskEdit 
{
...
public:
	__fastcall virtual TAdvSmoothEdit(Classes::TComponent* aOwner);
	__fastcall virtual ~TAdvSmoothEdit(void);
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TAdvSmoothEdit(HWND ParentWindow) : Mask::TCustomMaskEdit(ParentWindow) { }
	#pragma option pop
...
class PASCALIMPLEMENTATION TAdvSmoothMaskEdit : public Mask::TMaskEdit 
{
...
public:
	__fastcall virtual TAdvSmoothMaskEdit(Classes::TComponent* AOwner);
	virtual void __fastcall SetBounds(int ALeft, int ATop, int AWidth, int AHeight);
	__fastcall virtual ~TAdvSmoothMaskEdit(void);
	__property bool Modified = {read=GetModified, write=SetModified, nodefault};
	virtual void __fastcall Loaded(void);
	__property Stdctrls::TLabel* EditLabel = {read=FLabel};
	__property bool Border3D = {read=FBorder3D, write=SetBorder3D, nodefault};
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TAdvSmoothMaskEdit(HWND ParentWindow) : Mask::TMaskEdit(ParentWindow) { }
	#pragma option pop
...
extern PACKAGE bool AdvSmoothEdit_DEFAULTHANDLING;
extern PACKAGE bool __fastcall AdvInputQuery(const TAdvSmoothEditType QueryType, PQueryParams QueryParams, const AnsiString ACaption, const AnsiString APrompt, AnsiString &Value);
