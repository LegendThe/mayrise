...
// (DO NOT EDIT: machine generated header) 'Advdatetimepicker.pas' rev: 11.00
...
private:
	...
	TTime __fastcall GetTimeEx(void);
	void __fastcall SetTimeEx(const TTime Value);
	System::TDateTime __fastcall GetDateTimeEx(void);
	AnsiString __fastcall GetFormatEx();
	void __fastcall SetFormatEx(const AnsiString Value);
	...
	TDate __fastcall GetDateEx(void);
	void __fastcall SetDateEx(const TDate Value);
...
protected:
	...
	virtual void __fastcall TimePickerKeyPress(System::TObject* Sender, char &Key);
	void __fastcall TimePickerKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
...
__published:
	...
	__property Ctl3D ;
	__property TDate Date = {read=GetDateEx, write=SetDateEx};
	__property System::TDateTime DateTime = {read=GetDateTimeEx, write=SetDateTimeEx};
	__property AnsiString Format = {read=GetFormatEx, write=SetFormatEx};
	__property AnsiString TimeFormat = {read=GetTimeFormat, write=SetTimeFormat};
	__property TAdvDateTimeKind Kind = {read=FKind, write=SetKind, nodefault};
	__property TTime Time = {read=GetTimeEx, write=SetTimeEx};
