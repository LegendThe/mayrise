...
// (DO NOT EDIT: machine generated header) 'Advofficepager.pas' rev: 11.00
...
public:
	...
	_di_IFloatingPagerWindow __fastcall FloatingWindow();
...
private:
	...
	TTabAppearance* FTabAppearance;
	Advglowbutton::TGlowButtonAppearance* FGlowButtonAppearance;
	TMetaClass* FFloatingPagerWindowClass;
	bool FMultiLine;
...
protected:
	...
	TAdvOfficePage* __fastcall PageByName(AnsiString Value);
	TAdvOfficePage* __fastcall PageByCaption(AnsiString Value);
...
public:
	...
	__property TMetaClass* FloatingPagerWindowClass = {read=FFloatingPagerWindowClass, write=FFloatingPagerWindowClass};
...
__interface  INTERFACE_UUID("{26C994ED-F15A-4CBC-92FF-5DD24E3D24C6}") IFloatingPagerWindow  : public IInterface 
{
...
private:
	void *__IFloatingPagerWindow;	/* Advofficepager::IFloatingPagerWindow */
...
typedef DynamicArray<Types::TPoint >  AdvOfficePager__71;
