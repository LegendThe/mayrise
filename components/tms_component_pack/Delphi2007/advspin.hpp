...
// (DO NOT EDIT: machine generated header) 'Advspin.pas' rev: 11.00
...
private:
	...
	bool __fastcall DoCheckInt(void);
	bool __fastcall DoCheckFloat(void);
	bool __fastcall DoCheckDate(void);
	
protected:
	virtual void __fastcall SetEnabled(bool Value);
	virtual bool __fastcall GetVisible(void);
	HIDESBASE virtual void __fastcall SetVisible(const bool Value);
...
__published:
	...
	__property bool CheckMinValue = {read=FCheckMinValue, write=FCheckMinValue, default=1};
	__property bool CheckMaxValue = {read=FCheckMaxValue, write=FCheckMaxValue, default=1};
...
extern PACKAGE AnsiString SPIN_HOURFORMAT;
