...
// (DO NOT EDIT: machine generated header) 'Advgroupbox.pas' rev: 11.00
...
#pragma option push -b-
enum TCheckBoxAction { caNone, caDisable, caCheckAll };
#pragma option pop
