...
// (DO NOT EDIT: machine generated header) 'Htmltv.pas' rev: 11.00
...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TAnchorClick)(System::TObject* Sender, Comctrls::TTreeNode* Node, AnsiString anchor);
...
private:
	...
	Graphics::TBitmap* FGlyphRadio;
	Graphics::TBitmap* FGlyphRadioSelected;
	bool FIsWinXP;
	...
	void __fastcall ShowH(AnsiString &HintStr, bool &CanShow, Forms::THintInfo &HintInfo);
	...
	void __fastcall SetGlyphRadio(const Graphics::TBitmap* Value);
	void __fastcall SetGlyphRadioSelected(const Graphics::TBitmap* Value);
...
public:
	...
	AnsiString __fastcall NodeText(Comctrls::TTreeNode* Node);
	void __fastcall SetComponentStyle(Advstyleif::TTMSStyle AStyle);
	__property ReadOnly  = {default=0};
	
__published:
	__property bool AutoChildCheck = {read=FAutoChildCheck, write=FAutoChildCheck, default=0};
	...
	__property Graphics::TBitmap* GlyphRadio = {read=FGlyphRadio, write=SetGlyphRadio};
	__property Graphics::TBitmap* GlyphRadioSelected = {read=FGlyphRadioSelected, write=SetGlyphRadioSelected};
