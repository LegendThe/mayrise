...
// (DO NOT EDIT: machine generated header) 'Customeditor.pas' rev: 11.00
...
__published:
	...
	void __fastcall AdvPolyList1KeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
...
public:
	...
	void __fastcall AddNewItem(AnsiString ItemClassString, int NewIndex, int X, int Y);
