...
// (DO NOT EDIT: machine generated header) 'Advmetroreplacedialog.pas' rev: 11.00

#ifndef AdvmetroreplacedialogHPP
#define AdvmetroreplacedialogHPP
...
namespace Advmetroreplacedialog
{
//-- type declarations -------------------------------------------------------
...
class DELPHICLASS TAdvMetroReplaceDialog;
class PASCALIMPLEMENTATION TAdvMetroReplaceDialog : public Advreplacedialogform::TAdvReplaceDialog 
{
	typedef Advreplacedialogform::TAdvReplaceDialog inherited;
	
private:
	Advstyleif::TColorTones FTones;
	
protected:
	virtual Advreplacedialogform::TReplaceDialogForm* __fastcall CreateDialogForm(Classes::TComponent* AOwner);
...
public:
	...
	__fastcall virtual TAdvMetroReplaceDialog(Classes::TComponent* AOwner);
	__fastcall virtual ~TAdvMetroReplaceDialog(void);
...
class DELPHICLASS TMetroReplaceDialogForm;
class PASCALIMPLEMENTATION TMetroReplaceDialogForm : public Advreplacedialogform::TReplaceDialogForm 
{
	typedef Advreplacedialogform::TReplaceDialogForm inherited;
...
public:
	...
	Advglowbutton::TAdvGlowButton* ReplaceBtnAGB;
	Advglowbutton::TAdvGlowButton* ReplaceAllBtnAGB;
	Advglowbutton::TAdvGlowButton* CloseBtnAGB;
	Advglowbutton::TAdvGlowButton* MoreBtnAGB;
	__fastcall virtual TMetroReplaceDialogForm(Classes::TComponent* AOwner);
	__fastcall virtual TMetroReplaceDialogForm(Classes::TComponent* AOwner, int Dummy);
	__fastcall virtual ~TMetroReplaceDialogForm(void);
	void __fastcall SetColorTones(const Advstyleif::TColorTones &ATones);
...
public:
	...
	/* TWinControl.CreateParented */ inline __fastcall TMetroReplaceDialogForm(HWND ParentWindow) : Advreplacedialogform::TReplaceDialogForm(ParentWindow) { }
	#pragma option pop
...
extern PACKAGE TMetroReplaceDialogForm* MetroReplaceDialogForm;
extern PACKAGE bool More;

}	/* namespace Advmetroreplacedialog */
using namespace Advmetroreplacedialog;
#pragma pack(pop)
#pragma option pop

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// Advmetroreplacedialog
