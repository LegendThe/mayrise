...
// (DO NOT EDIT: machine generated header) 'Asgdd.pas' rev: 11.00
...
private:
	...
	AnsiString __fastcall SomeRTF(Word Format);
	bool __fastcall SomeFiles(Classes::TStringList* &Files);
	Classes::TMemoryStream* __fastcall SomeStream(Word Format);
...
public:
	__fastcall TSourceDataObject(const AnsiString stxt, const AnsiString srtf, int sidx, Classes::TMemoryStream* ms);
...
extern PACKAGE HRESULT __fastcall StartTextDoDragDrop(TASGDropSource* DropSource, AnsiString stxt, AnsiString srtf, Classes::TMemoryStream* ms, int dwOKEffects, int &dwEffect);
