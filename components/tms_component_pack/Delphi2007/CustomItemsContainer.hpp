...
// (DO NOT EDIT: machine generated header) 'Customitemscontainer.pas' rev: 11.00
...
class DELPHICLASS TActionCustomItem;
class PASCALIMPLEMENTATION TActionCustomItem : public Gdipcustomitem::TCustomItem 
{
	typedef Gdipcustomitem::TCustomItem inherited;
	
public:
	#pragma option push -w-inl
	/* TCustomItem.Create */ inline __fastcall virtual TActionCustomItem(Classes::TComponent* AOwner) : Gdipcustomitem::TCustomItem(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomItem.Destroy */ inline __fastcall virtual ~TActionCustomItem(void) { }
	#pragma option pop
...
private:
	...
	bool FIsAppMenu;
	bool FIsMainMenu;
	Advgdip::TextRenderingHint FTextRenderingHint;
	Gdipbase::TItemAppearanceEvent FOnItemAppearance;
	Gdipbase::TItemReorderEvent FOnItemReorder;
	...
	void __fastcall SetTextRenderingHint(const Advgdip::TextRenderingHint Value);
	
protected:
	bool __fastcall IsMetroStyle(void);
	...
	void __fastcall Anchor(AnsiString Anchor);
	...
	void __fastcall ListItemAppearance(System::TObject* Sender, Gdipcustomitem::TCustomItem* Item, const Gdipcustomitem::TItemAppearance &Appearance);
	...
	__property Gdipbase::TItemAppearanceEvent OnItemAppearance = {read=FOnItemAppearance, write=FOnItemAppearance};
	__property Gdipbase::TItemReorderEvent OnItemReorder = {read=FOnItemReorder, write=FOnItemReorder};
...
public:
	...
	Gdipcustomitem::TCustomItem* __fastcall AddItem(TMetaClass* AClass);
	...
	Gdipcustomitem::TCustomItem* __fastcall InsertItem(int Index, TMetaClass* AClass);
	...
	__property Advgdip::TextRenderingHint TextRendering = {read=FTextRenderingHint, write=SetTextRenderingHint, default=5};
public:
	#pragma option push -w-inl
