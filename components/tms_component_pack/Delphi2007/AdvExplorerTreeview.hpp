...
// (DO NOT EDIT: machine generated header) 'Advexplorertreeview.pas' rev: 11.00
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall ETreeViewError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall ETreeViewError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	...
	TAdvTreeNode* __fastcall AddFirst(const AnsiString S)/* overload */;
	TAdvTreeNode* __fastcall AddFirst(System::TObject* Data, const AnsiString S)/* overload */;
	TAdvTreeNode* __fastcall Add(const AnsiString S)/* overload */;
	TAdvTreeNode* __fastcall Add(System::TObject* Data, const AnsiString S)/* overload */;
	...
	TAdvTreeNode* __fastcall Insert(TAdvTreeNode* Sibling, const AnsiString S);
	TAdvTreeNode* __fastcall InsertObject(TAdvTreeNode* Sibling, const AnsiString S, System::TObject* Data);
...
typedef void __fastcall (__closure *TPopulateChildEvent)(System::TObject* Sender, TAdvTreeNode* ParentNode, AnsiString Path, bool &PopulateAllowed);

#pragma option push -b-
enum TEditStyle { esList, esEdit };
#pragma option pop

typedef void __fastcall (__closure *TNodePopulateEvent)(System::TObject* Sender, TAdvTreeNode* ANode);
...
private:
	...
	int FUpdateCount;
	AnsiString FNewSelectedFolderPath;
	...
	TNodePopulateEvent FOnNodePopulate;
	...
	void __fastcall OnListBoxKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	void __fastcall OnListBoxKeyKeyPress(System::TObject* Sender, char &Key);
	...
	void __fastcall OnAutoCompListBoxKeyPress(System::TObject* Sender, char &Key);
	void __fastcall OnAutoCompListBoxKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	...
	void __fastcall SetFolderPath(const AnsiString Value);
	tagSIZE __fastcall GetIconSize();
	...
	void __fastcall SetDirectText(AnsiString Value);
	bool __fastcall GetDropDownButton(void);
...
protected:
	...
	Types::TRect __fastcall GetNodeButtonsRect();
	Types::TRect __fastcall GetRefreshButtonRect();
	Types::TRect __fastcall GetDropDownButtonRect();
	Types::TRect __fastcall GetLeftIconRect();
	AnsiString __fastcall GetHierarchicalNodeText(TAdvTreeNode* N, bool IncludeFolderPath = true);
	...
	__property bool DropDownButton = {read=GetDropDownButton, write=SetDropDownButton, default=1};
	...
	__property AnsiString FolderPath = {read=FFolderPath, write=SetFolderPath};
	...
	__property TNodePopulateEvent OnNodePopulate = {read=FOnNodePopulate, write=FOnNodePopulate};
...
public:
	...
	void __fastcall LoadDirectoryStructure(TBaseNode BaseNode, AnsiString path, bool ClearOldNodes);
	void __fastcall AddSubFolders(AnsiString path, TAdvTreeNode* ParentNode);
	AnsiString __fastcall GetNodePath(TAdvTreeNode* Node);
	void __fastcall RefreshSubFolders(TAdvTreeNode* ParentNode);
	virtual void __fastcall Clear(void);
	AnsiString __fastcall GetSelectedFolder();
	void __fastcall SetSelectedFolder(AnsiString Path, bool Immediately = true);
...
protected:
	...
	virtual void __fastcall DoNodePopulate(TAdvTreeNode* Node);
...
public:
	...
	TAdvTreeNode* __fastcall AddFirstChild(const AnsiString S)/* overload */;
	TAdvTreeNode* __fastcall AddFirstChild(System::TObject* Data, const AnsiString S)/* overload */;
	TAdvTreeNode* __fastcall AddChild(const AnsiString S)/* overload */;
	TAdvTreeNode* __fastcall AddChild(System::TObject* Data, const AnsiString S)/* overload */;
	virtual void __fastcall Assign(Classes::TPersistent* Source);
...
__published:
	...
	__property DropDownButton  = {default=1};
...
static const char NODE_SEP = '\x5c';
...
extern PACKAGE Word WM_ET_HIDEDROPDOWN;
extern PACKAGE Word WM_ET_SETFOLDERPATH;
extern PACKAGE Word WM_ET_TRACKKEYPRESS;
