...
// (DO NOT EDIT: machine generated header) 'Advsmoothexpanderbuttonpanel.pas' rev: 11.00
...
protected:
	...
	virtual void __fastcall DoButtonClick(int idx);
	virtual void __fastcall DoButtonClicked(int idx);
...
private:
	...
	void __fastcall SetStatusCaption(const AnsiString Value);
...
__published:
	...
	__property AnsiString StatusCaption = {read=FStatusCaption, write=SetStatusCaption};
...
//-- end unit ----------------------------------------------------------------
#endif	// Advsmoothexpanderbuttonpanel
