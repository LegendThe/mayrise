...
// (DO NOT EDIT: machine generated header) 'Advdbcombobox.pas' rev: 11.00
...
private:
	AnsiString __fastcall GetStoredStrings(int Index);
	void __fastcall PutStoredStrings(int Index, const AnsiString Value);
...
protected:
	...
	int __fastcall AddStored(AnsiString StoredS)/* overload */;
	
public:
	__fastcall TAdvDBComboBoxStrings(void);
	__fastcall virtual ~TAdvDBComboBoxStrings(void);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	virtual int __fastcall Add(const AnsiString S);
	int __fastcall AddStored(const AnsiString S, AnsiString StoredS)/* overload */;
	int __fastcall AddStoredObject(const AnsiString S, AnsiString StoredS, System::TObject* AObject);
	virtual void __fastcall Insert(int Index, const AnsiString S);
	void __fastcall InsertStored(int Index, const AnsiString S, AnsiString StoredS);
	virtual void __fastcall Clear(void);
	void __fastcall ClearAll(void);
	virtual void __fastcall Delete(int Index);
	int __fastcall IndexOfStored(AnsiString s);
	__property AnsiString StoredStrings[int Index] = {read=GetStoredStrings, write=PutStoredStrings};
};
...
private:
	...
	AnsiString __fastcall GetLabelField();
...
public:
	...
	HIDESBASE void __fastcall AddItem(AnsiString Item, AnsiString StoredValue, System::TObject* AObject);
	virtual void __fastcall Clear(void);
	void __fastcall AddDisplayAndStoredValue(AnsiString Displayed, AnsiString Stored);
	AnsiString __fastcall StoredToDispText(AnsiString StoredText);
	AnsiString __fastcall GetDisplayValue(int Index);
	AnsiString __fastcall GetStoredValue(int Index);
	__property AnsiString StoredStrings[int Index] = {read=GetStoredStrings, write=PutStoredStrings};
...
__published:
	...
	__property AnsiString LabelField = {read=GetLabelField, write=SetLabelField};
