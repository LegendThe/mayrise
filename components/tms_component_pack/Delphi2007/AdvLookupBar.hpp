...
// (DO NOT EDIT: machine generated header) 'Advlookupbar.pas' rev: 11.00
...
public:
	__property Byte Transparency = {read=FTransparency, write=FTransparency, nodefault};
...
private:
	...
	bool FMouseDown;
	TCharRec FChar[36];
	DynamicArray<TCharRec >  FCustomChar;
...
public:
	...
	void __fastcall SelectLookup(AnsiString Lookup);
...
typedef TCharRec AdvLookupBar__6[36];

typedef DynamicArray<TCharRec >  AdvLookupBar__7;
