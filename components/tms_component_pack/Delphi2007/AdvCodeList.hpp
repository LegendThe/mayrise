...
// (DO NOT EDIT: machine generated header) 'Advcodelist.pas' rev: 11.00
...
private:
	...
	AnsiString __fastcall GetBlock(int index);
	void __fastcall SetBlock(int Index, AnsiString Value);
...
protected:
	...
	DYNAMIC void __fastcall KeyDown(Word &KeyCode, Classes::TShiftState Shift);
	DYNAMIC void __fastcall MouseMove(Classes::TShiftState Shift, int X, int Y);
	DYNAMIC void __fastcall MouseDown(Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
	DYNAMIC void __fastcall MouseUp(Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
	void __fastcall DrawItemEx(Graphics::TCanvas* ACanvas, int Index, const Types::TRect &ARect, Windows::TOwnerDrawState State);
	virtual void __fastcall DrawItem(int Index, const Types::TRect &Rect, Windows::TOwnerDrawState State);
	virtual void __fastcall Notification(Classes::TComponent* AComponent, Classes::TOperation AOperation);
	void __fastcall AddBlock(AnsiString Source);
	__property int BlockCount = {read=FBlockCount, nodefault};
	__property AnsiString Blocks[int Index] = {read=GetBlock, write=SetBlock};
...
public:
	...
	HIDESBASE TCodeBlock* __fastcall Add(AnsiString Text);
	HIDESBASE TCodeBlock* __fastcall Insert(int Index, AnsiString Text);
