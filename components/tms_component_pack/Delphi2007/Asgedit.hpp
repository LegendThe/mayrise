...
// (DO NOT EDIT: machine generated header) 'Asgedit.pas' rev: 11.00
...
class PASCALIMPLEMENTATION TAsgEditBtn : public Mask::TCustomMaskEdit 
{
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TAsgEditBtn(HWND ParentWindow) : Mask::TCustomMaskEdit(ParentWindow) { }
	#pragma option pop
...
private:
	...
	AnsiString __fastcall GetTextAndUnit();
	void __fastcall SetTextAndUnit(const AnsiString Value);
...
public:
	...
	__property AnsiString TextAndUnit = {read=GetTextAndUnit, write=SetTextAndUnit};
