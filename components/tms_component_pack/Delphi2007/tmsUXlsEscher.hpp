...
// (DO NOT EDIT: machine generated header) 'Tmsuxlsescher.pas' rev: 11.00
...
public:
	...
	/* TBaseRecord.Create */ inline __fastcall virtual TXlsEscherRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : Tmsuxlsbaserecords::TBaseRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TDrawingGroupRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : TXlsEscherRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TDrawingRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : TXlsEscherRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TDrawingSelectionRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : TXlsEscherRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	...
	void __fastcall DeleteRows(const Word aRow, const Word aCount, const Tmsxlsmessages::TSheetInfo &SheetInfo, const System::TObject* dSheet);
	void __fastcall DeleteCols(const Word aCol, const Word aCount, const Tmsxlsmessages::TSheetInfo &SheetInfo, const System::TObject* dSheet);
	Tmsuescherrecords::TEscherClientDataRecord* __fastcall FindObjId(const Word ObjId);
