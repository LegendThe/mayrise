...
// (DO NOT EDIT: machine generated header) 'Advtrackbar.pas' rev: 11.00
...
#pragma option push -b-
enum TMoveOnClick { mcStep, mcMove, mcMoveSlide };
#pragma option pop
...
typedef void __fastcall (__closure *TDrawTickEvent)(System::TObject* Sender, Graphics::TCanvas* Canvas, const Types::TPoint &Location, int Position, Comctrls::TTickMark TickPos, int &Length, Graphics::TColor &Color, Graphics::TColor &TextColor, AnsiString &Text, bool &DefaultDraw);
...
typedef void __fastcall (__closure *TGetTrackLabelEvent)(System::TObject* Sender, int Position, AnsiString &value);

typedef void __fastcall (__closure *TGetTickMarkTextEvent)(System::TObject* Sender, int Index, AnsiString &value);

typedef void __fastcall (__closure *TWheelEvent)(System::TObject* Sender, int Position, int &NewPosition, bool &Allow);
...
private:
	...
	int FMouseDownD;
	TWheelEvent FOnMouseWheelDown;
	TWheelEvent FOnMouseWheelUp;
...
protected:
	...
	virtual Types::TRect __fastcall TickMarkTopRect();
	virtual Types::TRect __fastcall TickMarkBottomRect();
	...
	__property TWheelEvent OnMouseWheelUp = {read=FOnMouseWheelUp, write=FOnMouseWheelUp};
	__property TWheelEvent OnMouseWheelDown = {read=FOnMouseWheelDown, write=FOnMouseWheelDown};
...
typedef void __fastcall (__closure *TGetSliderLabelEvent)(System::TObject* Sender, int PosLeft, int PosRight, AnsiString &value);
