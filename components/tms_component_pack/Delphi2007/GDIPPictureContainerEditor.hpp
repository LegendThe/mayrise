...
// (DO NOT EDIT: machine generated header) 'Gdippicturecontainereditor.pas' rev: 11.00
...
__published:
	...
	void __fastcall FileListKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
...
public:
	...
	void __fastcall PopulateDirectory(AnsiString AFolder);
...
extern PACKAGE AnsiString CurrentDir;
...
//-- end unit ----------------------------------------------------------------
#endif	// Gdippicturecontainereditor
