...
// (DO NOT EDIT: machine generated header) 'Advsyskeyboardhook.pas' rev: 11.00
...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TAdvSysKeyEvent)(System::TObject* Sender, Word Key, Classes::TShiftState Shift, bool &Allow);
...
private:
	...
	int FAltTabHotKeyID;
	void __fastcall Button1KeyUp(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
