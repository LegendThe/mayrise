...
// (DO NOT EDIT: machine generated header) 'Hotspotimage.pas' rev: 11.00
...
private:
	...
	DynamicArray<TRealPoint >  FPoints;
	double FEx1;
	double FEx2;
	double FEy1;
	double FEy2;
...
private:
	...
	void __fastcall InternalRotate90Degrees(void);
...
public:
	...
	THotSpot* __fastcall HotSpotByName(AnsiString Name);
	void __fastcall Rotate(bool Clockwise);
	void __fastcall RotateReset(void);
...
private:
	...
	TPoints __fastcall getPolyPoints();
...
protected:
	...
	void __fastcall ReCalcClips(void);
...
extern PACKAGE bool TMSHotSpot_V1Compatibility;
...
extern PACKAGE void __fastcall WriteString(Classes::TStream* S, AnsiString Buffer);
extern PACKAGE AnsiString __fastcall ReadString(Classes::TStream* S);
