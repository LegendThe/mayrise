...
// (DO NOT EDIT: machine generated header) 'Tmsuxlsotherrecords.pas' rev: 11.00
...
public:
	...
	__fastcall virtual TBOFRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize);
public:
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TEOFRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : Tmsuxlsbaserecords::TBaseRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	/*         class method */ static void __fastcall SaveNewRecord(TMetaClass* vmt, const Tmsuole2impl::TOle2File* Workbook);
	/*         class method */ static int __fastcall GetSize(TMetaClass* vmt, const bool HasTemplate);
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TTemplateRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : Tmsuxlsbaserecords::TBaseRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	Word ObjId;
	Word CmoId;
	__fastcall virtual TObjRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize);
public:
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TTXORecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : Tmsuxlsbaserecords::TBaseRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	unsigned Count;
	__fastcall virtual TSSTRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize);
public:
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TBoundSheetRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : Tmsuxlsbaserecords::TBaseRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TCodeNameRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : Tmsuxlsbaserecords::TBaseRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TObProjRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : Tmsuxlsbaserecords::TBaseRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TRangeRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : Tmsuxlsbaserecords::TBaseRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TCellMergingRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : TRangeRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TDValRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : TRangeRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	bool RecalcNeeded;
	__fastcall virtual TGutsRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize);
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TPaneRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : Tmsuxlsbaserecords::TBaseRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
