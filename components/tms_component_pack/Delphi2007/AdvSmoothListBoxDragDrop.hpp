...
// (DO NOT EDIT: machine generated header) 'Advsmoothlistboxdragdrop.pas' rev: 11.00
...
extern PACKAGE HRESULT __fastcall StartTextDoDragDrop(TListBoxDropSource* DropSource, AnsiString stxt, AnsiString srtf, int dwOKEffects, int &dwEffect);
...
//-- end unit ----------------------------------------------------------------
#endif	// Advsmoothlistboxdragdrop
