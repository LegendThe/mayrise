...
// (DO NOT EDIT: machine generated header) 'Gdipbase.pas' rev: 11.00
...
typedef void __fastcall (__closure *TItemAppearanceEvent)(System::TObject* Sender, Gdipcustomitem::TCustomItem* Item, const Gdipcustomitem::TItemAppearance &Appearance);
...
private:
	...
	TItemAppearanceEvent FOnItemAppearance;
	bool FMetroStyle;
...
protected:
	...
	Gdipcustomitem::TItemAppearance __fastcall CreateAppearance();
	void __fastcall CopyAppearance(const Gdipcustomitem::TItemAppearance &Appearance, Gdipcustomitem::TItemAppearance &CopyAppearance);
	void __fastcall DestroyAppearance(const Gdipcustomitem::TItemAppearance &Appearance);
	
public:
	__property bool MetroStyle = {read=FMetroStyle, write=FMetroStyle, nodefault};
	...
	void __fastcall DoCMDialogChar(Messages::TWMKey &Message);
	...
	void __fastcall DoKeyDownGrid(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	void __fastcall DoKeyDownBox(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	void __fastcall DoKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	void __fastcall DoKeyUp(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	void __fastcall ProcessKeyGrid(Word Key, int &SelRow, int &SelCol);
	void __fastcall ProcessKeyBox(Word Key, int &ItemIndex);
	void __fastcall DrawItems(Advgdip::TGPGraphics* g, bool Focused);
	void __fastcall ConvertItem(Gdipcustomitem::TCustomItem* it, TMetaClass* AItemClass);
	...
	TMetaClass* __fastcall GetItemClassByCustomName(AnsiString ACustomName);
	...
	Gdipcustomitem::TItemAppearance __fastcall GetItemAppearance();
	...
	__property TItemAppearanceEvent OnItemAppearance = {read=FOnItemAppearance, write=FOnItemAppearance};
...
typedef void __fastcall (__closure *TItemReorderEvent)(System::TObject* Sender, Gdipcustomitem::TCustomItem* AItem, Gdipcustomitem::TCustomItem* ADropItem, bool &Allow);
...
private:
	TMetaClass* FParentClass;
	void __fastcall CallbackClass(TMetaClass* AClass);
	
public:
	void __fastcall Execute(const TMetaClass* aClass);
public:
	#pragma option push -w-inl
