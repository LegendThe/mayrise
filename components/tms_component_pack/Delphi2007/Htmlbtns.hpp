...
// (DO NOT EDIT: machine generated header) 'Htmlbtns.pas' rev: 11.00
...
private:
	...
	void __fastcall SetDisabledShadow(const bool Value);
...
__published:
	...
	__property bool DisabledShadow = {read=FDisabledShadow, write=SetDisabledShadow, default=1};
...
protected:
	...
	virtual void __fastcall Notification(Classes::TComponent* AComponent, Classes::TOperation AOperation);
	void __fastcall OnAnchorClickEvent(System::TObject* Sender, AnsiString Anchor);
	void __fastcall OnAnchorEnterEvent(System::TObject* Sender, AnsiString Anchor);
	void __fastcall OnAnchorExitEvent(System::TObject* Sender, AnsiString Anchor);
