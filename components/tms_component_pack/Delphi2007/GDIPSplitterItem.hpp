...
// (DO NOT EDIT: machine generated header) 'Gdipsplitteritem.pas' rev: 11.00
...
private:
	...
	void __fastcall SetLineOpacityTo(const Byte Value);
...
__published:
	...
	__property Byte LineOpacityTo = {read=FLineOpacityTo, write=SetLineOpacityTo, default=255};
