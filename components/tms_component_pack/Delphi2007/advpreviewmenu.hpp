...
// (DO NOT EDIT: machine generated header) 'Advpreviewmenu.pas' rev: 11.00
...
private:
	...
	void __fastcall OnButtonKeyPress(System::TObject* Sender, char &Key);
	void __fastcall OnButtonKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
...
protected:
	...
	DYNAMIC void __fastcall MouseUp(Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
	DYNAMIC void __fastcall KeyDown(Word &Key, Classes::TShiftState Shift);
	void __fastcall DrawShortCutHint(Graphics::TCanvas* Canvas, AnsiString ShortCutHint, const Types::TPoint &Pt, bool Shaded);
...
private:
	...
	Controls::TImageList* FButtonDisabledImages;
	Imglist::TCustomImageList* FSubMenuDisabledImages;
	Imglist::TCustomImageList* FMenuDisabledImages;
	...
	void __fastcall SetButtonDisabledImages(const Controls::TImageList* Value);
	void __fastcall SetMenuDisabledImages(const Imglist::TCustomImageList* Value);
	void __fastcall SetSubMenuDisabledImages(const Imglist::TCustomImageList* Value);
...
__published:
	...
	__property Imglist::TCustomImageList* MenuDisabledImages = {read=FMenuDisabledImages, write=SetMenuDisabledImages};
	__property int MenuWidth = {read=FMenuWidth, write=FMenuWidth, nodefault};
	__property AnsiString MenuText = {read=FMenuText, write=FMenuText};
	...
	__property Imglist::TCustomImageList* SubMenuDisabledImages = {read=FSubMenuDisabledImages, write=SetSubMenuDisabledImages};
	__property Controls::TImageList* ButtonImages = {read=FButtonImages, write=SetButtonImages};
	__property Controls::TImageList* ButtonDisabledImages = {read=FButtonDisabledImages, write=SetButtonDisabledImages};
...
private:
	...
	void __fastcall SetWideTitle(const WideString Value);
	void __fastcall SetWideNotes(const WideString Value);
...
__published:
	__property Classes::TBasicAction* Action = {read=GetAction, write=SetAction};
	__property AnsiString Title = {read=FTitle, write=SetTitle, stored=IsTitleStored};
	__property WideString WideTitle = {read=FWideTitle, write=SetWideTitle};
	__property Classes::TStringList* Notes = {read=FNotes, write=SetNotes};
	__property WideString WideNotes = {read=FWideNotes, write=SetWideNotes};
