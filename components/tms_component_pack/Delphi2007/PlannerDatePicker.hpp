...
// (DO NOT EDIT: machine generated header) 'Plannerdatepicker.pas' rev: 11.00
...
protected:
	...
	void __fastcall PlannerCalendarKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	void __fastcall PlannerCalendarKeyUp(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
