...
// (DO NOT EDIT: machine generated header) 'Htmlcredit.pas' rev: 11.00

#ifndef HtmlcreditHPP
#define HtmlcreditHPP
...
class DELPHICLASS THTMLCredit;
class PASCALIMPLEMENTATION THTMLCredit : public Stdctrls::TCustomStaticText 
{
...
private:
	...
	void __fastcall SetScrollSpeed(const int Value);
...
public:
	__fastcall virtual THTMLCredit(Classes::TComponent* AOwner);
	__fastcall virtual ~THTMLCredit(void);
...
__published:
	...
	__property int ScrollSpeed = {read=FScrollSpeed, write=SetScrollSpeed, default=100};
	__property int ScrollStep = {read=FScrollStep, write=FScrollStep, default=4};
	__property int ScrollPosition = {read=FVOffset, write=SetVOffset, default=0};
...
public:
	...
	/* TWinControl.CreateParented */ inline __fastcall THTMLCredit(HWND ParentWindow) : Stdctrls::TCustomStaticText(ParentWindow) { }
	#pragma option pop
