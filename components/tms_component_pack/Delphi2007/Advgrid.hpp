...
#include <Asgdatetimepicker.hpp>	// Pascal unit
...
typedef void __fastcall (__closure *TUnitChangedEvent)(System::TObject* Sender, int ACol, int ARow, AnsiString NewUnit);
...
#pragma option push -b-
enum TScrollType { ssNormal, ssFlat, ssEncarta, ssMetro };
#pragma option pop
...
typedef void __fastcall (__closure *TGridPrintPageNumEvent)(System::TObject* Sender, int PageNum, int PageColNum, AnsiString &PageNumString);
...
typedef void __fastcall (__closure *TColorSelectedEvent)(System::TObject* Sender, int ACol, int ARow, Graphics::TColor &Color, AnsiString &Value);

typedef void __fastcall (__closure *TColorSelectEvent)(System::TObject* Sender, int ACol, int ARow, Graphics::TColor Color, AnsiString Value);
...
typedef void __fastcall (__closure *TFixedEditEvent)(System::TObject* Sender, int ACol, int ARow, Advobj::TGridFixedCellEditor &AEditor, Classes::TStrings* Values);
...
typedef void __fastcall (__closure *TCellComboControlSelectEvent)(System::TObject* Sender, int ARow, int ACol, int ItemIndex, AnsiString CtrlID, AnsiString CtrlValue);
...
typedef void __fastcall (__closure *TAfterCellPasteEvent)(System::TObject* Sender, int ACol, int ARow, AnsiString Value);
...
typedef void __fastcall (__closure *TAfterCellPasteWideEvent)(System::TObject* Sender, int ACol, int ARow, WideString Value);
...
typedef void __fastcall (__closure *TCellCursorEvent)(System::TObject* Sender, int ACol, int ARow, int X, int Y, Controls::TCursor &ACursor);
...
typedef void __fastcall (__closure *TFilterCheckEvent)(System::TObject* Sender, int Column, int ItemIndex, AnsiString FriendlyName, AnsiString &FilterCondition, Checklst::TCheckListBox* CheckList);
...
class PASCALIMPLEMENTATION TDropCheckList : public Checklst::TCheckListBox 
{
...
public:
	#pragma option push -w-inl
	/* TCheckListBox.Create */ inline __fastcall virtual TDropCheckList(Classes::TComponent* AOwner) : Checklst::TCheckListBox(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCheckListBox.Destroy */ inline __fastcall virtual ~TDropCheckList(void) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TDropCheckList(HWND ParentWindow) : Checklst::TCheckListBox(ParentWindow) { }
	#pragma option pop
...
private:
	...
	Variant FCellVar;
	Stdctrls::TCheckBoxState FCellCheckBoxState;
...
public:
	...
	void __fastcall SetCheckBox(Stdctrls::TCheckBoxState Value, bool Flat, TCellHAlign hal, TCellVAlign val)/* overload */;
...
__published:
	...
	__property Stdctrls::TCheckBoxState CellCheckBoxState = {read=FCellCheckBoxState, write=FCellCheckBoxState, nodefault};
...
__published:
	...
	__property AnsiString Summary = {read=FSummary, write=FSummary};
...
public:
	...
	void __fastcall ToggleDirection(void);
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* TAsgCustomCombo.Destroy */ inline __fastcall virtual ~TControlCombo(void) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TAsgCustomCombo.Destroy */ inline __fastcall virtual ~TGridCombo(void) { }
	#pragma option pop
...
protected:
	...
	DYNAMIC void __fastcall DoExit(void);
	DYNAMIC void __fastcall Change(void);
	void __fastcall CheckMinMax(void);
...
class PASCALIMPLEMENTATION TGridTransCombo : public Stdctrls::TCustomComboBox 
{
...
public:
	TAdvStringGrid* FGrid;
	__fastcall virtual TGridTransCombo(Classes::TComponent* AOwner);
	bool __fastcall StopEdit(void);
...
public:
	#pragma option push -w-inl
	/* TCustomComboBox.Destroy */ inline __fastcall virtual ~TGridTransCombo(void) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TGridTransCombo(HWND ParentWindow) : Stdctrls::TCustomComboBox(ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TAsgDateTimePicker.Destroy */ inline __fastcall virtual ~TGridDatePicker(void) { }
	#pragma option pop
...
#pragma option push -b-
enum TFilterMethod { fmExpression, fmLiteral };
#pragma option pop
...
__interface ITAdvStringGridSelect;
typedef System::DelphiInterface<ITAdvStringGridSelect> _di_ITAdvStringGridSelect;
__interface  INTERFACE_UUID("{ED636930-EF86-46AD-80F7-FD29C28525EB}") ITAdvStringGridSelect  : public IInterface 
{
...
public:
	__fastcall virtual THTMLHintWindow(Classes::TComponent* AOwner);
...
private:
	...
	AnsiString FFindPrevCaption;
	AnsiString FMatchCaseCaption;
	AnsiString FHintFindPrev;
	AnsiString FHintClose;
	AnsiString FHintFindNext;
	AnsiString FHintHighlight;
	AnsiString FHighLightCaption;
	void __fastcall SetColorTo(const Graphics::TColor Value);
...
public:
	...
	__property AnsiString FindPrevCaption = {read=FFindPrevCaption, write=FFindPrevCaption};
	__property AnsiString MatchCaseCaption = {read=FMatchCaseCaption, write=FMatchCaseCaption};
	__property AnsiString HighLightCaption = {read=FHighLightCaption, write=FHighLightCaption};
	__property AnsiString HintClose = {read=FHintClose, write=FHintClose};
	__property AnsiString HintFindNext = {read=FHintFindNext, write=FHintFindNext};
	__property AnsiString HintFindPrev = {read=FHintFindPrev, write=FHintFindPrev};
	__property AnsiString HintHighlight = {read=FHintHighlight, write=FHintHighlight};
...
protected:
	...
	int __fastcall PaintCustomPaint(void);
	virtual void __fastcall Paint(void);
	virtual void __fastcall CreateWnd(void);
	Types::TRect __fastcall RTLCoord(bool rtl, const Types::TRect &ARect);
	int __fastcall GridColWidths(void);
...
#pragma option push -b-
enum TFooterStyle { fsFixedLastRow, fsColumnPreview, fsCustomPreview, fsCustomPaint };
#pragma option pop
...
#pragma option push -b-
enum TFilterDropDownColumns { fdNormal, fdAll };
#pragma option pop

#pragma option push -b-
enum THintShowLargeTextPos { hpCell, hpCursor };
#pragma option pop

class DELPHICLASS TScrollControl;
class PASCALIMPLEMENTATION TScrollControl : public Controls::TCustomControl 
{
...
private:
	...
	TAdvStringGrid* __fastcall Grid(void);
	HIDESBASE void __fastcall SetColor(const Graphics::TColor AValue);
...
public:
	__fastcall virtual TScrollControl(Classes::TComponent* AOwner);
...
public:
	#pragma option push -w-inl
	/* TCustomControl.Destroy */ inline __fastcall virtual ~TScrollControl(void) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TScrollControl(HWND ParentWindow) : Controls::TCustomControl(ParentWindow) { }
	#pragma option pop
...
class PASCALIMPLEMENTATION THeaderDragButton : public Controls::TCustomControl 
{
	typedef Controls::TCustomControl inherited;
...
public:
	#pragma option push -w-inl
	/* TCustomControl.Create */ inline __fastcall virtual THeaderDragButton(Classes::TComponent* AOwner) : Controls::TCustomControl(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomControl.Destroy */ inline __fastcall virtual ~THeaderDragButton(void) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall THeaderDragButton(HWND ParentWindow) : Controls::TCustomControl(ParentWindow) { }
	#pragma option pop
...
#pragma option push -b-
enum TCalcType { ctSum, ctAvg, ctMin, ctMax };
#pragma option pop
...
private:
	...
	#pragma pack(push,1)
	Types::TPoint FLastKeyCell;
	#pragma pack(pop)
	int FFilterLevel;
	AnsiString FLastFilter;
	bool FForceSel;
	int FMoveColInd;
	int FMoveRowInd;
	int FGroupColumn;
	AnsiString FGroupCaption;
	AnsiString FGroupFooter;
	int FGroupWidth;
	bool FAutoSize;
	bool FAutoNumAlign;
	bool FEnhTextSize;
	...
	AnsiString FNewCellText;
	WideString FOldCellTextWide;
	char FStartEditChar;
	int FOldCol;
	int FOldRow;
	int FOldRowSel;
	...
	TGridUniEdit* EditUni;
	TGridUniMemo* MemoUni;
	TGridUniCombo* ComboUni;
	TGridUniEditBtn* EditBtnUni;
	...
	TGetEditWideTextEvent FGetEditWideText;
	TSetEditWideTextEvent FSetEditWideText;
	TWideEllipsClickEvent FOnWideEllipsClick;
	...
	bool FSpreadSheet;
	#pragma pack(push,1)
	Types::TPoint FHoverCell;
	#pragma pack(pop)
	#pragma pack(push,1)
	Types::TPoint FHoverButton;
	#pragma pack(pop)
	int FHoverlink;
	int FOleDragCol;
	int FOleDragIndex;
	Stdctrls::TCustomListBox* FOleDragList;
	...
	void __fastcall ShowFocusHelper(const Types::TRect &R);
	void __fastcall HideFocusHelper(void);
	void __fastcall MoveFocusHelper(void);
	...
	Types::TRect __fastcall ExpandRect(int ACol, int ARow);
	...
	AnsiString __fastcall CopyFuncStr(const Grids::TGridRect &gd, bool DoDisjunct);
	...
	void __fastcall InitVCLStyle(void);
	...
	AnsiString __fastcall GetLookAsString(TGridLook Value);
	AnsiString __fastcall GetLookAsFriendlyString(TGridLook Value);
	void __fastcall CalcTextPos(Types::TRect &ARect, int AAngle, AnsiString ATxt, Classes::TAlignment hal, Advobj::TVAlignment val);
	...
	AnsiString __fastcall GetGridCellsEx(int i, int j);
	void __fastcall SetGridCellsEx(int i, int j, AnsiString Value);
	WideString __fastcall GetWideCellsEx(int i, int j);
	void __fastcall SetWideCellsEx(int i, int j, WideString Value);
	...
	int __fastcall PasteText(int ACol, int ARow, char * p, int &Cols, int &Rows);
	void __fastcall InputFromCSVStream(Classes::TStream* AStream, bool insertmode, int MaxRows);
	void __fastcall InputFromCSV(AnsiString FileName, bool insertmode, int MaxRows);
	void __fastcall OutputToCSV(AnsiString FileName, bool appendmode, bool unicode);
	void __fastcall OutputToHTML(AnsiString FileName, bool appendmode, bool Show = false, bool Unicode = true);
	void __fastcall LoadXLS(AnsiString filename, AnsiString sheetname);
	void __fastcall SaveXLS(AnsiString filename, AnsiString sheetname, bool CreateNewSheet);
	...
	Types::TPoint __fastcall PasteSize(char * p);
	void __fastcall MarkCells(AnsiString s, AnsiString tag, bool DoCase, int FromCol, int FromRow, int ToCol, int ToRow);
	void __fastcall UnMarkCells(AnsiString tag, int FromCol, int FromRow, int ToCol, int ToRow);
	AnsiString __fastcall GetUnSortedCell(int i, int j);
	void __fastcall SetUnSortedCell(int i, int j, const AnsiString Value);
	...
	AnsiString __fastcall GetFontNames(int i, int j);
	int __fastcall GetFontSizes(int i, int j);
	void __fastcall SetFontNames(int i, int j, const AnsiString Value);
	...
	AnsiString __fastcall GetCtrlVal(int ACol, int ARow, AnsiString ID);
	void __fastcall SetCtrlVal(int ACol, int ARow, AnsiString ID, const AnsiString Value);
	int __fastcall GetAllColCount(void);
	int __fastcall GetAllRowCount(void);
	WideString __fastcall GetWideCells(int i, int j);
	void __fastcall SetWideCells(int i, int j, const WideString Value);
	...
	Types::TPoint __fastcall FindInternal(const Types::TPoint &StartCell, AnsiString s, WideString sw, bool IsWide, TFindParams FindParams);
	bool __fastcall InNodeRect(int ARow, int x);
	void __fastcall SetVersion(const AnsiString Value);
	void __fastcall SaveToDOCInt(AnsiString FileName, AnsiString bookmark, bool CreateNewDocument, bool Append);
	void __fastcall SaveToASCIIInt(AnsiString FileName, bool AppendFile, bool Unicode);
	...
	Grids::TGridRect __fastcall GetSelectionEx();
	...
	AnsiString __fastcall GetOriginalCells(int i, int j);
	void __fastcall SetOriginalCells(int i, int j, const AnsiString Value);
	...
	Graphics::TFont* __fastcall GetCellFont(int i, int j);
	void __fastcall SetCellFont(int i, int j, const Graphics::TFont* Value);
	void __fastcall SetSortSettings(const TSortSettings* Value);
	void __fastcall SetSyncGrid(const Advobj::TSyncGrid* Value);
	int __fastcall GetColEx(void);
	void __fastcall SetColEx(const int Value);
	void __fastcall SetSpreadSheet(const bool Value);
	void __fastcall SetDefaultAlignment(const Classes::TAlignment Value);
	Advobj::TEditorType __fastcall GetCurrentEditor(void);
	void __fastcall SetSelectionColorMixer(const bool Value);
	void __fastcall SetBorderColor(const Graphics::TColor Value);
	void __fastcall SetFocusHelper(const Advobj::TFocusHelper* Value);
...
protected:
	...
	virtual void __fastcall DoF2Edit(void);
	virtual void __fastcall UpdateEditingCell(int ACol, int ARow, AnsiString Value);
	...
	virtual void __fastcall SetCurrentCell(const AnsiString AValue);
	virtual AnsiString __fastcall GetCurrentDisplCell();
	virtual void __fastcall SetEditCell(const AnsiString AValue);
	...
	void __fastcall AdvanceHTMLEdit(int ACol, int ARow, AnsiString CtrlID);
	...
	virtual AnsiString __fastcall GetCellFloatFormat(int ACol, int ARow);
	...
	virtual Types::TPoint __fastcall GetCellGraphicSizeEx(int ACol, int ARow, int Padding);
	...
	void __fastcall DrawCheck(const Types::TRect &R, bool State, bool Enabled, bool Grayed, TControlStyle ControlStyle, bool bTriState = false, Stdctrls::TCheckBoxState cbState = (Stdctrls::TCheckBoxState)(0x0));
	...
	virtual void __fastcall DoGetPrintPageNum(int PageNum, int PageNumCol, AnsiString &Value);
	...
	virtual void __fastcall DoFixedCellEdit(int ACol, int ARow, Advobj::TGridFixedCellEditor AEditor, Classes::TStrings* Values);
	...
	void __fastcall WideEllipsClick(System::TObject* Sender);
	...
	virtual void __fastcall EditProgress(AnsiString Value, const Types::TPoint &pt, int SelPos);
	...
	virtual void __fastcall LoadCell(int ACol, int ARow, AnsiString Value);
	...
	virtual void __fastcall DoSearchFooterAction(AnsiString AValue, int ACol, int ARow, TSearchAction ASearchAction);
	...
	virtual void __fastcall GetCellHint(int ACol, int ARow, AnsiString &AHint, WideString &AWideHint);
	...
	virtual void __fastcall GetColFormat(int ACol, Advobj::TSortStyle &AStyle, AnsiString &aPrefix, AnsiString &aSuffix);
	...
	virtual Grids::TGridRect __fastcall GetUsedCells();
	...
	void __fastcall UnitChanged(System::TObject* Sender, AnsiString NewUnit);
	...
	void __fastcall SetComment(int ACol, int ARow, AnsiString value);
	AnsiString __fastcall GetComment(int ACol, int ARow);
	...
	__property AnsiString OldCellText = {read=FOldCellText, write=FOldCellText};
	virtual Imglist::TCustomImageList* __fastcall GetCellImageList(int ACol, int ARow);
	bool __fastcall IsEditableInt(int ACol, int ARow);
	void __fastcall ForceMouseOnCell(int Col, int Row);
	void __fastcall GotoCellInt(int Col, int Row);
	virtual bool __fastcall UseVCLStyles(void);
	TAdvRichEdit* __fastcall GetRichEdit(void);
	TAdvRichEdit* __fastcall EditRichEdit(void);
	TGridDateTimePicker* __fastcall EditDateTime(void);
	TGridDatePicker* __fastcall EditDate(void);
	TGridSpin* __fastcall EditSpin(void);
	TGridAdvGridDropDown* __fastcall EditAdvGridPicker(void);
	TGridTrackbarDropDown* __fastcall EditTrackBar(void);
	TGridMemoDropDown* __fastcall EditMemo(void);
	TGridCalculatorDropDown* __fastcall EditCalculator(void);
	TGridTimepickerDropDown* __fastcall EditTimePicker(void);
	TGridDetailPickerDropDown* __fastcall EditDetailPicker(void);
	TGridGridDropDown* __fastcall EditGridPicker(void);
	TGridColorDropDown* __fastcall EditColorPicker(void);
	TGridImageDropDown* __fastcall EditImagePicker(void);
...
public:
	...
	void __fastcall CellControlsUpdate(bool rebuildlist = false);
	...
	void __fastcall OleColumnDragStart(int ACol, int AIndex, Stdctrls::TCustomListBox* AList);
	...
	virtual bool __fastcall ValidateCellWide(const WideString NewValue);
	...
	void __fastcall NarrowDown(AnsiString ACondition, int AColumn = 0xffffffff);
	...
	void __fastcall MergeCols(int ColIndex1, int ColIndex2, AnsiString Separator = " ");
	...
	virtual int __fastcall TotalColCount(void);
	...
	int __fastcall ColumnByHeader(AnsiString AValue);
	...
	void __fastcall ColorRect(int ACol1, int ARow1, int ACol2, int ARow2, Graphics::TColor AColor);
	...
	Classes::TStrings* __fastcall DistinctValues(int ACol, bool CaseSensitive = true);
	...
	void __fastcall AppendToASCII(AnsiString FileName);
	void __fastcall SaveToASCII(AnsiString FileName);
	void __fastcall SaveToBinFile(AnsiString FileName);
	...
	void __fastcall SaveToHTML(AnsiString FileName, bool Show = false, bool Unicode = true);
	AnsiString __fastcall SaveToHTMLString(AnsiString dir);
	void __fastcall AppendToHTML(AnsiString FileName, bool Show = false, bool Unicode = true);
	void __fastcall SaveToXML(AnsiString FileName, AnsiString ListDescr, AnsiString RecordDescr, Classes::TStrings* FieldDescr, bool ExportEmptyCells = false);
	void __fastcall LoadFromXML(AnsiString FileName, bool LevelToRow = false, bool LoadFieldDescr = true);
	...
	void __fastcall LoadFromBinFile(AnsiString FileName);
	...
	void __fastcall LoadFromCSV(AnsiString FileName, int MaxRows = 0xffffffff);
	void __fastcall LoadFromCSVStream(Classes::TStream* AStream, int MaxRows = 0xffffffff);
	void __fastcall LoadFromFixed(AnsiString FileName, Advobj::TIntList* positions, bool DoTrim = true, int MaxRows = 0xffffffff);
	void __fastcall InsertFromCSV(AnsiString FileName, int MaxRows = 0xffffffff);
	...
	AnsiString __fastcall ColumnStatesToString();
	void __fastcall StringToColumnStates(AnsiString Value);
	void __fastcall LoadVisualProps(AnsiString FileName);
	void __fastcall SaveVisualProps(AnsiString FileName);
	...
	AnsiString __fastcall GetSelectionAsText();
	void __fastcall SetSelectionAsText(const AnsiString Value);
	...
	void __fastcall FormatFill(bool DoFixed, AnsiString Fmt);
	...
	void __fastcall SaveToXLS(AnsiString Filename, bool CreateNewSheet = true);
	void __fastcall SaveToXLSSheet(AnsiString Filename, AnsiString SheetName);
	Classes::TStringList* __fastcall GetXLSSheets(AnsiString FileName);
	void __fastcall LoadFromXLS(AnsiString Filename);
	void __fastcall LoadFromXLSSheet(AnsiString Filename, AnsiString SheetName);
	void __fastcall LoadFromMDBTable(AnsiString Filename, AnsiString Table);
	void __fastcall LoadFromMDBSQL(AnsiString Filename, AnsiString SQL);
	void __fastcall AppendToDoc(AnsiString Filename, AnsiString Bookmark);
	void __fastcall SaveToDOC(AnsiString Filename, bool CreateNewDocument = true);
	...
	Types::TPoint __fastcall Find(const Types::TPoint &StartCell, AnsiString s, TFindParams FindParams);
	Types::TPoint __fastcall FindWide(const Types::TPoint &StartCell, WideString s, TFindParams FindParams);
	Types::TPoint __fastcall FindFirst(AnsiString s, TFindParams FindParams);
	Types::TPoint __fastcall FindNext();
	int __fastcall Replace(AnsiString OrigStr, AnsiString NewStr, TFindParams FindParams);
	...
	void __fastcall SetButtonText(int ACol, int ARow, AnsiString Caption);
	AnsiString __fastcall GetButtonText(int ACol, int ARow);
	...
	void __fastcall AddBitButton(int ACol, int ARow, int bw, int bh, AnsiString Caption, Graphics::TBitmap* Glyph, TCellHAlign hal, TCellVAlign val);
	Graphics::TBitmap* __fastcall CreateBitButton(int ACol, int ARow, int bw, int bh, AnsiString Caption, TCellHAlign hal, TCellVAlign val);
	void __fastcall AddCheckBox(int ACol, int ARow, bool State, bool Data)/* overload */;
	Stdctrls::TCheckBoxState __fastcall BoolToCheckBoxState(bool bChecked);
	void __fastcall AddCheckBox(int ACol, int ARow, Stdctrls::TCheckBoxState State)/* overload */;
	void __fastcall AddTriStateCheckBoxColumn(int ACol, Stdctrls::TCheckBoxState state);
	bool __fastcall GetCheckBoxState(int ACol, int ARow, Stdctrls::TCheckBoxState &state)/* overload */;
	...
	bool __fastcall SetCheckBoxState(int ACol, int ARow, Stdctrls::TCheckBoxState State)/* overload */;
	...
	void __fastcall AddProgressFormatted(int ACol, int ARow, Graphics::TColor FGColor, Graphics::TColor FGTextColor, Graphics::TColor BKColor, Graphics::TColor BKTextColor, AnsiString Fmt, int Min, int Max);
	...
	void __fastcall AddBalloon(int ACol, int ARow, AnsiString Title, AnsiString Text, TBalloonIcon Icon);
	void __fastcall RemoveBalloon(int ACol, int ARow);
	bool __fastcall HasBalloon(int ACol, int ARow);
	bool __fastcall IsBalloon(int ACol, int ARow, AnsiString &Title, AnsiString &Text, TBalloonIcon &Icon);
	void __fastcall AddComment(int ACol, int ARow, AnsiString Comment);
	void __fastcall AddColorComment(int ACol, int ARow, AnsiString Comment, Graphics::TColor Color);
	...
	__property AnsiString CellComment[int ACol][int ARow] = {read=GetComment, write=SetComment};
	...
	double __fastcall RectCalc(const Grids::TGridRect &GR, TCalcType CalcType);
	double __fastcall RectSum(const Grids::TGridRect &GR);
	double __fastcall RectAvg(const Grids::TGridRect &GR);
	double __fastcall RectMin(const Grids::TGridRect &GR);
	double __fastcall RectMax(const Grids::TGridRect &GR);
	double __fastcall SelectionSum(void);
	double __fastcall SelectionAvg(void);
	double __fastcall SelectionMin(void);
	double __fastcall SelectionMax(void);
	...
	__property AnsiString ControlValues[int ACol][int ARow][AnsiString ID] = {read=GetCtrlVal, write=SetCtrlVal};
	...
	__property AnsiString OriginalCellValue = {read=FCellCache, write=FCellCache};
	...
	__property TGridUniCombo* UniCombo = {read=ComboUni};
	__property TGridUniEdit* UniEdit = {read=EditUni};
	__property TGridUniMemo* UniMemo = {read=MemoUni};
	__property TGridUniEditBtn* UniEditBtn = {read=EditBtnUni};
	...
	__property AnsiString IncrSearchText = {read=SearchInc, write=SearchInc};
	...
	__property AnsiString UnSortedCells[int i][int j] = {read=GetUnSortedCell, write=SetUnSortedCell};
	__property AnsiString DisplCells[int i][int j] = {read=GetFormattedCell};
	__property AnsiString AllCells[int i][int j] = {read=GetCellsEx, write=SetCellsEx};
	__property AnsiString AllGridCells[int i][int j] = {read=GetGridCellsEx, write=SetGridCellsEx};
	__property WideString AllWideCells[int i][int j] = {read=GetWideCellsEx, write=SetWideCellsEx};
	__property WideString WideCells[int i][int j] = {read=GetWideCells, write=SetWideCells};
	__property System::TObject* AllObjects[int i][int j] = {read=GetObjectsEx, write=SetObjectsEx};
	__property AnsiString OriginalCells[int i][int j] = {read=GetOriginalCells, write=SetOriginalCells};
	...
	__property Graphics::TFont* Fonts[int i][int j] = {read=GetCellFont, write=SetCellFont};
	...
	__property AnsiString FontNames[int i][int j] = {read=GetFontNames, write=SetFontNames};
	...
	__property AnsiString XMLEncoding = {read=FXMLEncoding, write=FXMLEncoding};
	...
	__property unsigned UniLocale = {read=FUniLocale, write=FUniLocale, nodefault};
	__property unsigned UniCmpFlgs = {read=FUniCmpFlgs, write=FUniCmpFlgs, nodefault};
...
__published:
	...
	__property TWideEllipsClickEvent OnWideEllipsClick = {read=FOnWideEllipsClick, write=FOnWideEllipsClick};
	...
	__property TSetEditWideTextEvent OnSetEditWideText = {read=FSetEditWideText, write=FSetEditWideText};
	__property TGetEditWideTextEvent OnGetEditWideText = {read=FGetEditWideText, write=FGetEditWideText};
	...
	__property Classes::TAlignment DefaultAlignment = {read=FDefaultAlignment, write=SetDefaultAlignment, default=0};
	...
	__property AnsiString FilterDropDownClear = {read=FFilterDropDownClear, write=FFilterDropDownClear};
	...
	__property AnsiString InvalidEntryTitle = {read=FInvalidEntryTitle, write=FInvalidEntryTitle};
	__property TInvalidEntryIcon InvalidEntryIcon = {read=FInvalidEntryIcon, write=FInvalidEntryIcon, default=2};
	__property AnsiString InvalidEntryText = {read=FInvalidEntryText, write=FInvalidEntryText};
...
private:
	int FColCount;
	int FRowCount;
	AnsiString FColWidths;
	AnsiString FRowHeights;
	bool FFullGrid;
	int FID;
...
__published:
	...
	__property AnsiString ColWidths = {read=FColWidths, write=FColWidths};
	__property AnsiString RowHeights = {read=FRowHeights, write=FRowHeights};
...
__published:
	__property Word Col = {read=FCol, write=FCol, nodefault};
	__property Word Row = {read=FRow, write=FRow, nodefault};
	__property AnsiString Cell = {read=FCell, write=FCell};
...
static const Shortint MAJ_VER = 0x6;
static const Shortint MIN_VER = 0x2;
static const Shortint REL_VER = 0x5;
static const Shortint BLD_VER = 0x1;
#define DATE_VER "Nov, 2012"
extern PACKAGE Word CF_GRIDCELLS;
extern PACKAGE Word WM_GRIDEDITDONE;
extern PACKAGE Word WM_DTPSHIFTFOCUS;
