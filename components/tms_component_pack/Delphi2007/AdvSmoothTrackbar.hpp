...
// (DO NOT EDIT: machine generated header) 'Advsmoothtrackbar.pas' rev: 11.00
...
typedef void __fastcall (__closure *TAdvSmoothTrackBarDrawNumber)(System::TObject* Sender, double value, AnsiString &s, bool &AllowDrawText, Graphics::TColor &TickMarkColorLeft, Graphics::TColor &TickMarkColorRight, bool &AllowDrawTickMarkLeft, bool &AllowDrawTickMarkRight);

typedef void __fastcall (__closure *TAdvSmoothTrackBarGetToolTipText)(System::TObject* Sender, double Position, AnsiString &ToolTipText);
...
private:
	...
	AnsiString FPositionToolTipFormat;
...
protected:
	...
	Advgdip::TGPRectF __fastcall GetNumRect();
	Advgdip::TGPRectF __fastcall GetSliderRect();
...
__published:
	...
	__property AnsiString PositionToolTipFormat = {read=FPositionToolTipFormat, write=FPositionToolTipFormat};
	__property AnsiString ValueFormat = {read=FFormat, write=SetFormat};
