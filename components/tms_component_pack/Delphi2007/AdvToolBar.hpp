...
// (DO NOT EDIT: machine generated header) 'Advtoolbar.pas' rev: 11.00
...
protected:
	...
	__property Graphics::TColor FormBorderColor = {read=FFormBorderColor, write=SetFormBorderColor, default=8421504};
...
private:
	...
	bool __fastcall GetIsAeroVista(void);
...
private:
	...
	HIDESBASE MESSAGE void __fastcall WMActivate(Messages::TWMActivate &Message);
	HIDESBASE MESSAGE void __fastcall WMNCHitTest(Messages::TWMNCHitTest &Message);
	HIDESBASE MESSAGE void __fastcall WMClose(Messages::TMessage &Message);
...
#pragma option push -b-
enum TRotateDirection { rdNormal, rdReverse };
#pragma option pop
...
private:
	...
	bool FDown;
	TRotateDirection FRotateDirection;
	bool FAllowAllUp;
	int FSpacing;
	bool FTransparent;
	int FOffSet;
	...
	void __fastcall SetRotateDirection(const TRotateDirection Value);
...
protected:
	...
	__property TRotateDirection RotateDirection = {read=FRotateDirection, write=SetRotateDirection, default=0};
...
private:
	...
	AnsiString FHintOptionButton;
	AnsiString FHintCloseButton;
	AnsiString FTextAutoOptionMenu;
	AnsiString FTextOptionMenu;
	...
	bool FFirstRun;
	bool FFirstShowing;
	Controls::TControl* FHintCtrl;
	TDbgList* FCtrlVisList;
	bool FSupressClick;
	Classes::TNotifyEvent FOnClick;
	bool FChangingParent;
	...
	Types::TRect __fastcall GetMDIMinBtnRect();
	Types::TRect __fastcall GetMDIMaxBtnRect();
	Types::TRect __fastcall GetMDICloseBtnRect();
	...
	Types::TRect __fastcall GetOptionIndicatorRect();
	...
	Types::TRect __fastcall GetMyClientRect();
	Types::TRect __fastcall GetCaptionRect();
	Types::TRect __fastcall FWCustomizedBtnRect();
	Types::TRect __fastcall FWCloseBtnRect();
	...
	void __fastcall OnGlowButtonKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	...
	void __fastcall SetCompactCaption(const AnsiString Value);
...
protected:
	...
	void __fastcall AssignGlowButtonsEvent(void);
	void __fastcall ResizeAllGlowButtons(void);
	...
	void __fastcall SwitchToMetro(void);
	void __fastcall RevertMetro(void);
	bool __fastcall AnyDroppedDownButton(void);
	TAdvToolBarPager* __fastcall GetParentPager(void);
	bool __fastcall IsItones(void);
	void __fastcall ShowShortCutHintOfButtons(void);
	void __fastcall HideShortCutHintOfButtons(void);
	bool __fastcall HasShortCut(AnsiString aShortCut, int &VisibleHintCount);
	void __fastcall ReturnFocus(void);
	Controls::TWinControl* __fastcall GetCtrlFromHandle(unsigned HWnd);
	...
	TAdvCustomToolBarButton* __fastcall FindButtonFromAccel(Word Accel);
	...
	bool __fastcall ShowDisabledControlsHint(void);
	...
	__property AnsiString HintOptionButton = {read=FHintOptionButton, write=FHintOptionButton};
	__property AnsiString HintCloseButton = {read=FHintCloseButton, write=FHintCloseButton};
	...
	__property AnsiString TextAutoOptionMenu = {read=FTextAutoOptionMenu, write=FTextAutoOptionMenu};
	__property AnsiString TextOptionMenu = {read=FTextOptionMenu, write=FTextOptionMenu};
	...
	__property AnsiString CompactCaption = {read=FCompactCaption, write=SetCompactCaption};
	__property WideString WideCompactCaption = {read=FWideCompactCaption, write=FWideCompactCaption};
	__property Advhintinfo::TAdvHintInfo* OfficeHint = {read=FOfficeHint, write=SetOfficeHint};
	...
	__property AnsiString CompactShortCutHint = {read=FCompactShortCutHint, write=FCompactShortCutHint};
...
public:
	...
	void __fastcall AddMDIChildMenu(Forms::TCustomForm* ChildForm, AnsiString Caption = "");
	void __fastcall RemoveMDIChildMenu(Forms::TCustomForm* ChildForm, AnsiString Caption = "");
	...
	void __fastcall EnableAllControls(bool Value);
...
private:
	...
	AnsiString FUpHint;
	AnsiString FButtonEditCaptionLabel;
	AnsiString FTopHint;
	AnsiString FButtonEditIconLabel;
	AnsiString FToolBarLabel;
	AnsiString FDeleteHint;
	AnsiString FEditHint;
	AnsiString FCaptionLabel;
	AnsiString FGlyphPosLabel;
	AnsiString FCommandLabel;
	AnsiString FButtonEditVisibleCheck;
	AnsiString FButtonEditCaptionCheck;
	AnsiString FButtonEditHintLabel;
	AnsiString FAddHint;
	AnsiString FAddSeparatorHint;
	AnsiString FDeleteAllHint;
	AnsiString FBottomHint;
	AnsiString FDownHint;
	AnsiString FCaption;
	AnsiString FLargeIconCheck;
	AnsiString FButtonEditCaption;
	Classes::TNotifyEvent FOnChange;
	bool FEditGlyph;
	AnsiString FCustomize;
	AnsiString FResetButtonCaption;
	AnsiString FOKButtonCaption;
	AnsiString FCancelButtonCaption;
	bool FEditGlyphVisible;
	AnsiString FCancelButtonHint;
	AnsiString FResetButtonHint;
	AnsiString FAddGlowButtonHint;
	AnsiString FGlyphPositionBottomCaption;
	AnsiString FGlyphPositionLeftCaption;
	AnsiString FGlyphPositionTopCaption;
	AnsiString FGlyphPositionRightCaption;
	AnsiString FOKButtonHint;
	AnsiString FGlyphEditNoneIconCaption;
...
__published:
	__property AnsiString ToolBarLabel = {read=FToolBarLabel, write=FToolBarLabel};
	__property AnsiString CommandLabel = {read=FCommandLabel, write=FCommandLabel};
	__property AnsiString CaptionLabel = {read=FCaptionLabel, write=FCaptionLabel};
	__property AnsiString GlyphPosLabel = {read=FGlyphPosLabel, write=FGlyphPosLabel};
	__property AnsiString LargeIconCheck = {read=FLargeIconCheck, write=FLargeIconCheck};
	__property AnsiString TopHint = {read=FTopHint, write=FTopHint};
	__property AnsiString UpHint = {read=FUpHint, write=FUpHint};
	__property AnsiString DownHint = {read=FDownHint, write=FDownHint};
	__property AnsiString BottomHint = {read=FBottomHint, write=FBottomHint};
	__property AnsiString AddHint = {read=FAddHint, write=FAddHint};
	__property AnsiString AddSeparatorHint = {read=FAddSeparatorHint, write=FAddSeparatorHint};
	__property AnsiString DeleteHint = {read=FDeleteHint, write=FDeleteHint};
	__property AnsiString DeleteAllHint = {read=FDeleteAllHint, write=FDeleteAllHint};
	__property AnsiString EditHint = {read=FEditHint, write=FEditHint};
	__property AnsiString Caption = {read=FCaption, write=FCaption};
	__property AnsiString ButtonEditCaption = {read=FButtonEditCaption, write=FButtonEditCaption};
	__property AnsiString ButtonEditCaptionLabel = {read=FButtonEditCaptionLabel, write=FButtonEditCaptionLabel};
	__property AnsiString ButtonEditHintLabel = {read=FButtonEditHintLabel, write=FButtonEditHintLabel};
	__property AnsiString ButtonEditIconLabel = {read=FButtonEditIconLabel, write=FButtonEditIconLabel};
	__property AnsiString ButtonEditCaptionCheck = {read=FButtonEditCaptionCheck, write=FButtonEditCaptionCheck};
	__property AnsiString ButtonEditVisibleCheck = {read=FButtonEditVisibleCheck, write=FButtonEditVisibleCheck};
	__property AnsiString OKButtonCaption = {read=FOKButtonCaption, write=FOKButtonCaption};
	__property AnsiString OKButtonHint = {read=FOKButtonHint, write=FOKButtonHint};
	__property AnsiString CancelButtonCaption = {read=FCancelButtonCaption, write=FCancelButtonCaption};
	__property AnsiString CancelButtonHint = {read=FCancelButtonHint, write=FCancelButtonHint};
	__property AnsiString ResetButtonCaption = {read=FResetButtonCaption, write=FResetButtonCaption};
	__property AnsiString ResetButtonHint = {read=FResetButtonHint, write=FResetButtonHint};
	__property AnsiString AddGlowButtonHint = {read=FAddGlowButtonHint, write=FAddGlowButtonHint};
	__property AnsiString GlyphPositionLeftCaption = {read=FGlyphPositionLeftCaption, write=FGlyphPositionLeftCaption};
	__property AnsiString GlyphPositionTopCaption = {read=FGlyphPositionTopCaption, write=FGlyphPositionTopCaption};
	__property AnsiString GlyphPositionRightCaption = {read=FGlyphPositionRightCaption, write=FGlyphPositionRightCaption};
	__property AnsiString GlyphPositionBottomCaption = {read=FGlyphPositionBottomCaption, write=FGlyphPositionBottomCaption};
	__property AnsiString GlyphEditNoneIconCaption = {read=FGlyphEditNoneIconCaption, write=FGlyphEditNoneIconCaption};
	...
	__property AnsiString Customize = {read=FCustomize, write=FCustomize};
};
...
protected:
	...
	virtual void __fastcall Notification(Classes::TComponent* AComponent, Classes::TOperation Operation);
	Controls::TControl* __fastcall GetCtrl(AnsiString CtrlName);
...
private:
	...
	HIDESBASE MESSAGE void __fastcall CMMouseLeave(Messages::TMessage &Message);
	Types::TRect __fastcall GetCustomizeBtnRect();
	
protected:
	AnsiString FCustomizeText;
	void __fastcall UpDateSize(void);
	virtual void __fastcall Paint(void);
	DYNAMIC void __fastcall MouseMove(Classes::TShiftState Shift, int X, int Y);
	DYNAMIC void __fastcall MouseUp(Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
...
private:
	...
	void __fastcall SetTextAutoOptionMenu(const AnsiString Value);
	void __fastcall SetTextOptionMenu(const AnsiString Value);
	AnsiString __fastcall GetTextAutoOptionMenu();
	AnsiString __fastcall GetTextOptionMenu();
...
public:
	...
	__property AnsiString TextAutoOptionMenu = {read=GetTextAutoOptionMenu, write=SetTextAutoOptionMenu};
	__property AnsiString TextOptionMenu = {read=GetTextOptionMenu, write=SetTextOptionMenu};
...
private:
	...
	void __fastcall SetCustomizeHint(const AnsiString Value);
	void __fastcall SetAppIconAlphaBlended(const bool Value);
	bool __fastcall IsItones(void);
...
protected:
	...
	void __fastcall ApplyITones(const Advstyleif::TColorTones &ATones);
	...
	Types::TRect __fastcall GetMyClientRect();
	Types::TRect __fastcall GetDrawingRect();
	...
	__property AnsiString CustomizeHint = {read=FCustomizeHint, write=SetCustomizeHint};
...
public:
	...
	__property TAppIconGlowButton* App = {read=Fapp};
	__property bool AppIconAlphaBlended = {read=FAppIconAlphaBlended, write=SetAppIconAlphaBlended, default=1};
public:
	#pragma option push -w-inl
...
__published:
	...
	__property ShowHint ;
	__property OfficeHint ;
	__property RotateDirection  = {default=0};
...
private:
	...
	TGroupAppearance* FGroupAppearance;
	Classes::TAlignment FCaptionAlignment;
	int FTabExtraXMargin;
	int FTabCurrentExtraXMargin;
	void __fastcall OnGroupAppearanceChanged(System::TObject* Sender);
	void __fastcall SetCaption(const AnsiString Value);
	void __fastcall SetImageIndex(const int Value);
...
protected:
	__property int TabExtraXMargin = {read=FTabExtraXMargin, write=FTabExtraXMargin, nodefault};
	__property int TabCurrentExtraXMargin = {read=FTabCurrentExtraXMargin, write=FTabCurrentExtraXMargin, default=0};
...
private:
	...
	int __fastcall GetPageOffset(void);
...
protected:
	...
	bool __fastcall HasShortCut(AnsiString aShortCut);
...
typedef void __fastcall (__closure *TRibbonHideEvent)(System::TObject* Sender, bool &CanHide);

class DELPHICLASS TPagerHints;
class PASCALIMPLEMENTATION TPagerHints : public Classes::TPersistent 
{
	typedef Classes::TPersistent inherited;
	
private:
	AnsiString FMDIMaximizeBtnHint;
	AnsiString FMDIMinimizeBtnHint;
	AnsiString FMDICloseBtnHint;
	Classes::TNotifyEvent FOnChange;
	AnsiString FHelpBtnHint;
	void __fastcall SetHelpBtnHint(const AnsiString Value);
	void __fastcall SetMDICloseBtnHint(const AnsiString Value);
	void __fastcall SetMDIMaximizeBtnHint(const AnsiString Value);
	void __fastcall SetMDIMinimizeBtnHint(const AnsiString Value);
	
protected:
	virtual void __fastcall Change(void);
	
public:
	__fastcall TPagerHints(void);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	
__published:
	__property AnsiString MDICloseBtnHint = {read=FMDICloseBtnHint, write=SetMDICloseBtnHint};
	__property AnsiString MDIMinimizeBtnHint = {read=FMDIMinimizeBtnHint, write=SetMDIMinimizeBtnHint};
	__property AnsiString MDIMaximizeBtnHint = {read=FMDIMaximizeBtnHint, write=SetMDIMaximizeBtnHint};
	__property AnsiString HelpBtnHint = {read=FHelpBtnHint, write=SetHelpBtnHint};
	__property Classes::TNotifyEvent OnChange = {read=FOnChange, write=FOnChange};
public:
	#pragma option push -w-inl
	/* TPersistent.Destroy */ inline __fastcall virtual ~TPagerHints(void) { }
	#pragma option pop
...
typedef void __fastcall (__closure *TTextPaintEvent)(System::TObject* Sender, AnsiString &Text, Types::TRect &TxtR, Classes::TAlignment &Algn);
...
private:
	...
	TPagerHints* FHints;
	bool FAutoCompactToolBars;
	TRibbonHideEvent FOnFloatingRibbonHide;
	bool FShowDisabledControlsHint;
	bool FIgnoreALT;
	bool FTabRoundEdges;
	bool FShadow;
	bool FShow3D;
	...
	TTabAppearance* FTabAppearance;
	Advglowbutton::TGlowButtonAppearance* FGlowButtonAppearance;
	Advglowbutton::TGlowButtonAppearance* FPageGlowButtonAppearance;
	TToolBarAppearance* FToolBarAppearance;
	Graphics::TColor FToolBarCaptionTextColor;
	bool FItonesBeingSet;
	TCaptionAppearance* FCaptionAppearance;
	TGroupAppearance* FGroupAppearance;
	bool FOldAeroVista;
	bool FMenuFrameShown;
	HIDESBASE MESSAGE void __fastcall WMPaint(Messages::TWMPaint &Message);
	HIDESBASE MESSAGE void __fastcall WMSize(Messages::TWMSize &Message);
	HIDESBASE MESSAGE void __fastcall CMVisibleChanged(Messages::TMessage &Message);
	HIDESBASE MESSAGE void __fastcall CMShowingChanged(Messages::TMessage &Message);
	...
	void __fastcall OnCaptionTextPaint(System::TObject* Sender, AnsiString &Text, Types::TRect &TxtR, Classes::TAlignment &Algn);
	...
	void __fastcall OnExpCollapsBtnMouseUp(System::TObject* Sender, Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
	...
	bool __fastcall IsWin7FormMaxState(void);
	void __fastcall DoTabChanged(void);
	void __fastcall DoHintsChanged(System::TObject* Sender);
	void __fastcall SetHints(const TPagerHints* Value);
	void __fastcall SetAutoCompactToolBars(const bool Value);
...
protected:
	...
	virtual void __fastcall AdjustClientRect(Types::TRect &Rect);
	void __fastcall DrawMetroCaption(void);
	...
	Controls::TControl* __fastcall GetShapeButton(void);
	...
	void __fastcall InitializeGroupTabExtraMargins(void);
	int __fastcall GetRealTabWidth(int TabIndex, int &TabClientWidth, int &ExtraXMargin)/* overload */;
	int __fastcall GetRealTabWidth(int TabIndex, int &TabClientWidth)/* overload */;
	...
	int __fastcall TabCountInGroup(int GroupIndex);
	...
	void __fastcall InvalidateTabGroups(void);
	Types::TRect __fastcall GetCaptionTextRect(Classes::TAlignment &Alignment);
	Types::TRect __fastcall GetCaptionRect();
	Types::TRect __fastcall GetAvailableCaptionRect();
	...
	Types::TRect __fastcall GetMDIButtonsRectRect();
	void __fastcall UpdateMDIButtons(bool UpdateImage);
	Types::TRect __fastcall GetCaptionButtonsRect();
	Types::TRect __fastcall MaxQATRect();
	int __fastcall GetQATHeight(void);
	void __fastcall CreateFloatingRibbon(void);
	void __fastcall DestroyFloatingRibbon(void);
	void __fastcall HandleKey(Word Code);
	Types::TRect __fastcall GetHelpBtnRect();
	Types::TRect __fastcall GetExpCollapsBtnRect();
	bool __fastcall CanGlow(void);
	bool __fastcall CanShow3D(void);
	bool __fastcall CanShowShadow(void);
	void __fastcall MenuFrameShown(const bool Value);
	void __fastcall SetAeroVista(bool Value);
...
public:
	...
	__property bool AutoCompactToolBars = {read=FAutoCompactToolBars, write=SetAutoCompactToolBars, default=1};
...
__published:
	...
	__property TPagerHints* Hints = {read=FHints, write=SetHints};
	...
	__property Menus::TPopupMenu* PopupMenu = {read=GetPopupMenuEx, write=SetPopupMenuEx};
	__property TCustomAdvToolBarStyler* ToolBarStyler = {read=FToolBarStyler, write=SetToolBarStyler};
	__property bool ShowDisabledControlsHint = {read=FShowDisabledControlsHint, write=FShowDisabledControlsHint, default=0};
	...
	__property TRibbonHideEvent OnFloatingRibbonHide = {read=FOnFloatingRibbonHide, write=FOnFloatingRibbonHide};
...
private:
	...
	bool FIsWin7;
	bool FInternalActivate;
	bool FSubClassAsRibbon;
	bool FNoDropShadow;
	int FMaxY;
	int FMaxX;
	bool FUpdatingSize;
	bool FDoNotSizeWindow;
	bool FSwitchingOnXP;
	bool FSingleBorder;
	bool FThickBorder;
	bool FItones;
	bool FItonesBeingSet;
	bool FOldGlassFrameEnble;
	int FOldBorderWidth;
	Forms::TFormBorderStyle FOldBorderStyle;
	bool FOldAeroVista;
	bool FOldCtl3D;
	Graphics::TColor FBorderClr;
	...
	void __fastcall SetSubClassAsRibbon(const bool Value);
	void __fastcall SetSingleBorder(const bool Value);
	void __fastcall InternalSetSingleBorder(bool Value);
	void __fastcall SetThickBorder(const bool Value);
	void __fastcall SwitchToMetro(void);
...
protected:
	...
	bool __fastcall IsWin7FormMaxState(void);
	bool __fastcall IsSingleBorder(void);
	void __fastcall RevertMetro(void);
...
public:
	...
	virtual void __fastcall SetBounds(int ALeft, int ATop, int AWidth, int AHeight);
	void __fastcall SetColorTones(const Advstyleif::TColorTones &ATones);
	__property bool SubclassAsRibbon = {read=FSubClassAsRibbon, write=SetSubClassAsRibbon, nodefault};
	__property bool NoDropShadow = {read=FNoDropShadow, write=FNoDropShadow, default=0};
	void __fastcall SwitchFromDockPanelToRibbon(TAdvDockPanel* ADockPanel, TAdvToolBarPager* ARibbon);
	void __fastcall SwitchFromRibbonToDockPanel(TAdvToolBarPager* ARibbon, TAdvDockPanel* ADockPanel);
	void __fastcall InitRibbonAndDockPanel(TAdvToolBarPager* ARibbon, TAdvDockPanel* ADockPanel);
	void __fastcall InitDockPanelAndRibbon(TAdvDockPanel* ADockPanel, TAdvToolBarPager* ARibbon);
	__property bool SingleBorder = {read=FSingleBorder, write=SetSingleBorder, default=0};
	__property bool ThickBorder = {read=FThickBorder, write=SetThickBorder, default=0};
...
class DELPHICLASS TStyleForm;
class PASCALIMPLEMENTATION TStyleForm : public Forms::TForm 
{
	typedef Forms::TForm inherited;
...
private:
	...
	Advglowbutton::TAdvGlowButton* FCaptionMinBtn;
	Advglowbutton::TAdvGlowButton* FCaptionMaxBtn;
	TVistaBackground* FAppearance;
	HIDESBASE MESSAGE void __fastcall WMSize(Messages::TWMSize &Message);
	HIDESBASE MESSAGE void __fastcall WMNCHitTest(Messages::TWMNCHitTest &Message);
	void __fastcall SetAppearance(const TVistaBackground* Value);
...
public:
	__fastcall virtual TStyleForm(Classes::TComponent* AOwner);
	__fastcall virtual TStyleForm(Classes::TComponent* AOwner, int Dummy);
	void __fastcall SetComponentStyle(Advstyleif::TTMSStyle AStyle);
	__fastcall virtual ~TStyleForm(void);
	
__published:
	__property TVistaBackground* Appearance = {read=FAppearance, write=SetAppearance};
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TStyleForm(HWND ParentWindow) : Forms::TForm(ParentWindow) { }
	#pragma option pop
...
#define TOOLBAR_SECTION "UnDockedAdvToolBars"
...
extern PACKAGE Word WM_TBCOMPACTWINHIDE;
extern PACKAGE Word WM_TBSETAEROVISTA;
extern PACKAGE Word WM_TBFUPDATECONTEXTMENU;
extern PACKAGE Word WM_TBPSETIGNOREALT;
extern PACKAGE Word WM_TBSETMETRO;
extern PACKAGE Word WM_TBSHOWSHORTCUTHINT;
extern PACKAGE bool ATF_NoDropShadow;
extern PACKAGE Advstyleif::TColorTones TBFormMetroTones;
extern PACKAGE unsigned SHORTCUT_DELAY;
extern PACKAGE bool CANCAPTURE;
extern PACKAGE void __fastcall DrawVerticalText(Graphics::TCanvas* Canvas, AnsiString Text, const Types::TPoint &TextP);
