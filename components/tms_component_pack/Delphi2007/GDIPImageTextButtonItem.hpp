...
// (DO NOT EDIT: machine generated header) 'Gdipimagetextbuttonitem.pas' rev: 11.00
...
enum TItemButtonType { btButton, btExpander, btPushButton };
#pragma option pop
...
protected:
	...
	virtual void __fastcall DoItemButtonHint(System::TObject* Sender, Gdipcustomitem::TCustomItem* Item, AnsiString &ButtonHint);
	...
	virtual void __fastcall DoInternalItemButtonHint(System::TObject* Sender, Gdipcustomitem::TCustomItem* Item, AnsiString &ButtonHint);
	...
	Graphics::TFont* __fastcall GetButtonFont(const Gdipcustomitem::TItemAppearance &AItemAppearance);
