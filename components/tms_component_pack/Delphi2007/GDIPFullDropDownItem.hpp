...
// (DO NOT EDIT: machine generated header) 'Gdipfulldropdownitem.pas' rev: 11.00
...
__published:
	...
	__property int DropDownWidth = {read=FDropDownWidth, write=SetDropDownWidth, default=150};
	__property int DropDownHeight = {read=FDropDownHeight, write=SetDropDownHeight, default=200};
};
...
private:
	...
	void __fastcall SetAutoSetItemSize(const bool Value);
	
protected:
	virtual void __fastcall Loaded(void);
	void __fastcall IndexChanged(System::TObject* Sender, Gdipcustomitem::TCustomItem* Item, int OldIndex, int NewIndex);
	...
	void __fastcall ContainerKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
...
__published:
	...
	__property bool AutoSetItemSize = {read=FAutoSetItemSize, write=SetAutoSetItemSize, default=1};
private:
