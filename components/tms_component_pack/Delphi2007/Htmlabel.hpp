...
// (DO NOT EDIT: machine generated header) 'Htmlabel.pas' rev: 11.00
...
typedef void __fastcall (__closure *TNewSizeEvent)(System::TObject* Sender, int NewWidth, int NewHeight);
...
protected:
	...
	virtual void __fastcall DoAnchorClick(AnsiString Anchor);
...
__published:
	...
	__property TNewSizeEvent OnNewSize = {read=FOnNewSize, write=FOnNewSize};
