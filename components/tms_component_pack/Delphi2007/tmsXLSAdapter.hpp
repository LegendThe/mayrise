...
// (DO NOT EDIT: machine generated header) 'Tmsxlsadapter.pas' rev: 11.00
...
private:
	...
	void __fastcall InternalSetCellString(const int aRow, const int aCol, const WideString Text, const Tmsuflxformats::PFlxFormat Fm, const WideString DateFormat, const WideString TimeFormat, const Tmsuflxmessages::PFormatSettings FormatSettings);
	void __fastcall SetCellValueAndFmt(const int aRow, const int aCol, const Variant &v, const Tmsuflxformats::PFlxFormat Fm);
	AnsiString __fastcall SkipThousands(const AnsiString s, const Tmsuflxmessages::PFormatSettings FormatSettings);
	void __fastcall RestoreObjectSizes(void);
	void __fastcall GetPercentAndCurrencyFormat(const int aRow, const int aCol, Tmsuflxformats::TFlxFormat &Fmt1, const bool HasExp, const bool HasPercent, const bool HasCurrency, const bool NeedsDecimals, const Tmsuflxmessages::PFormatSettings FormatSettings);
