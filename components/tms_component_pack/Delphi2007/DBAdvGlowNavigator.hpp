...
// (DO NOT EDIT: machine generated header) 'Dbadvglownavigator.pas' rev: 11.00
...
private:
	...
	AnsiString FBookmarkStr;
	void *FBookmark;
	int FLook;
	int FGlyphCustomSize;
	AnsiString FGlyphResName;
	bool FTransparent;
	...
	void __fastcall SetGlyphResName(const AnsiString Value);
...
public:
	...
	__property AnsiString BookMarkStr = {read=FBookmarkStr, write=FBookmarkStr};
	__property void * BookMark = {read=FBookmark, write=FBookmark};
...
__published:
	...
	__property AnsiString GlyphResName = {read=FGlyphResName, write=SetGlyphResName};
	__property Ctl3D ;
