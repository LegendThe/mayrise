...
// (DO NOT EDIT: machine generated header) 'Advhtmlprop.pas' rev: 11.00

#ifndef AdvhtmlpropHPP
#define AdvhtmlpropHPP
...
namespace Advhtmlprop
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TAdvHTMLEditor;
class PASCALIMPLEMENTATION TAdvHTMLEditor : public Forms::TForm 
{
...
__published:
	...
	Advmemo::TAdvMemo* Memo1;
	Advmws::TAdvHTMLMemoStyler* AdvHTMLMemoStyler1;
	...
	void __fastcall HTMLStaticText1AnchorEnter(System::TObject* Sender, AnsiString Anchor);
	void __fastcall HTMLStaticText1AnchorExit(System::TObject* Sender, AnsiString Anchor);
...
public:
	__fastcall virtual TAdvHTMLEditor(Classes::TComponent* aOwner);
	__fastcall virtual ~TAdvHTMLEditor(void);
...
public:
	...
	/* TCustomForm.CreateNew */ inline __fastcall virtual TAdvHTMLEditor(Classes::TComponent* AOwner, int Dummy) : Forms::TForm(AOwner, Dummy) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TAdvHTMLEditor(HWND ParentWindow) : Forms::TForm(ParentWindow) { }
	#pragma option pop
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE TAdvHTMLEditor* AdvHTMLEditor;

}	/* namespace Advhtmlprop */
using namespace Advhtmlprop;
#pragma pack(pop)
#pragma option pop
