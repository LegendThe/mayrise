...
private:
	...
	void __fastcall YearStartAtChanged(System::TObject* Sender);
	...
	Types::TRect __fastcall FullItemRectAtDate(Planner::TPlannerItem* APlannerItem, System::TDateTime ADate);
	...
	int __fastcall GetRowScrollPositoin(int index);
	void __fastcall SetRowScrollPosition(int index, const int Value);
...
protected:
	...
	void __fastcall CreateDragImage(Planner::TPlannerItem* APlannerItem);
...
public:
	...
	__property int RowScrollPosition[int index] = {read=GetRowScrollPositoin, write=SetRowScrollPosition};
