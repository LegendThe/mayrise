...
// (DO NOT EDIT: machine generated header) 'Advsmoothsplashscreen.pas' rev: 11.00
...
public:
	...
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	void __fastcall Refresh(bool Fast = false);
...
__published:
	...
	__property Byte OpacityStart = {read=FStartOpacity, write=FStartOpacity, default=255};
	__property Byte OpacityEnd = {read=FEndOpacity, write=FEndOpacity, default=255};
...
private:
	...
	void __fastcall SetMainForm(const Forms::TForm* Value);
	
protected:
	virtual void __fastcall Notification(Classes::TComponent* AComponent, Classes::TOperation AOperation);
	void __fastcall DestroySplashScreen(void);
	void __fastcall LoadBasicInfo(void);
	void __fastcall RefreshItem(TSplashItem* Item, bool Fast = false);
	void __fastcall RefreshRect(const Types::TRect &R, bool Fast = false);
	void __fastcall Changed(void);
...
public:
	...
	void __fastcall Refresh(void);
	void __fastcall RefreshProgress(void);
	void __fastcall BeginUpdate(void);
	void __fastcall EndUpdate(void);
	...
	__property Forms::TForm* MainForm = {read=FMainForm, write=SetMainForm};
...
__published:
	__property bool StayOnTop = {read=FStayOnTop, write=SetStayOnTop, default=1};
	__property AnsiString Version = {read=GetVersion, write=SetVersion};
	...
	__property Byte MaxOpacity = {read=FMaxOpacity, write=FMaxOpacity, default=255};
...
protected:
	...
	Types::TRect __fastcall GetDisplayRectangle();
