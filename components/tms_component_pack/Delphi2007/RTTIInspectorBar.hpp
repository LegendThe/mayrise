...
// (DO NOT EDIT: machine generated header) 'Rttiinspectorbar.pas' rev: 11.00
...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TItemInsertEvent)(System::TObject* Sender, AnsiString &PropertyName, Typinfo::TTypeKind PropertyType, bool &Allow);
...
public:
	...
	__property AnsiString PropName = {read=FPropName, write=FPropName};
};
