...
// (DO NOT EDIT: machine generated header) 'Advofficecombobox.pas' rev: 11.00
...
private:
	...
	Graphics::TColor FBorderDisabledColor;
	...
	void __fastcall SetBorderDisabledColor(const Graphics::TColor Value);
...
protected:
	...
	virtual void __fastcall ShowDropDownInt(void);
	...
	__property Stdctrls::TListBox* DropDownListBox = {read=FDropDownListBox};
...
__published:
	...
	__property Graphics::TColor DropDownColor = {read=FDropDownColor, write=SetDropDownColor, default=-16777211};
	...
	__property Graphics::TColor BorderDisabledColor = {read=FBorderDisabledColor, write=SetBorderDisabledColor, default=12632256};
...
private:
	...
	Graphics::TColor FDisabledArrowColor;
	...
	void __fastcall SetDisabledArrowColor(const Graphics::TColor Value);
...
protected:
	...
	__property Graphics::TColor DisabledArrowColor = {read=FDisabledArrowColor, write=SetDisabledArrowColor, nodefault};
...
__published:
	...
	__property Graphics::TColor ColorMirrorDisabled = {read=FColorMirrorDisabled, write=SetColorMirrorDisabled, default=12632256};
	__property Graphics::TColor ColorMirrorDisabledTo = {read=FColorMirrorDisabledTo, write=SetColorMirrorDisabledTo, default=16777215};
...
typedef void __fastcall (__closure *TSelectFontNameEvent)(System::TObject* Sender, AnsiString AName);

typedef void __fastcall (__closure *TSelectFontSizeEvent)(System::TObject* Sender, int ASize);

class DELPHICLASS TOfficeListBox;
class PASCALIMPLEMENTATION TOfficeListBox : public Stdctrls::TListBox 
{
...
public:
	#pragma option push -w-inl
	/* TCustomListBox.Create */ inline __fastcall virtual TOfficeListBox(Classes::TComponent* AOwner) : Stdctrls::TListBox(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomListBox.Destroy */ inline __fastcall virtual ~TOfficeListBox(void) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TOfficeListBox(HWND ParentWindow) : Stdctrls::TListBox(ParentWindow) { }
	#pragma option pop
...
private:
	...
	AnsiString __fastcall GetSelectedFontName();
	void __fastcall SetSelectedFontName(const AnsiString Value);
...
public:
	...
	DYNAMIC void __fastcall Change(void);
	virtual void __fastcall DoSelect(int Index);
	__property AnsiString SelectedFontName = {read=GetSelectedFontName, write=SetSelectedFontName};
...
extern PACKAGE Types::TRect __fastcall DrawVistaText(Graphics::TCanvas* Canvas, Classes::TAlignment Alignment, const Types::TRect &r, const AnsiString Caption, Graphics::TFont* AFont, bool Enabled, bool RealDraw, Advgdip::TAntiAlias AntiAlias, Comctrls::TTabPosition Direction);
extern PACKAGE void __fastcall DrawVistaGradient(Graphics::TCanvas* Canvas, const Types::TRect &r, Graphics::TColor CFU, Graphics::TColor CTU, Graphics::TColor CFB, Graphics::TColor CTB, Graphics::TColor PC, Advglowbutton::TGDIPGradient GradientU, Advglowbutton::TGDIPGradient GradientB, const AnsiString Caption, Graphics::TFont* AFont, Controls::TImageList* Images, int ImageIndex, bool EnabledImage, Advglowbutton::TButtonLayout Layout, bool DropDownButton, bool DrawDwLine, bool Enabled, bool Focus, Advglowbutton::TDropDownPosition DropDownPos, Gdipicture::TGDIPPicture* Picture, Advgdip::TAntiAlias AntiAlias, bool RoundEdges, bool RotateLeftRight, Comctrls::TTabPosition Direction)/* overload */;
extern PACKAGE void __fastcall DrawVistaGradient(Graphics::TCanvas* Canvas, const Types::TRect &r, Graphics::TColor CFU, Graphics::TColor CTU, Graphics::TColor CFB, Graphics::TColor CTB, Graphics::TColor PC, Advglowbutton::TGDIPGradient GradientU, Advglowbutton::TGDIPGradient GradientB, const AnsiString Caption, Graphics::TFont* AFont, bool Enabled, bool Focus, Advgdip::TAntiAlias AntiAlias, bool RoundEdges, bool RotateLeftRight, Comctrls::TTabPosition Direction = (Comctrls::TTabPosition)(0x0))/* overload */;
