...
private:
	...
	void __fastcall SetActiveTextColor(const Graphics::TColor Value);
...
__published:
	...
	__property Graphics::TColor ActiveTextColor = {read=FActiveTextColor, write=SetActiveTextColor, default=-16777208};
