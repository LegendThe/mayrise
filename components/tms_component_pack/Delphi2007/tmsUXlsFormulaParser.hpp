...
// (DO NOT EDIT: machine generated header) 'Tmsuxlsformulaparser.pas' rev: 11.00
...
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE WideString __fastcall RPNToString(const Tmsxlsmessages::PArrayOfByte RPN, const int atPos, const Tmsuxlsrowcolentries::TCellList* CellList);
