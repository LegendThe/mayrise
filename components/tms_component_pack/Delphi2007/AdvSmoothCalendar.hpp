...
// (DO NOT EDIT: machine generated header) 'Advsmoothcalendar.pas' rev: 11.00
...
class PASCALIMPLEMENTATION TDisjunctDateTimeArray : public Classes::TCollection 
{
	typedef Classes::TCollection inherited;
	
public:
	TDisjunctDateTimeItem* operator[](int Index) { return Items[Index]; }
	
private:
	Classes::TNotifyEvent FOnDisjunctArrayChange;
	HIDESBASE TDisjunctDateTimeItem* __fastcall GetItem(int Index);
	HIDESBASE void __fastcall SetItem(int Index, const TDisjunctDateTimeItem* Value);
	
public:
	__property TDisjunctDateTimeItem* Items[int Index] = {read=GetItem, write=SetItem/*, default*/};
	HIDESBASE TDisjunctDateTimeItem* __fastcall Add(void);
	HIDESBASE TDisjunctDateTimeItem* __fastcall Insert(int Index);
	HIDESBASE void __fastcall Delete(int Index);
	virtual void __fastcall EndUpdate(void);
	__property Classes::TNotifyEvent OnDisjunctArrayChange = {read=FOnDisjunctArrayChange, write=FOnDisjunctArrayChange};
public:
	#pragma option push -w-inl
	/* TCollection.Create */ inline __fastcall TDisjunctDateTimeArray(TMetaClass* ItemClass) : Classes::TCollection(ItemClass) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCollection.Destroy */ inline __fastcall virtual ~TDisjunctDateTimeArray(void) { }
	#pragma option pop
...
typedef void __fastcall (__closure *TAdvSmoothCalendarDateHintEvent)(System::TObject* Sender, System::TDateTime Date, AnsiString &hint);

typedef void __fastcall (__closure *TAdvSmoothCalendarGetDateStatusEvent)(System::TObject* Sender, System::TDateTime Date, AnsiString &StatusMessage, Gdipfill::TGDIPStatus* Fill, int &OffsetX, int &OffsetY);

typedef void __fastcall (__closure *TAdvSmoothCalendarDateTextEvent)(System::TObject* Sender, System::TDateTime Date, Graphics::TFont* AFont, AnsiString &AText);
...
typedef void __fastcall (__closure *TAdvSmoothCalendarStatusClickEvent)(System::TObject* Sender, AnsiString StatusMessage, System::TDateTime Date);

typedef void __fastcall (__closure *TAdvSmoothCalendarGetWeekDayNameEvent)(System::TObject* Sender, int WeekDay, AnsiString &WeekDayName);

typedef void __fastcall (__closure *TAdvSmoothCalendarGetMonthNameEvent)(System::TObject* Sender, int Month, AnsiString &MonthName);

typedef void __fastcall (__closure *TAdvSmoothCalendarGetTextEvent)(System::TObject* Sender, AnsiString &AText);

typedef void __fastcall (__closure *TAdvSmoothCalendarGetYearNameEvent)(System::TObject* Sender, int Year, AnsiString &YearName);

typedef void __fastcall (__closure *TAdvSmoothCalendarNormalDateFillEvent)(System::TObject* Sender, Gdipfill::TGDIPFill* AFill, Graphics::TFont* AFont, System::TDateTime Date, TAdvSmoothCalendarDateKind DateKind);
...
private:
	...
	bool FFocused;
	bool FDesignTime;
	DynamicArray<Advgdip::TGPRectF >  arrMulti;
	int FRows;
	...
	Classes::TNotifyEvent FArrowLeftClick;
	Classes::TNotifyEvent FArrowRightClick;
	bool FAllowToggle;
...
protected:
	...
	void __fastcall DoGetDayStatus(System::TObject* Sender, System::TDateTime Date, AnsiString &StatusMessage, Gdipfill::TGDIPStatus* Fill, int &OffsetX, int &OffsetY);
	...
	__property Classes::TNotifyEvent ArrowLeftClick = {read=FArrowLeftClick, write=FArrowLeftClick};
	__property Classes::TNotifyEvent ArrowRightClick = {read=FArrowRightClick, write=FArrowRightClick};
	...
	__property Classes::TShiftState Shiftst = {read=FShift, write=FShift, nodefault};
...
class PASCALIMPLEMENTATION TDisjunctDateTimeItem : public Classes::TCollectionItem 
{
...
public:
	#pragma option push -w-inl
	/* TCollectionItem.Create */ inline __fastcall virtual TDisjunctDateTimeItem(Classes::TCollection* Collection) : Classes::TCollectionItem(Collection) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCollectionItem.Destroy */ inline __fastcall virtual ~TDisjunctDateTimeItem(void) { }
	#pragma option pop
...
typedef DynamicArray<Advgdip::TGPRectF >  AdvSmoothCalendar__9;
