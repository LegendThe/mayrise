...
// (DO NOT EDIT: machine generated header) 'Advsmoothexpandergroup.pas' rev: 11.00
...
private:
	...
	HIDESBASE MESSAGE void __fastcall WMExitSizeMove(Messages::TMessage &Msg);
