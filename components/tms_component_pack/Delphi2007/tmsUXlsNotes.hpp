...
// (DO NOT EDIT: machine generated header) 'Tmsuxlsnotes.pas' rev: 11.00
...
public:
	__fastcall TNoteRecord(const int aRow, const int aCol, const WideString aTxt, const Tmsuxlsescher::TDrawing* Drawing, const Tmsuflxmessages::TImageProperties &Properties, const System::TObject* sSheet);
...
public:
	...
	/* TBaseRowColRecord.Create */ inline __fastcall virtual TNoteRecord(const Word aId, const Tmsxlsmessages::PArrayOfByte aData, const int aDataSize) : Tmsuxlsbaserecords::TBaseRowColRecord(aId, aData, aDataSize) { }
	#pragma option pop
...
public:
	...
	void __fastcall FixDwgIds(const Tmsuxlsescher::TDrawing* Drawing);
	void __fastcall AddNewComment(const int Row, const int Col, const WideString Txt, const Tmsuxlsescher::TDrawing* Drawing, const Tmsuflxmessages::TImageProperties &Properties, const System::TObject* sSheet);
public:
	#pragma option push -w-inl
