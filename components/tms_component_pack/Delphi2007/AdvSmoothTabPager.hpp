...
// (DO NOT EDIT: machine generated header) 'Advsmoothtabpager.pas' rev: 11.00
...
typedef void __fastcall (__closure *TStatusClickEvent)(System::TObject* Sender, int TabIndex);
...
private:
	...
	TStatusClickEvent FOnStatusClick;
...
protected:
	...
	Types::TRect __fastcall GetSmoothTabRect();
...
public:
	...
	int __fastcall AddAdvSmoothTabPage(AnsiString PageCaption)/* overload */;
...
__published:
	...
	__property TStatusClickEvent OnStatusClick = {read=FOnStatusClick, write=FOnStatusClick};
...
private:
	...
	Graphics::TColor FColorTextHot;
	Graphics::TColor FColorTextDisabled;
	Graphics::TColor FColorTextSelected;
	...
	void __fastcall SetColorTextDisabled(const Graphics::TColor Value);
	void __fastcall SetColorTextSelected(const Graphics::TColor Value);
...
__published:
	...
	__property Graphics::TColor ColorTextHot = {read=FColorTextHot, write=FColorTextHot, default=0};
	__property Graphics::TColor ColorTextDisabled = {read=FColorTextDisabled, write=SetColorTextDisabled, default=8421504};
	__property Graphics::TColor ColorTextSelected = {read=FColorTextSelected, write=SetColorTextSelected, default=0};
