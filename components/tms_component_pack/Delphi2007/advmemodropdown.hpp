...
// (DO NOT EDIT: machine generated header) 'Advmemodropdown.pas' rev: 11.00
...
private:
	...
	void __fastcall OnMemoKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
...
public:
	...
	__property AnsiString Text = {read=GetTextEx};
