...
typedef void __fastcall (__closure *TOGLGetHintEvent)(TOutlookGroupedList* Sender, POGLItem Item, AnsiString &HintText, Types::TPoint &HintPos);
...
protected:
	...
	virtual bool __fastcall HTMLPaint(Graphics::TCanvas* Canvas, AnsiString s, const Types::TRect &fr);
	...
	__property Graphics::TColor GroupLineColor = {read=FGroupLineColor, write=SetGroupLineColor, nodefault};
