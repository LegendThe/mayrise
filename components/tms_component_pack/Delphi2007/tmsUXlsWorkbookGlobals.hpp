...
// (DO NOT EDIT: machine generated header) 'Tmsuxlsworkbookglobals.pas' rev: 11.00
...
public:
	...
	Tmsuxlsformula::TNameRecord* __fastcall GetName(const int sheet, const WideString aName);
};
