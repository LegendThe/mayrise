...
// (DO NOT EDIT: machine generated header) 'Advsmoothdockdragdrop.pas' rev: 11.00

#ifndef AdvsmoothdockdragdropHPP
#define AdvsmoothdockdragdropHPP
...
namespace Advsmoothdockdragdrop
{
//-- type declarations -------------------------------------------------------
...
class DELPHICLASS TDockDropTarget;
class PASCALIMPLEMENTATION TDockDropTarget : public System::TInterfacedObject 
{
...
public:
	__fastcall TDockDropTarget(void);
...
public:
	...
	/* TObject.Destroy */ inline __fastcall virtual ~TDockDropTarget(void) { }
	#pragma option pop
...
class DELPHICLASS TDockDropSource;
class PASCALIMPLEMENTATION TDockDropSource : public System::TInterfacedObject 
{
	typedef System::TInterfacedObject inherited;
...
public:
	__fastcall TDockDropSource(void);
...
public:
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TDockDropSource(void) { }
	#pragma option pop
...
extern PACKAGE HRESULT __fastcall StartTextDoDragDrop(TDockDropSource* DropSource, AnsiString stxt, AnsiString srtf, int dwOKEffects, int &dwEffect);
extern PACKAGE HRESULT __fastcall StartColDoDragDrop(TDockDropSource* DropSource, int column, int dwOKEffects, int &dwEffect);

}	/* namespace Advsmoothdockdragdrop */
using namespace Advsmoothdockdragdrop;
#pragma pack(pop)
#pragma option pop

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// Advsmoothdockdragdrop
