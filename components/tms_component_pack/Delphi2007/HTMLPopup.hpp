...
// (DO NOT EDIT: machine generated header) 'Htmlpopup.pas' rev: 11.00
...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TAnchorClickEvent)(System::TObject* Sender, AnsiString Anchor);
...
protected:
	void __fastcall WindowAnchorClick(System::TObject* Sender, AnsiString Anchor);
