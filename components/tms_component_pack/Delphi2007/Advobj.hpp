...
public:
	...
	void __fastcall LoadFromString(AnsiString s);
...
protected:
	...
	Types::TRect __fastcall DrawButton(Graphics::TCanvas* Canvas, const Types::TRect &Client, const Types::TPoint &Offset, const AnsiString Caption, Buttons::TButtonLayout Layout, int Margin, int Spacing, Buttons::TButtonState State, bool Transparent, int BiDiFlags);
	void __fastcall CalcButtonLayout(Graphics::TCanvas* Canvas, const Types::TRect &Client, const Types::TPoint &Offset, const AnsiString Caption, Buttons::TButtonLayout Layout, int Margin, int Spacing, Types::TPoint &GlyphPos, Types::TRect &TextBounds, int BiDiFlags);
	virtual void __fastcall Paint(void);
...
private:
	...
	void __fastcall SetColorTo(const Graphics::TColor Value);
	void __fastcall SetFindNextCaption(const AnsiString Value);
	void __fastcall SetFindPrevCaption(const AnsiString Value);
	...
	void __fastcall SetMatchCaseCaption(const AnsiString Value);
	void __fastcall SetHintClose(const AnsiString Value);
	void __fastcall SetHintFindNext(const AnsiString Value);
	void __fastcall SetHintFindPrev(const AnsiString Value);
	void __fastcall SetHintHighlight(const AnsiString Value);
	void __fastcall SetHighLightCaption(const AnsiString Value);
...
public:
	__fastcall TSearchFooter(Classes::TComponent* AOwner, bool InitDesign);
	__fastcall virtual ~TSearchFooter(void);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	__property bool AutoThemeAdapt = {read=FAutoThemeAdapt, write=SetAutoThemeAdapt, nodefault};
	__property AnsiString LastSearch = {read=FLastSearch, write=FLastSearch};
...
__published:
	...
	__property AnsiString FindNextCaption = {read=FFindNextCaption, write=SetFindNextCaption};
	__property AnsiString FindPrevCaption = {read=FFindPrevCaption, write=SetFindPrevCaption};
	__property Graphics::TFont* Font = {read=FFont, write=SetFont};
	__property AnsiString HighLightCaption = {read=FHighLightCaption, write=SetHighLightCaption};
	__property AnsiString HintClose = {read=FHintClose, write=SetHintClose};
	__property AnsiString HintFindNext = {read=FHintFindNext, write=SetHintFindNext};
	__property AnsiString HintFindPrev = {read=FHintFindPrev, write=SetHintFindPrev};
	__property AnsiString HintHighlight = {read=FHintHighLight, write=SetHintHighlight};
	__property AnsiString MatchCaseCaption = {read=FMatchCaseCaption, write=SetMatchCaseCaption};
...
#pragma option push -b-
enum THomeEndAction { heFirstLastColumn, heFirstLastRow, heFirstLastCell };
#pragma option pop
...
#pragma option push -b-
enum TAdvanceDirection { adLeftRight, adTopBottom, adLeftRightInRow, adTopBottomInCol };
#pragma option pop
...
#pragma option push -b-
enum TCursorAdvance { caDefault, caSnake, caLoop };
#pragma option pop
...
#pragma option push -b-
enum TGridFixedCellEditor { fceEdit, fceComboEdit, fceComboList };
#pragma option pop
...
private:
	...
	Classes::TStringList* FFixedComboValues;
	...
	void __fastcall SetFixedComboValues(const Classes::TStrings* Value);
	Classes::TStrings* __fastcall GetFixedComboValues(void);
...
__published:
	...
	__property Classes::TStrings* FixedComboValues = {read=GetFixedComboValues, write=SetFixedComboValues};
...
class PASCALIMPLEMENTATION TSyncGrid : public Classes::TPersistent 
{
	typedef Classes::TPersistent inherited;
...
private:
	...
	bool FMoveRow;
	bool FMoveColumn;
	void __fastcall SetGrid(const Grids::TStringGrid* Value);
	
public:
	__fastcall TSyncGrid(Classes::TComponent* AOwner);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	
__published:
	__property Grids::TStringGrid* Grid = {read=FGrid, write=SetGrid};
...
public:
	#pragma option push -w-inl
	/* TPersistent.Destroy */ inline __fastcall virtual ~TSyncGrid(void) { }
	#pragma option pop
...
class PASCALIMPLEMENTATION TGridFocusWindow : public Controls::TCustomControl 
{
	typedef Controls::TCustomControl inherited;
...
public:
	__fastcall virtual TGridFocusWindow(Classes::TComponent* AOwner);
	virtual void __fastcall CreateWnd(void);
public:
	#pragma option push -w-inl
	/* TCustomControl.Destroy */ inline __fastcall virtual ~TGridFocusWindow(void) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TGridFocusWindow(HWND ParentWindow) : Controls::TCustomControl(ParentWindow) { }
	#pragma option pop
...
class PASCALIMPLEMENTATION TGridAlphaMask : public Graphics::TBitmap 
{
...
public:
	__fastcall virtual TGridAlphaMask(void);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	void __fastcall MergeMask(Graphics::TBitmap* Mask, Graphics::TBitmap* Bitmap, Graphics::TColor Color);
	__property Byte Opacity = {read=FOpacity, write=FOpacity, nodefault};
public:
	#pragma option push -w-inl
	/* TBitmap.Destroy */ inline __fastcall virtual ~TGridAlphaMask(void) { }
	#pragma option pop
...
class PASCALIMPLEMENTATION TFocusHelper : public Classes::TPersistent 
{
	typedef Classes::TPersistent inherited;
...
public:
	__fastcall TFocusHelper(Classes::TComponent* AOwner);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
...
public:
	#pragma option push -w-inl
	/* TPersistent.Destroy */ inline __fastcall virtual ~TFocusHelper(void) { }
	#pragma option pop
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE void __fastcall DrawRoundRect(Graphics::TBitmap* Bitmap, int W, int H, int Thickness, int Radius, double Blur);
