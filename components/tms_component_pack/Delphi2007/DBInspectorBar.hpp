...
// (DO NOT EDIT: machine generated header) 'Dbinspectorbar.pas' rev: 11.00
...
protected:
	...
	virtual bool __fastcall HintCaptionOptions(Inspectorbar::TInspectorPanel* Panel, int x, int y, AnsiString &Hint);
