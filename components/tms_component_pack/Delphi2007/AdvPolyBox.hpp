...
// (DO NOT EDIT: machine generated header) 'Advpolybox.pas' rev: 11.00

#ifndef AdvpolyboxHPP
#define AdvpolyboxHPP
...
namespace Advpolybox
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TAdvPolyBox;
class PASCALIMPLEMENTATION TAdvPolyBox : public Customitemscontainer::TCustomItemsContainer 
{
	typedef Customitemscontainer::TCustomItemsContainer inherited;
	
public:
	__fastcall virtual TAdvPolyBox(Classes::TComponent* AOwner);
...
public:
	...
	/* TCustomItemsContainer.Destroy */ inline __fastcall virtual ~TAdvPolyBox(void) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TAdvPolyBox(HWND ParentWindow) : Customitemscontainer::TCustomItemsContainer(ParentWindow) { }
	#pragma option pop
