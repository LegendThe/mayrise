...
// (DO NOT EDIT: machine generated header) 'Advtrackbarpersist.pas' rev: 11.00
...
public:
	...
	void __fastcall StorePropertiesToFile(Classes::TComponent* AComponent, AnsiString FileName);
	void __fastcall RestorePropertiesToFile(Classes::TComponent* AComponent, AnsiString FileName);
