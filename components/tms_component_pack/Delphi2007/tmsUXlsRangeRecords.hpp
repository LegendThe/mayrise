...
// (DO NOT EDIT: machine generated header) 'Tmsuxlsrangerecords.pas' rev: 11.00
...
public:
	__fastcall TRangeValuesList(const int aMaxRangesPerRecord, const Word aOtherDataLen);
