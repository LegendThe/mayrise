...
// (DO NOT EDIT: machine generated header) 'Advsmoothmegamenu.pas' rev: 11.00
...
private:
	...
	bool FSeparator;
	AnsiString FGraphicLeftDisabledName;
	AnsiString FGraphicLeftSelectedName;
	AnsiString FGraphicLeftName;
	AnsiString FGraphicRightSelectedName;
	AnsiString FGraphicLeftHoverName;
	AnsiString FGraphicRightName;
	AnsiString FGraphicRightHoverName;
	AnsiString FGraphicRightDisabledName;
	...
	void __fastcall SetGraphicLeftDisabledName(const AnsiString Value);
	void __fastcall SetGraphicLeftHoverName(const AnsiString Value);
	...
	void __fastcall SetGraphicRightHoverName(const AnsiString Value);
	...
	void __fastcall SetGraphicRightDisabledName(const AnsiString Value);
...
protected:
	...
	AnsiString __fastcall DrawMenuItemHTMLText(Advgdip::TGPGraphics* g, Graphics::TFont* f, Gdipmenu::TGDIPMenuHTMLText* HTML, Gdipmenu::TGDIPMenuLocation Location, const Advgdip::TGPRectF &r, Advgdip::TGPRectF &htmlr, AnsiString str, bool DoCalculate = false, bool DoAnchor = false, int fX = 0xffffffff, int fY = 0xffffffff);
...
__published:
	...
	__property AnsiString GraphicLeftHoverName = {read=FGraphicLeftHoverName, write=SetGraphicLeftHoverName};
	__property AnsiString GraphicRightHoverName = {read=FGraphicRightHoverName, write=SetGraphicRightHoverName};
	__property AnsiString GraphicLeftDisabledName = {read=FGraphicLeftDisabledName, write=SetGraphicLeftDisabledName};
	__property AnsiString GraphicRightDisabledName = {read=FGraphicRightDisabledName, write=SetGraphicRightDisabledName};
...
public:
	...
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	void __fastcall SaveToFile(Inifiles::TIniFile* ini, AnsiString Section);
	void __fastcall LoadFromFile(Inifiles::TIniFile* ini, AnsiString Section);
...
typedef void __fastcall (__closure *TAdvSmoothMegaMenuSubItemEvent)(System::TObject* Sender, TAdvSmoothMegaMenu* Menu, TAdvSmoothMegaMenuItem* MenuItem, Gdipmenu::TGDIPMenuSectionItem* Item, AnsiString Text);

typedef void __fastcall (__closure *TAdvSmoothMegaMenuSubItemEditChanged)(System::TObject* Sender, TAdvSmoothMegaMenu* Menu, TAdvSmoothMegaMenuItem* MenuItem, AnsiString Text, Gdipmenu::TGDIPMenuSectionItem* item);
...
typedef void __fastcall (__closure *TAdvSmoothMegaMenuSubItemAnchorEvent)(System::TObject* Sender, TAdvSmoothMegaMenu* Menu, TAdvSmoothMegaMenuItem* MenuItem, Gdipmenu::TGDIPMenuSectionItem* Item, AnsiString Anchor);
...
protected:
	...
	void __fastcall DoMenuSubItemClick(System::TObject* Sender, Gdipmenu::TGDIPMenuSectionItem* Item, AnsiString Text);
	void __fastcall DoMenuSubItemHover(System::TObject* Sender, Gdipmenu::TGDIPMenuSectionItem* Item, AnsiString Text);
	void __fastcall DoMenuSubItemEditChanged(System::TObject* Sender, AnsiString Text, Gdipmenu::TGDIPMenuSectionItem* item);
	void __fastcall DoMenuSubItemCheckChanged(System::TObject* Sender, Gdipmenu::TGDIPMenuSectionItem* item);
	void __fastcall DoMenuSubItemAnchor(System::TObject* Sender, Gdipmenu::TGDIPMenuSectionItem* Item, AnsiString Anchor);
...
public:
	void __fastcall CloseAllMenus(void);
	...
	void __fastcall LoadFromFile(AnsiString Filename, bool ApplyDefaultStyles = true);
...
__published:
	...
	__property bool AutoOpenMenus = {read=FAutoOpenMenus, write=SetAutoOpenMenus, default=1};
...
protected:
	...
	void __fastcall DoItemSelection(Word Key, const Gdipmenu::TCurrentItem &SelectedItem, int &sec, int &secit);
