...
// (DO NOT EDIT: machine generated header) 'Advsmoothimagelistbox.pas' rev: 11.00
...
public:
	...
	int __fastcall Find(const AnsiString s);
	...
	TAdvSmoothImageListBoxItemArray __fastcall SelectedItems();
...
private:
	...
	AnsiString FHintNext;
	AnsiString FHintPreviousPage;
	AnsiString FHintPrevious;
	AnsiString FHintNextPage;
	Graphics::TColor FArrowColor;
	Graphics::TColor FArrowColorDisabled;
	...
	void __fastcall SetHintNext(const AnsiString Value);
	void __fastcall SetHintNextPage(const AnsiString Value);
	void __fastcall SetHintPrevious(const AnsiString Value);
	void __fastcall SetHintPreviousPage(const AnsiString Value);
	void __fastcall SetArrowColor(const Graphics::TColor Value);
	void __fastcall SetArrowColorDisabled(const Graphics::TColor Value);
	void __fastcall SetArrowColorHover(const Graphics::TColor Value);
...
protected:
	...
	int __fastcall GetStopVisibleCount(void);
	int __fastcall GetStartVisibleCount(void);
...
__published:
	...
	__property Graphics::TColor ArrowColorDisabled = {read=FArrowColorDisabled, write=SetArrowColorDisabled, default=0};
	__property Graphics::TColor ArrowColorHover = {read=FArrowColorHover, write=SetArrowColorHover, default=0};
	...
	__property AnsiString HintNext = {read=FHintNext, write=SetHintNext};
	__property AnsiString HintPrevious = {read=FHintPrevious, write=SetHintPrevious};
	__property AnsiString HintNextPage = {read=FHintNextPage, write=SetHintNextPage};
	__property AnsiString HintPreviousPage = {read=FHintPreviousPage, write=SetHintPreviousPage};
...
protected:
	...
	Advgdip::TGPRectF __fastcall GetRect();
...
typedef void __fastcall (__closure *TAdvSmoothImageListBoxItemHintEvent)(System::TObject* Sender, int itemindex, AnsiString &hint);

typedef void __fastcall (__closure *TAdvSmoothImageListBoxItemTextEvent)(System::TObject* Sender, int itemindex, AnsiString &text);
...
typedef void __fastcall (__closure *TAdvSmoothImageListBoxItemAnchorEvent)(System::TObject* Sender, int itemindex, AnsiString Anchor);
...
typedef void __fastcall (__closure *TAdvSmoothImageListBoxCachedImageLoaded)(System::TObject* Sender, int ItemIndex);

typedef void __fastcall (__closure *TAdvSmoothImageListBoxTopLayerItemClick)(System::TObject* Sender, TAdvSmoothImageListBoxTopLayerItem* AItem);

#pragma option push -b-
enum TAdvSmoothImageListBoxScrollType { stNormal, stIndicators };
#pragma option pop

class DELPHICLASS TAdvSmoothImageListBoxIndicator;
#pragma option push -b-
enum TAdvSmoothImageListBoxScrollIndicatorStyle { issiPhone, issAlways };
#pragma option pop

class PASCALIMPLEMENTATION TAdvSmoothImageListBoxIndicator : public Classes::TPersistent 
{
	typedef Classes::TPersistent inherited;
...
private:
	...
	int FSize;
	int FAnimateOpacity;
	TAdvSmoothImageListBoxScrollIndicatorStyle FStyle;
	void __fastcall SetColor(const Graphics::TColor Value);
	...
	void __fastcall SetSize(const int Value);
	void __fastcall SetStyle(const TAdvSmoothImageListBoxScrollIndicatorStyle Value);
	
protected:
	void __fastcall Changed(void);
	
public:
	__fastcall TAdvSmoothImageListBoxIndicator(TAdvSmoothImageListBox* AOwner);
	__fastcall virtual ~TAdvSmoothImageListBoxIndicator(void);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
...
__published:
	...
	__property TAdvSmoothImageListBoxScrollIndicatorStyle Style = {read=FStyle, write=SetStyle, default=0};
	__property bool Visible = {read=FVisible, write=SetVisible, default=1};
...
private:
	...
	TAdvSmoothImageListBoxCachedImageLoaded FOnCachedImageLoaded;
	bool FAutoHideNavigator;
	Advhintinfo::TAdvHintInfo* FHint;
	bool FIsZoomed;
	int FClickMargin;
	TAdvSmoothImageListBoxTopLayerItemClick FOnTopLayerItemClick;
	TAdvSmoothImageListBoxScrollType FScrollType;
	TAdvSmoothImageListBoxIndicator* FScrollIndicator;
	...
	void __fastcall SetAutoHideNavigator(const bool Value);
	void __fastcall SetOfficeHint(const Advhintinfo::TAdvHintInfo* Value);
	bool __fastcall GetScrollBarDoubleBuffered(void);
	void __fastcall SetScrollBarDoubleBuffered(const bool Value);
	void __fastcall SetScrollType(const TAdvSmoothImageListBoxScrollType Value);
	void __fastcall SetScrollIndicator(const TAdvSmoothImageListBoxIndicator* Value);
...
protected:
	...
	AnsiString __fastcall DrawHTMLText(Advgdip::TGPGraphics* g, TAdvSmoothImageListBoxHTMLText* HTML, const Advgdip::TGPRectF &r, AnsiString str, bool DoAnchor = false, int fX = 0xffffffff, int fY = 0xffffffff);
	void __fastcall DrawText(Advgdip::TGPGraphics* g, TAdvSmoothImageListBoxHTMLText* HTML, const Advgdip::TGPRectF &r, AnsiString str);
	Advgdip::TGPRectF __fastcall GetHeaderTextRect();
	Advgdip::TGPRectF __fastcall GetFooterTextRect();
	virtual void __fastcall SelectImage(Word Key, int &itemindex, bool itemselect);
	void __fastcall GetAspectSize(int &w, int &h, double ow, double oh, double nw, double nh);
	void __fastcall InitPreview(void);
	void __fastcall Navigate(Word Key, Classes::TShiftState Shift);
	...
	Advgdip::TGPRectF __fastcall GetTextRect(Advgdip::TGPGraphics* g, TAdvSmoothImageListBoxHTMLText* HTML, const Advgdip::TGPRectF &r, AnsiString str);
	Advgdip::TGPRectF __fastcall GetHTMLTextRect(Advgdip::TGPGraphics* g, TAdvSmoothImageListBoxHTMLText* HTML, const Advgdip::TGPRectF &r, AnsiString str);
	...
	Advgdip::TGPRectF __fastcall GetDisplayRectangle();
	AnsiString __fastcall GetStrippedHTMLText(TAdvSmoothImageListBoxHTMLText* HTML);
	bool __fastcall ProcessKeyDown(Word Key, int &itemindex);
...
public:
	TAdvSmoothImageListBoxTopLayerItem* __fastcall XYToTopLayerItem(int X, int Y);
	__property int ClickMargin = {read=FClickMargin, write=FClickMargin, nodefault};
	__property bool ScrollBarDoubleBuffered = {read=GetScrollBarDoubleBuffered, write=SetScrollBarDoubleBuffered, default=1};
	...
	void __fastcall AddImagesFromFolder(AnsiString AFolder, bool SetImageCaption = false, bool SetImageHint = false, bool NoExt = false);
	void __fastcall AddImageLocationsFromFolder(AnsiString AFolder, bool SetImageCaption = false, bool SetImageHint = false, bool NoExt = false);
	void __fastcall Highlight(bool DoCase, AnsiString HiText);
	void __fastcall UnHighlight(void);
	void __fastcall Mark(bool DoCase, AnsiString HiText);
...
__published:
	__property TAdvSmoothImageListBoxScrollType ScrollType = {read=FScrollType, write=SetScrollType, nodefault};
	__property TAdvSmoothImageListBoxTopLayerItemClick OnTopLayerItemClick = {read=FOnTopLayerItemClick, write=FOnTopLayerItemClick};
	__property bool AutoHideNavigator = {read=FAutoHideNavigator, write=SetAutoHideNavigator, default=0};
	...
	__property TAdvSmoothImageListBoxCachedImageLoaded OnCachedImageLoaded = {read=FOnCachedImageLoaded, write=FOnCachedImageLoaded};
	...
	__property TAdvSmoothImageListBoxIndicator* ScrollIndicator = {read=FScrollIndicator, write=SetScrollIndicator};
...
protected:
	...
	Advgdip::TGPRectF __fastcall GetRectangle(const Advgdip::TGPRectF &r);
...
private:
	...
	int FPixelDepth;
	int FPixelFormat;
	int FThreadedImageHeight;
	int FThreadedImageWidth;
	...
	void __fastcall SetSplitterText(const AnsiString Value);
...
protected:
	...
	void __fastcall SetInternalCaptionText(AnsiString Value);
...
public:
	...
	Advgdip::TGPRectF __fastcall GetImageRectangle();
	__property Advgdip::TGPImage* ThreadedImage = {read=FCachedNormal};
	__property int ThreadedImageWidth = {read=FThreadedImageWidth, write=FThreadedImageWidth, default=0};
	__property int ThreadedImageHeight = {read=FThreadedImageHeight, write=FThreadedImageHeight, default=0};
...
__published:
	...
	__property AnsiString SplitterText = {read=FSplitterText, write=SetSplitterText};
...
private:
	...
	Advgdip::TGPRectF FRectangleOrig;
...
public:
	...
	__property Advgdip::TGPRectF RectangleOrig = {read=FRectangleOrig, write=FRectangleOrig};
public:
	#pragma option push -w-inl
