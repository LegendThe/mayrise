...
// (DO NOT EDIT: machine generated header) 'Advsmoothexpanderpanel.pas' rev: 11.00
...
private:
	...
	Classes::TNotifyEvent FOnStartExpandPanel;
	Classes::TNotifyEvent FOnEndExpandPanel;
	Classes::TNotifyEvent FOnStartCollapsePanel;
	Classes::TNotifyEvent FOnEndCollapsePanel;
...
protected:
	...
	virtual void __fastcall DrawExpander(Advgdip::TGPGraphics* g, const Advgdip::TGPRectF &r, bool Down, bool Hover);
	Types::TRect __fastcall InsideRect();
	Advgdip::TGPRectF __fastcall GetExpanderRect();
	...
	virtual void __fastcall GDIPPaint(Advgdip::TGPGraphics* g)/* overload */;
...
__published:
	...
	__property Classes::TNotifyEvent OnStartExpandPanel = {read=FOnStartExpandPanel, write=FOnStartExpandPanel};
	__property Classes::TNotifyEvent OnEndExpandPanel = {read=FOnEndExpandPanel, write=FOnEndExpandPanel};
	__property Classes::TNotifyEvent OnStartCollapsePanel = {read=FOnStartCollapsePanel, write=FOnStartCollapsePanel};
	__property Classes::TNotifyEvent OnEndCollapsePanel = {read=FOnEndCollapsePanel, write=FOnEndCollapsePanel};
public:
