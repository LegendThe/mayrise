...
// (DO NOT EDIT: machine generated header) 'Advdropdownreg.pas' rev: 11.00

#ifndef AdvdropdownregHPP
#define AdvdropdownregHPP
...
using namespace Advdropdownreg;
#pragma pack(pop)
#pragma option pop

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// Advdropdownreg
