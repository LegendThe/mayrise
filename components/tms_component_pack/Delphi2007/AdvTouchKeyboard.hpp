...
// (DO NOT EDIT: machine generated header) 'Advtouchkeyboard.pas' rev: 11.00
...
enum TSpecialKey { skNone, skAlt, skAltGr, skShift, skCaps, skCtrl, skNum, skScroll, skReturn, skAdd, skDivide, skDecimal, skSubstract, skMultiply, skTab, skWin, skApp, skBackSpace, skSpaceBar, skLeft, skRight, skUp, skDown, skNext, skPrior, skHome, skEnd, skF1, skF2, skF3, skF4, skF5, skF6, skF7, skF8, skF9, skF10, skF11, skF12 };
#pragma option pop
...
private:
	...
	bool __fastcall GetAutoPost(void);
...
__published:
	__property Left ;
	__property Top ;
	__property bool AutoPost = {read=FAutoPost, write=FAutoPost, default=1};
...
private:
	...
	Types::TRect __fastcall GetKeyboardRect();
...
public:
	...
	__property Types::TRect KeyboardRect = {read=GetKeyboardRect};
...
static const Shortint REL_VER = 0xb;
