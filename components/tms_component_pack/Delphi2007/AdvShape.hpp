...
// (DO NOT EDIT: machine generated header) 'Advshape.pas' rev: 11.00
...
private:
	...
	void __fastcall SetMaxSize(const bool Value);
...
protected:
	...
	Types::TRect __fastcall ShapeRect();
	TPointArray __fastcall GetBoundsPts();
	TPointArray __fastcall GetSurroundRgn();
	HRGN __fastcall GetShapeClipRegion(void);
	TPointArray __fastcall SurroundRgn();
...
__published:
	...
	__property bool MaxSize = {read=FMaxSize, write=SetMaxSize, default=1};
