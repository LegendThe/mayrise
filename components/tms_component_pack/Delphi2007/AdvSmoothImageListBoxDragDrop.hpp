...
// (DO NOT EDIT: machine generated header) 'Advsmoothimagelistboxdragdrop.pas' rev: 11.00

#ifndef AdvsmoothimagelistboxdragdropHPP
#define AdvsmoothimagelistboxdragdropHPP
...
namespace Advsmoothimagelistboxdragdrop
{
//-- type declarations -------------------------------------------------------
...
class DELPHICLASS TImageListBoxDropTarget;
class PASCALIMPLEMENTATION TImageListBoxDropTarget : public System::TInterfacedObject 
{
...
public:
	__fastcall TImageListBoxDropTarget(void);
...
public:
	...
	/* TObject.Destroy */ inline __fastcall virtual ~TImageListBoxDropTarget(void) { }
	#pragma option pop
...
class DELPHICLASS TImageListBoxDropSource;
class PASCALIMPLEMENTATION TImageListBoxDropSource : public System::TInterfacedObject 
{
	typedef System::TInterfacedObject inherited;
...
public:
	__fastcall TImageListBoxDropSource(void);
...
public:
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TImageListBoxDropSource(void) { }
	#pragma option pop
...
extern PACKAGE HRESULT __fastcall StartTextDoDragDrop(TImageListBoxDropSource* DropSource, AnsiString stxt, AnsiString srtf, int dwOKEffects, int &dwEffect);
extern PACKAGE HRESULT __fastcall StartColDoDragDrop(TImageListBoxDropSource* DropSource, int column, int dwOKEffects, int &dwEffect);

}	/* namespace Advsmoothimagelistboxdragdrop */
using namespace Advsmoothimagelistboxdragdrop;
#pragma pack(pop)
#pragma option pop

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// Advsmoothimagelistboxdragdrop
