...
// (DO NOT EDIT: machine generated header) 'Advsmoothspinner.pas' rev: 11.00
...
typedef void __fastcall (__closure *TAdvSmoothSpinnerColumnHintEvent)(System::TObject* Sender, int Column, AnsiString Hint);
