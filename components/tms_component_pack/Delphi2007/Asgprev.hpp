...
// (DO NOT EDIT: machine generated header) 'Asgprev.pas' rev: 11.00
...
__published:
	...
	__property AnsiString DialogCaption = {read=FDlgCaption, write=FDlgCaption};
	__property AnsiString DialogPrevBtn = {read=FDlgPrev, write=FDlgPrev};
	__property AnsiString DialogNextBtn = {read=FDlgNext, write=FDlgNext};
	__property AnsiString DialogPrintBtn = {read=FDlgPrint, write=FDlgPrint};
	__property AnsiString DialogCloseBtn = {read=FDlgClose, write=FDlgClose};
