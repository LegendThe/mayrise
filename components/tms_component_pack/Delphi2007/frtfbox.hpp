...
// (DO NOT EDIT: machine generated header) 'Frtfbox.pas' rev: 11.00
...
__published:
	...
	void __fastcall RTFControlKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
	void __fastcall RTFControlKeyPress(System::TObject* Sender, char &Key);
