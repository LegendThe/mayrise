...
// (DO NOT EDIT: machine generated header) 'Advpolypager.pas' rev: 11.00
...
private:
	...
	bool Ffocused;
	int FPageMargin;
	Gdipcustomitem::TCustomItem* FDownItem;
	int FOffSetY;
	int FOffSetX;
...
protected:
	...
	Types::TRect __fastcall GetPolyRect();
...
public:
	...
	int __fastcall AddAdvPolyPage(AnsiString PageCaption, Gdipcustomitem::TCustomItem* Item = (Gdipcustomitem::TCustomItem*)(0x0))/* overload */;
...
__published:
	__property int ListWidth = {read=GetListWidth, write=SetListWidth, nodefault};
