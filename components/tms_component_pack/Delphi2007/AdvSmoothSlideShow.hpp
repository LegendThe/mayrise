...
// (DO NOT EDIT: machine generated header) 'Advsmoothslideshow.pas' rev: 11.00
...
__published:
	...
	__property Byte Opacity = {read=FOpacity, write=SetOpacity, default=200};
...
typedef void __fastcall (__closure *TSlideShowHintEvent)(System::TObject* Sender, int itemindex, AnsiString &Hint);

#pragma option push -b-
enum TSlideShowItemKind { ikImage, ikControl, ikText, ikImageText, ikCustom };
#pragma option pop
...
typedef void __fastcall (__closure *TSlideShowControlCustomDrawEvent)(System::TObject* Sender, Controls::TControl* Control, int itemindex, Graphics::TBitmap* bmp);
...
private:
	...
	bool FDesignTime;
	int FUpdateCount;
	float FColorMatrix[5][5];
	bool FDoAnimation;
	bool FAnimatePlaceHolder;
	bool FAnimateImage;
	bool FAnimating;
	Advgdip::TGPRectF FCurrentPlaceHolder;
	Byte FCurrentOpacityTo;
	Byte FNextOpacityTo;
	Byte FCurrentOpacity;
	Byte FNextOpacity;
	...
	int FStretchPercentage;
	TSlideShowControlCustomDrawEvent FOnCustomDrawControl;
	...
	void __fastcall SetShowDescription(const bool Value);
	void __fastcall SetStretchPercentage(const int Value);
	int __fastcall GetFadeAnimationFactor(void);
...
protected:
	...
	Advgdip::TGPRectF __fastcall GetThumbNailRect();
	Types::TRect __fastcall GetThumbNailRectangle();
	...
	Advgdip::TGPRectF __fastcall GetHandleHorzLeft();
	Advgdip::TGPRectF __fastcall GetHandleHorzRight();
	Advgdip::TGPRectF __fastcall GetHandleVertTop();
	Advgdip::TGPRectF __fastcall GetHandleVertBottom();
...
public:
	__property Advgdip::TGPRectF CurrentPlaceHolder = {read=FCurrentPlaceHolder};
	__fastcall virtual TAdvSmoothSlideShow(Classes::TComponent* AOwner);
	__fastcall virtual ~TAdvSmoothSlideShow(void);
	virtual void __fastcall Paint(void);
	DYNAMIC void __fastcall Resize(void);
	void __fastcall AddItemsFromFolder(AnsiString AFolder, TSlideShowItemKind AKind, bool DescriptionLocation = false, bool CaptionLocation = false, bool LocationThumbHint = false);
...
__published:
	__property bool ShowDescription = {read=FShowDescription, write=SetShowDescription, default=1};
	__property int FadeAnimationFactor = {read=GetFadeAnimationFactor, write=SetFadeAnimationFactor, default=6};
	...
	__property int StretchPercentage = {read=FStretchPercentage, write=SetStretchPercentage, default=100};
	__property TSlideShowControlCustomDrawEvent OnCustomDrawControl = {read=FOnCustomDrawControl, write=FOnCustomDrawControl};
...
#pragma option push -b-
enum TImageThreadStatus { stNone, stInitialized, stLoading, stLoaded };
#pragma option pop
...
protected:
	...
	void __fastcall DrawPlaceHolder(Advgdip::TGPGraphics* g, const Advgdip::TGPRectF &R, Byte Opacity);
	void __fastcall DrawItem(Advgdip::TGPGraphics* g, const Advgdip::TGPRectF &R, Byte Opacity);
	void __fastcall DrawDescription(Advgdip::TGPGraphics* g, const Advgdip::TGPRectF &R, Byte Opacity);
	void __fastcall GetAspectSize(double &w, double &h, double ow, double oh, double nw, double nh, int f);
	
public:
	__property Advgdip::TGPRectF PlaceHolderRect = {read=FPlaceHolderRect};
