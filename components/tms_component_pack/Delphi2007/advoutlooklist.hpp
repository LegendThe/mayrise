...
typedef void __fastcall (__closure *THeaderHintEvent)(System::TObject* Sender, int ColumnIndex, AnsiString &AHint);
...
typedef void __fastcall (__closure *TOnGetGroupHintEvent)(TAdvOutlookList* Sender, Outlookgroupedlist::POGLItem Item, AnsiString &HintText);

typedef void __fastcall (__closure *TOnGetItemHintEvent)(TAdvOutlookList* Sender, Outlookgroupedlist::POGLItem Item, int ColumnIndex, AnsiString &HintText);
...
private:
	...
	Graphics::TColor FGroupLineColor;
	...
	void __fastcall OnListGetHint(Outlookgroupedlist::TOutlookGroupedList* Sender, Outlookgroupedlist::POGLItem Item, AnsiString &HintText, Types::TPoint &HintPos);
	...
	void __fastcall SetGroupLineColor(const Graphics::TColor Value);
...
public:
	...
	TOutlookGroup* __fastcall InsertGroup(int Index, AnsiString Caption);
	...
	void __fastcall MoveColumn(int FromColIndex, int ToColIndex);
	...
	void __fastcall SelectItem(Outlookgroupedlist::POGLItem Item, bool Focus = true);
	...
	void __fastcall ScrollList(int deltax, int deltay);
...
__published:
	...
	__property Graphics::TColor GroupLineColor = {read=FGroupLineColor, write=SetGroupLineColor, default=14722171};
