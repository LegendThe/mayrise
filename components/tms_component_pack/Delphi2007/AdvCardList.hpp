...
// (DO NOT EDIT: machine generated header) 'Advcardlist.pas' rev: 11.00
...
public:
	...
	/* Exception.Create */ inline __fastcall ECardTemplateError(const AnsiString Msg) : Sysutils::Exception(Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall ECardTemplateError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall ECardTemplateError(const AnsiString Msg, int AHelpContext) : Sysutils::Exception(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall ECardTemplateError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~ECardTemplateError(void) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* Exception.Create */ inline __fastcall ECardItemListError(const AnsiString Msg) : Sysutils::Exception(Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall ECardItemListError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall ECardItemListError(const AnsiString Msg, int AHelpContext) : Sysutils::Exception(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall ECardItemListError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~ECardItemListError(void) { }
	#pragma option pop
...
protected:
	void __fastcall ControlKeyDown(System::TObject* Sender, Word &Key, Classes::TShiftState Shift);
...
public:
	...
	virtual void __fastcall ValueToControl(const Variant &value) = 0 ;
	virtual Variant __fastcall ControlToValue(void) = 0 ;
...
public:
	__fastcall virtual TAdvCardTemplateItems(TAdvCardTemplate* CardTemplate, TMetaClass* ItemClass);
...
public:
	...
	virtual void __fastcall DropCard(const Types::TPoint &pt, AnsiString s);
...
typedef DynamicArray<TAdvButton* >  AdvCardList__32;
