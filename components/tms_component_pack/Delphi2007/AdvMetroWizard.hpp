...
// (DO NOT EDIT: machine generated header) 'Advmetrowizard.pas' rev: 11.00

#ifndef AdvmetrowizardHPP
#define AdvmetrowizardHPP
...
namespace Advmetrowizard
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TMetroApplicationWizard;
class PASCALIMPLEMENTATION TMetroApplicationWizard : public Toolsapi::TNotifierObject 
{
...
public:
	...
	/* TObject.Create */ inline __fastcall TMetroApplicationWizard(void) : Toolsapi::TNotifierObject() { }
	#pragma option pop
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TMetroApplicationWizard(void) { }
	#pragma option pop
...
class DELPHICLASS TMetroProjectCreator;
class PASCALIMPLEMENTATION TMetroProjectCreator : public Toolsapi::TNotifierObject 
{
	typedef Toolsapi::TNotifierObject inherited;
...
public:
	__fastcall TMetroProjectCreator(AnsiString ProjFile, AnsiString ProjectDir, AnsiString UnitName, AnsiString FormClass, AnsiString aFileName);
public:
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TMetroProjectCreator(void) { }
	#pragma option pop
...
class DELPHICLASS TMetroFrmWizard;
class PASCALIMPLEMENTATION TMetroFrmWizard : public Toolsapi::TNotifierObject 
{
	typedef Toolsapi::TNotifierObject inherited;
...
public:
	#pragma option push -w-inl
	/* TObject.Create */ inline __fastcall TMetroFrmWizard(void) : Toolsapi::TNotifierObject() { }
	#pragma option pop
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TMetroFrmWizard(void) { }
	#pragma option pop
...
class DELPHICLASS TMetroFrmStyleWizard;
class PASCALIMPLEMENTATION TMetroFrmStyleWizard : public Toolsapi::TNotifierObject 
{
	typedef Toolsapi::TNotifierObject inherited;
...
public:
	#pragma option push -w-inl
	/* TObject.Create */ inline __fastcall TMetroFrmStyleWizard(void) : Toolsapi::TNotifierObject() { }
	#pragma option pop
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TMetroFrmStyleWizard(void) { }
	#pragma option pop
...
class DELPHICLASS TMetroUnitCreator;
class PASCALIMPLEMENTATION TMetroUnitCreator : public Toolsapi::TNotifierObject 
{
	typedef Toolsapi::TNotifierObject inherited;
...
public:
	...
	__fastcall TMetroUnitCreator(Toolsapi::_di_IOTAModule AOwner, AnsiString UnitIdent, AnsiString ClassName, AnsiString aFileName, bool AIsMainForm);
public:
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TMetroUnitCreator(void) { }
	#pragma option pop
...
public:
	__fastcall TBaseFile(const AnsiString ModuleName, const AnsiString FormName, const AnsiString AncestorName);
public:
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TBaseFile.Create */ inline __fastcall TUnitFile(const AnsiString ModuleName, const AnsiString FormName, const AnsiString AncestorName) : TBaseFile(ModuleName, FormName, AncestorName) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TBaseFile.Create */ inline __fastcall TFormFile(const AnsiString ModuleName, const AnsiString FormName, const AnsiString AncestorName) : TBaseFile(ModuleName, FormName, AncestorName) { }
	#pragma option pop
...
class DELPHICLASS TMetroProjectFile;
class PASCALIMPLEMENTATION TMetroProjectFile : public Toolsapi::TNotifierObject 
{
	typedef Toolsapi::TNotifierObject inherited;
...
public:
	AnsiString __fastcall GetSource();
	System::TDateTime __fastcall GetAge(void);
	__fastcall TMetroProjectFile(AnsiString ProjName, AnsiString UnitName, AnsiString FormClass);
public:
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TMetroProjectFile(void) { }
	#pragma option pop
...
using namespace Advmetrowizard;
#pragma pack(pop)
#pragma option pop

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// Advmetrowizard
