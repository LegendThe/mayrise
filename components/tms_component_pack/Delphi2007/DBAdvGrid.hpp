...
typedef void __fastcall (__closure *TGetHTMLTemplateEvent)(System::TObject* Sender, int ACol, int ARow, AnsiString &HTMLTemplate, Db::TFields* Fields);
...
private:
	...
	TGetHTMLTemplateEvent FOnGetHTMLTemplate;
	bool FKeyDownAppend;
	...
	void __fastcall DoTQuerySort(int ACol);
...
protected:
	...
	HIDESBASE void __fastcall DoKeyDown(Word Key, Classes::TShiftState Shift);
	...
	virtual void __fastcall DoAutoRemoveColumns(bool removedefined);
	...
	virtual void __fastcall GetColFormat(int ACol, Advobj::TSortStyle &ASortStyle, AnsiString &aPrefix, AnsiString &aSuffix);
...
__published:
	...
	__property TGetHTMLTemplateEvent OnGetHTMLTemplate = {read=FOnGetHTMLTemplate, write=FOnGetHTMLTemplate};
...
protected:
	...
	int __fastcall GridColIndex(void);
