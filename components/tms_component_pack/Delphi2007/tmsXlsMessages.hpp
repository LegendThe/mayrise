...
// (DO NOT EDIT: machine generated header) 'Tmsxlsmessages.pas' rev: 11.00
...
extern PACKAGE Byte XlsImgConv[6];
extern PACKAGE Word XlsBlipHeaderConv[6];
extern PACKAGE Word XlsBlipSignConv[6];
...
extern PACKAGE void __fastcall IncMax(Word &X, int N, int Max);
extern PACKAGE void __fastcall IncLongWord(const PArrayOfByte Pdata, const int tPos, const __int64 Offset);
extern PACKAGE void __fastcall IncMaxMin(Word &X, int N, int Max, int Min);
extern PACKAGE Word __fastcall GetWord(const PArrayOfByte Pdata, const int tPos);
...
extern PACKAGE void __fastcall SetWord(const PArrayOfByte Pdata, const int tPos, const Word number);
...
extern PACKAGE void __fastcall GetSimpleString(const bool Length16Bit, const PArrayOfByte Pdata, const int tPos, const bool UseExtStrLen, const unsigned ExtStrLen, WideString &St, int &StSize);
extern PACKAGE bool __fastcall IsWide(const WideString W);
extern PACKAGE AnsiString __fastcall WideStringToStringNoCodePage(const WideString W);
extern PACKAGE void __fastcall CompressBestUnicode(const WideString w, const PArrayOfByte PData, const int PDataPos);
extern PACKAGE WideString __fastcall StringToWideStringNoCodePage(const AnsiString s);
