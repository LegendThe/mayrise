...
{ TAdvSpinEdit }
  ...
  published
    ...
    property CheckMinValue: boolean read FCheckMinValue write FCheckMinValue default true;
    property CheckMaxValue: boolean read FCheckMaxValue write FCheckMaxValue default true;
    property Color;
    property Ctl3D;
    property DragCursor;
    property DragMode;
