...
//    R2.Bottom := R2.Bottom - 1;
    ...
    if IsWin7 then
    begin
      DrawWin7Button(Canvas, MakeRect(0, 1, 55, 23), FAdvPreviewMenu.FMenuButtonBorderColor , FAdvPreviewMenu.FMenuButtonInnerBorderColor,
      ...
      if IsGlass then
      begin
        DrawGDIPText(Canvas, nil, taCenter, Bounds(0, 1, 55, 23), FAdvPreviewMenu.FMenuText, FAdvPreviewMenu.FMenuText, FAdvPreviewMenu.FMenuFont, true, true, aaClearType);
      end;

      if FAdvPreviewMenu.FMenuDefaultShape then
      begin
        DrawWin7Menu(Canvas, MakeRect(-1, 3, 55, 19), FAdvPreviewMenu.FMenuShapeColor);
      end;
