...
uses
  Windows, SysUtils,  Graphics, Grids, Classes, Controls, AdvStyleIF
...
type
  ...
  procedure DrawButton(Canvas: TCanvas; AHandle: THandle; ARect: TRect; AControlStyle: TControlDrawStyle; AState: TControlState; ATones: TColorTones);
