...
type
  ...
  private
    ...
    function TranslateDate( dt : TDateTime): longint;
  protected
...
function TUnTar.TranslateDate( dt : TDateTime) : longint;
begin
...
begin
   ...
   if outfileDir <> '' then outfileDir := outfileDir + '\';
   ...
   begin
      ...
      FileSetDate(outf.Handle, translateDate(FNextFile.timestamp));
      outf.Free
   end else
   begin
