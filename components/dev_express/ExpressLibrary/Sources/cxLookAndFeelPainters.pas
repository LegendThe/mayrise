...
type
  ...
  ['{7665926E-2C4B-48B9-F9F7-A21C4734EF39}']
    procedure PainterChanged(APainter: TcxCustomLookAndFeelPainterClass);
  end;

  TcxCustomLookAndFeelPainter = class
  protected
    class function DefaultDateNavigatorHeaderHighlightTextColor: TColor; virtual;
    ...
    class function GetSeparatorBounds(const R: TRect; AWidth: Integer; AIsVertical: Boolean): TRect; virtual;
  public
    class function LookAndFeelStyle: TcxLookAndFeelStyle; virtual;
    class function NeedRedrawOnResize: Boolean; virtual;
    ...
    class function DefaultVGridHeaderColor: TColor; virtual;
    class function DefaultVGridHeaderTextColor: TColor; virtual;
    class function DefaultVGridLineColor: TColor; virtual;

    class function DefaultDateNavigatorContentColor: TColor; virtual;
    class function DefaultDateNavigatorHeaderColor: TColor; virtual;
    class function DefaultDateNavigatorHeaderTextColor(AIsHighlight: Boolean): TColor; virtual;
    class function DefaultDateNavigatorHolydayTextColor: TColor; virtual;
    class function DefaultDateNavigatorInactiveTextColor: TColor; virtual;
    ...
    class function DefaultDateNavigatorSeparator1Color: TColor; virtual;
    class function DefaultDateNavigatorSeparator2Color: TColor; virtual;
    class function DefaultDateNavigatorTextColor: TColor; virtual;
    class function DefaultDateNavigatorTodayFrameColor: TColor; virtual;
    class function DefaultDateNavigatorTodayTextColor: TColor; virtual;
    ...
    class function DefaultSchedulerTimeRulerColor: TColor; virtual;
    class function DefaultSchedulerTimeRulerTextColor: TColor; virtual;
    ...
    class function DefaultRootTabsBackgroundColor: TColor; virtual;
    ...
    class procedure DrawSeparator(ACanvas: TcxCanvas; const R: TRect; AIsVertical: Boolean); virtual;
    // buttons
    ...
    class procedure DrawExpandButtonEx(ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState; AExpanded: Boolean; ARotationAngle: TcxRotationAngle = ra0); virtual;
    ...
    class procedure DrawGroupByBox(ACanvas: TcxCanvas; const ARect: TRect;
      ATransparent: Boolean; ABackgroundColor: TColor; const ABackgroundBitmap: TBitmap); virtual;
    class function GridGroupRowStyleOffice11ContentColor(AHasData: Boolean): TColor; virtual;
    class function GridGroupRowStyleOffice11SeparatorColor: TColor; virtual;
    class function GridGroupRowStyleOffice11TextColor: TColor; virtual;
    ...
    class procedure LayoutViewDrawRecordBorder(ACanvas: TcxCanvas; const ABounds: TRect;
      AState: TcxButtonState; ABorders: TcxBorders = []); virtual;
    ...
    class function LayoutViewGetPadding(AElement: TcxLayoutElement): TRect; virtual;
    class function LayoutViewGetSpacing(AElement: TcxLayoutElement): TRect; virtual;
    ...
    class procedure DrawFooterPanel(ACanvas: TcxCanvas; const ABounds: TRect;
    ...
    // PopupPanel
    class function PopupPanelSize: Integer;
    class procedure CalculatePopupPanelClientRect(
    ...
    class procedure DrawPopupNCPanel(AHandle: HWND;
    ...
    class procedure DrawPopupPanelBand(ACanvas: TcxCanvas;
    ...
    class procedure DrawSizeGrip(ACanvas: TcxCanvas; const ARect: TRect;
      ABackgroundColor: TColor = clDefault; ACorner: TdxCorner = coBottomRight); virtual;
    // SmallCloseButton
    class function SmallCloseButtonSize: TSize; virtual;
    class procedure DrawSmallCloseButton(ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState); virtual;
    // ms outlook
    ...
    // DateNavigator
    class procedure DrawDateNavigatorDateHeader(ACanvas: TcxCanvas; var R: TRect); virtual;
    // navigator
    ...
    class procedure DrawProgressBarText(ACanvas: TcxCanvas; AVertical, ASolid: Boolean;
    ...
    class function ProgressBarTextColorEx(AIsFilledArea: Boolean): TColor; virtual;
    // GroupBox
    ...
    class function GroupBoxTextColor(AEnabled: Boolean; ACaptionPosition: TcxGroupBoxCaptionPosition): TColor; virtual;
    ...
    // TrackBar
    class procedure CorrectThumbRect(ACanvas: TcxCanvas; var ARect: TRect; AHorizontal: Boolean; ATicks: TcxTrackBarTicksAlign); virtual;
    ...
    class procedure DrawTrackBarTrackBounds(ACanvas: TcxCanvas; const ARect: TRect); virtual;
    ...
    class procedure DrawTrackBarThumbBorderUpDown(ACanvas: TcxCanvas;
      const ALightPolyLine, AShadowPolyLine, ADarkPolyLine: TPointArray); virtual;
    class procedure DrawTrackBarThumbBorderBoth(ACanvas: TcxCanvas; const ARect: TRect); virtual;
    ...
    // Splitter
    class function GetSplitterInnerColor(AHighlighted: Boolean): TColor; virtual;
    class function GetSplitterOuterColor(AHighlighted: Boolean): TColor; virtual;
    ...
    // LayoutControl
    class function LayoutControlEmptyAreaColor: TColor; virtual;
    class procedure DrawLayoutControlBackground(ACanvas: TcxCanvas; const R: TRect); virtual;
    // Printing System
    class function PrintPreviewPageBordersWidth: TRect; virtual; 
    class procedure DrawPrintPreviewBackground(ACanvas: TcxCanvas; const R: TRect); virtual;
    ...
    // CalcEdit
    class function CalcEditButtonTextColor(AButtonKind: TcxCalcButtonKind): TColor; virtual;
    // Customization Form
    class function GetCustomizationFormListBackgroundColor: TColor; virtual;
  end;
  ...
  public
    ...
    // Splitter
    class function GetSplitterOuterColor(AHighlighted: Boolean): TColor; override;
  end;
  ...
  protected
    class function DefaultDateNavigatorHeaderHighlightTextColor: TColor; override;
    class procedure DrawContent(ACanvas: TcxCanvas; const ABounds, ATextAreaBounds: TRect; AState: Integer;
      AAlignmentHorz: TAlignment; AAlignmentVert: TcxAlignmentVert; AMultiLine, AShowEndEllipsis: Boolean;
      const AText: string; AFont: TFont; ATextColor, ABkColor: TColor;
  ...
  public
    class function LookAndFeelStyle: TcxLookAndFeelStyle; override;
    class function NeedRedrawOnResize: Boolean; override;
    ...
    // GroupBox
    class procedure DrawGroupBoxFrame(ACanvas: TcxCanvas; R: TRect;
    ...
    class procedure DrawDateNavigatorDateHeader(ACanvas: TcxCanvas; var R: TRect); override;
    // Splitter
    class function GetSplitterInnerColor(AHighlighted: Boolean): TColor; override;
    class function GetSplitterOuterColor(AHighlighted: Boolean): TColor; override;
    class function GetSplitterSize(AHorizontal: Boolean): TSize; override;
  end;
...
class function TcxCustomLookAndFeelPainter.DefaultDateNavigatorHeaderHighlightTextColor: TColor;
begin
...
class procedure TcxCustomLookAndFeelPainter.DrawFooterBorderEx(ACanvas: TcxCanvas;
...
class function TcxCustomLookAndFeelPainter.GetSeparatorBounds(const R: TRect; AWidth: Integer; AIsVertical: Boolean): TRect;
var
  P: TPoint;
begin
  P := cxRectCenter(R);
...
class function TcxCustomLookAndFeelPainter.NeedRedrawOnResize: Boolean;
begin
  Result := False;
end;
...
class function TcxCustomLookAndFeelPainter.DefaultDateNavigatorTextColor: TColor;
begin
   Result := clWindowText;
end;

class function TcxCustomLookAndFeelPainter.DefaultDateNavigatorHolydayTextColor: TColor;
begin
  Result := clRed;
end;

class function TcxCustomLookAndFeelPainter.DefaultDateNavigatorInactiveTextColor: TColor;
begin
  Result := clGrayText;
end;

class function TcxCustomLookAndFeelPainter.DefaultDateNavigatorSeparator1Color: TColor;
begin
  Result := clBtnShadow;
end;

class function TcxCustomLookAndFeelPainter.DefaultDateNavigatorSeparator2Color: TColor;
begin
  Result := clWindow;
end;

class function TcxCustomLookAndFeelPainter.DefaultDateNavigatorTodayFrameColor: TColor;
begin
  Result := clMaroon;
end;

class function TcxCustomLookAndFeelPainter.DefaultDateNavigatorTodayTextColor: TColor;
begin
  Result := clNavy;
end;

class function TcxCustomLookAndFeelPainter.DefaultDateNavigatorContentColor: TColor;
begin
...
class function TcxCustomLookAndFeelPainter.DefaultDateNavigatorHeaderTextColor(
...
class function TcxCustomLookAndFeelPainter.DefaultVGridHeaderColor: TColor;
begin
  Result := DefaultHeaderColor;
end;

class function TcxCustomLookAndFeelPainter.DefaultVGridHeaderTextColor: TColor;
begin
  Result := DefaultHeaderTextColor;
end;
...
class function TcxCustomLookAndFeelPainter.DefaultSchedulerTimeRulerColor: TColor;
begin
  Result := DefaultHeaderColor;
end;

class function TcxCustomLookAndFeelPainter.DefaultSchedulerTimeRulerTextColor: TColor;
begin
  Result := DefaultHeaderTextColor;
end;
...
class function TcxCustomLookAndFeelPainter.DefaultRootTabsBackgroundColor: TColor;
begin
  Result := clBtnFace;
end;
...
class procedure TcxCustomLookAndFeelPainter.DrawSeparator(ACanvas: TcxCanvas; const R: TRect; AIsVertical: Boolean);
begin
end;
...
class procedure TcxCustomLookAndFeelPainter.DrawExpandButtonEx(
...
class procedure TcxCustomLookAndFeelPainter.DrawFooterCellContent(ACanvas: TcxCanvas;
  const ABounds: TRect; AAlignmentHorz: TAlignment; AAlignmentVert: TcxAlignmentVert;
  AMultiLine: Boolean; const AText: string; AFont: TFont; ATextColor, ABkColor: TColor;
  AOnDrawBackground: TcxDrawBackgroundEvent = nil);
begin
...
class function TcxCustomLookAndFeelPainter.GridGroupRowStyleOffice11ContentColor(AHasData: Boolean): TColor;
begin
  if AHasData then
    Result := clWindow
  else
...
class function TcxCustomLookAndFeelPainter.GridGroupRowStyleOffice11SeparatorColor: TColor;
begin
  Result := dxOffice11GroupRowSeparatorColor;
end;

class function TcxCustomLookAndFeelPainter.GridGroupRowStyleOffice11TextColor: TColor;
begin
...
class function TcxCustomLookAndFeelPainter.LayoutViewGetPadding(AElement: TcxLayoutElement): TRect;
begin
  Result := cxNullRect;
end;

class function TcxCustomLookAndFeelPainter.LayoutViewGetSpacing(AElement: TcxLayoutElement): TRect;
begin
  Result := cxNullRect;
end;

class procedure TcxCustomLookAndFeelPainter.LayoutViewDrawItem(ACanvas: TcxCanvas; const ABounds: TRect;
...
class procedure TcxCustomLookAndFeelPainter.LayoutViewDrawRecordCaption(
...
class procedure TcxCustomLookAndFeelPainter.LayoutViewDrawRecordBorder(
  ACanvas: TcxCanvas; const ABounds: TRect;
  AState: TcxButtonState; ABorders: TcxBorders = []);
var
  ABorderColor: TColor;
...
class procedure TcxCustomLookAndFeelPainter.LayoutViewDrawRecordContent(
  ACanvas: TcxCanvas; const ABounds: TRect;
...
class procedure TcxCustomLookAndFeelPainter.LayoutViewDrawRecordExpandButton(ACanvas: TcxCanvas;
...
class procedure TcxCustomLookAndFeelPainter.DrawFooterPanel(ACanvas: TcxCanvas;
...
class procedure TcxCustomLookAndFeelPainter.DrawFooterBorder(ACanvas: TcxCanvas;
  const R: TRect);
begin
end;
...
class procedure TcxCustomLookAndFeelPainter.DrawScrollBarBackground(
...
class function TcxCustomLookAndFeelPainter.PopupPanelSize: Integer;
begin
...
class procedure TcxCustomLookAndFeelPainter.CalculatePopupPanelClientRect(
  var AClientRect, APanelRect, AGripRect, ACloseButtonRect: TRect;
  ACorner: TdxCorner; const ABorders, APanelBorders: TRect;
  APanelHeight: Integer = 0; AShowCloseButton: Boolean = True; AShowGripSize: Boolean = True);
...
class procedure TcxCustomLookAndFeelPainter.DrawPopupNCPanel(AHandle: HWND;
  AMouseAboveCloseButton, ACloseButtonIsTracking: Boolean; ACorner: TdxCorner;
  ACloseButtonRect, AGripRect: TRect; ABorderColor: TColor);
...
class procedure TcxCustomLookAndFeelPainter.DrawPopupPanelBand(ACanvas: TcxCanvas;
  const ABounds, AGripRect, ACloseButtonRect: TRect;
  AGripCorner: TdxCorner; ACloseButtonState: TcxButtonState;
  ABorders: TRect; ABorderColor: TColor;
...
class procedure TcxCustomLookAndFeelPainter.DoDrawSizeGrip(ACanvas: TcxCanvas;
  const ARect: TRect);
begin
...
class function TcxCustomLookAndFeelPainter.SmallCloseButtonSize: TSize;
begin
  Result := cxSize(FilterCloseButtonHeight, FilterCloseButtonHeight);
end;

class procedure TcxCustomLookAndFeelPainter.DrawSmallCloseButton(ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState);
begin
...
class function TcxCustomLookAndFeelPainter.SchedulerNavigationButtonTextColor(
...
class procedure TcxCustomLookAndFeelPainter.DrawEditorButton(
...
class procedure TcxCustomLookAndFeelPainter.DrawDateNavigatorDateHeader(
...
class procedure TcxCustomLookAndFeelPainter.DrawProgressBarChunk(
  ACanvas: TcxCanvas; ARect: TRect; AVertical: Boolean);
begin
end;

class procedure TcxCustomLookAndFeelPainter.DrawProgressBarText(
...
class procedure TcxCustomLookAndFeelPainter.DrawProgressBarBorder(
  ACanvas: TcxCanvas; ARect: TRect; AVertical: Boolean);
begin
end;
...
class function TcxCustomLookAndFeelPainter.ProgressBarTextColorEx(AIsFilledArea: Boolean): TColor;
begin
...
class procedure TcxCustomLookAndFeelPainter.DrawGroupBoxExpandButton(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState; AExpanded: Boolean; ARotationAngle: TcxRotationAngle = ra0);
begin
  DrawExpandButtonEx(ACanvas, R, AState, AExpanded, ARotationAngle);
end;

class procedure TcxCustomLookAndFeelPainter.DrawGroupBoxFrame(ACanvas: TcxCanvas;
...
class procedure TcxCustomLookAndFeelPainter.CorrectThumbRect(ACanvas: TcxCanvas;
  var ARect: TRect; AHorizontal: Boolean; ATicks: TcxTrackBarTicksAlign);
begin
  ExtendRect(ARect, Rect(0, 0, -1, -1));
end;

class procedure TcxCustomLookAndFeelPainter.DrawTrackBarTrack(ACanvas: TcxCanvas;
...
class procedure TcxCustomLookAndFeelPainter.DrawTrackBarTrackBounds(ACanvas: TcxCanvas; const ARect: TRect);
begin
...
class procedure TcxCustomLookAndFeelPainter.DrawTrackBarThumbBorderUpDown(ACanvas: TcxCanvas;
  const ALightPolyLine, AShadowPolyLine, ADarkPolyLine: TPointArray);
begin
//
end;

class procedure TcxCustomLookAndFeelPainter.DrawTrackBarThumbBorderBoth(ACanvas: TcxCanvas; const ARect: TRect);
begin
...
class function TcxCustomLookAndFeelPainter.GetSplitterInnerColor(AHighlighted: Boolean): TColor;
begin
  Result := clWhite;
end;

class function TcxCustomLookAndFeelPainter.GetSplitterOuterColor(AHighlighted: Boolean): TColor;
begin
  Result := clBtnShadow;
end;
...
class function TcxCustomLookAndFeelPainter.LayoutControlEmptyAreaColor: TColor;
begin
  Result := clBtnFace;
end;

class procedure TcxCustomLookAndFeelPainter.DrawLayoutControlBackground(
  ACanvas: TcxCanvas; const R: TRect);
begin
  ACanvas.FillRect(R, LayoutControlEmptyAreaColor);
end;

class function TcxCustomLookAndFeelPainter.PrintPreviewPageBordersWidth: TRect;
begin
  Result := Rect(2, 2, 4, 4);
end;

class procedure TcxCustomLookAndFeelPainter.DrawPrintPreviewBackground(
  ACanvas: TcxCanvas; const R: TRect);
begin
  ACanvas.FillRect(R, clBtnShadow);
end;

class procedure TcxCustomLookAndFeelPainter.DrawPrintPreviewPageBackground(
...
class function TcxCustomLookAndFeelPainter.CalcEditButtonTextColor(
...
class function TcxCustomLookAndFeelPainter.GetCustomizationFormListBackgroundColor: TColor;
begin
  Result := clBtnFace;
end;
...
class function TcxWinXPLookAndFeelPainter.NeedRedrawOnResize: Boolean;
begin
...
class procedure TcxWinXPLookAndFeelPainter.DrawSeparator(ACanvas: TcxCanvas; const R: TRect; AIsVertical: Boolean);
const
...
class procedure TcxWinXPLookAndFeelPainter.LayoutViewDrawRecordCaption(
  ACanvas: TcxCanvas; const ABounds: TRect;
  APosition: TcxGroupBoxCaptionPosition; AState: TcxButtonState);
begin
  LayoutViewDrawRecordBorder(ACanvas, ABounds, AState, cxBordersAll);
...
class procedure TcxWinXPLookAndFeelPainter.DrawSplitter(ACanvas: TcxCanvas; const ARect: TRect;
...
class function TcxWinXPLookAndFeelPainter.ScrollBarMinimalThumbSize(AVertical: Boolean): Integer;
...
class function TcxWinXPLookAndFeelPainter.SizeGripSize: TSize;
var
  ATheme: Cardinal;
begin
  ATheme := OpenTheme(totScrollBar);
...
class procedure TcxWinXPLookAndFeelPainter.DoDrawSizeGrip(ACanvas: TcxCanvas; const ARect: TRect);
var
  ATheme: Cardinal;
begin
  ATheme := OpenTheme(totScrollBar);
...
class function TcxWinXPLookAndFeelPainter.SmallCloseButtonSize: TSize;
var
  ATheme: TdxTheme;
begin
  ATheme := OpenTheme(totWindow);
...
class procedure TcxWinXPLookAndFeelPainter.DrawGroupBoxFrame(ACanvas: TcxCanvas;
  R: TRect; AEnabled: Boolean; ACaptionPosition: TcxGroupBoxCaptionPosition;
  ABorders: TcxBorders = cxBordersAll);
const
...
class function TcxWinXPLookAndFeelPainter.GroupBoxTextColor(AEnabled: Boolean; ACaptionPosition: TcxGroupBoxCaptionPosition): TColor;
const
...
class procedure TcxWinXPLookAndFeelPainter.DrawPanelBackground(ACanvas: TcxCanvas;
...
class procedure TcxWinXPLookAndFeelPainter.CorrectThumbRect(ACanvas: TcxCanvas;
  var ARect: TRect; AHorizontal: Boolean; ATicks: TcxTrackBarTicksAlign);
var
  ATheme: TdxTheme;
  AThumbSize: TSize;
...
class procedure TcxWinXPLookAndFeelPainter.DrawTrackBarTrack(ACanvas: TcxCanvas;
  const ARect, ASelection: TRect; AShowSelection, AEnabled, AHorizontal: Boolean; ATrackColor: TColor);
const
...
class procedure TcxWinXPLookAndFeelPainter.DrawTrackBarThumb(ACanvas: TcxCanvas;
...
class procedure TcxWinXPLookAndFeelPainter.DrawDateNavigatorDateHeader(
  ACanvas: TcxCanvas; var R: TRect);
begin
...
class procedure TcxStandardLookAndFeelPainter.DrawSeparator(ACanvas: TcxCanvas; const R: TRect; AIsVertical: Boolean);
var
  ABounds: TRect;
begin
...
class procedure TcxStandardLookAndFeelPainter.DrawFooterBorder(ACanvas: TcxCanvas;
  const R: TRect);
begin
...
class procedure TcxStandardLookAndFeelPainter.DrawGroupBoxFrame(ACanvas: TcxCanvas;
  R: TRect; AEnabled: Boolean; ACaptionPosition: TcxGroupBoxCaptionPosition;
  ABorders: TcxBorders = cxBordersAll);
begin
  Dec(R.Right);
...
class procedure TcxStandardLookAndFeelPainter.DrawTrackBarTrackBounds(ACanvas: TcxCanvas; const ARect: TRect);
var
  R: TRect;
begin
  R := ARect;
...
class procedure TcxStandardLookAndFeelPainter.DrawTrackBarThumbBorderUpDown(ACanvas: TcxCanvas;
  const ALightPolyLine, AShadowPolyLine, ADarkPolyLine: TPointArray);
begin
...
class procedure TcxStandardLookAndFeelPainter.DrawTrackBarThumbBorderBoth(ACanvas: TcxCanvas; const ARect: TRect);
var
  R: TRect;
begin
  R := ARect;
...
class procedure TcxFlatLookAndFeelPainter.DrawSeparator(ACanvas: TcxCanvas; const R: TRect; AIsVertical: Boolean);
begin
  TcxStandardLookAndFeelPainter.DrawSeparator(ACanvas, R, AIsVertical);
end;
...
class procedure TcxFlatLookAndFeelPainter.DrawFooterBorder(ACanvas: TcxCanvas;
  const R: TRect);
begin
  ACanvas.DrawEdge(R, False, False);
end;
...
class procedure TcxFlatLookAndFeelPainter.DrawGroupBoxFrame(ACanvas: TcxCanvas;
  R: TRect; AEnabled: Boolean; ACaptionPosition: TcxGroupBoxCaptionPosition;
  ABorders: TcxBorders = cxBordersAll);
begin
  ACanvas.FrameRect(R, clBtnShadow, 1, ABorders, True);
...
class procedure TcxFlatLookAndFeelPainter.DrawTrackBarTrackBounds(ACanvas: TcxCanvas; const ARect: TRect);
var
  R: TRect;
begin
  R := ARect;
...
class procedure TcxFlatLookAndFeelPainter.DrawTrackBarThumbBorderUpDown(ACanvas: TcxCanvas;
  const ALightPolyLine, AShadowPolyLine, ADarkPolyLine: TPointArray);
begin
  ACanvas.Pen.Color := clBtnHighlight;
  ACanvas.Polyline(ALightPolyLine);
...
class procedure TcxFlatLookAndFeelPainter.DrawTrackBarThumbBorderBoth(ACanvas: TcxCanvas; const ARect: TRect);
begin
  ACanvas.DrawComplexFrame(ARect, clBtnHighlight, clBtnShadow)
end;

class procedure TcxFlatLookAndFeelPainter.DrawDateNavigatorDateHeader(
  ACanvas: TcxCanvas; var R: TRect);
begin
  ACanvas.FillRect(R, DefaultDateNavigatorHeaderColor);
...
class function TcxFlatLookAndFeelPainter.GetSplitterOuterColor(AHighlighted: Boolean): TColor;
begin
...
class procedure TcxUltraFlatLookAndFeelPainter.DrawSeparator(ACanvas: TcxCanvas; const R: TRect; AIsVertical: Boolean);
var
  ABounds: TRect;
begin
  ABounds := GetSeparatorBounds(R, BorderSize, AIsVertical);
...
class procedure TcxUltraFlatLookAndFeelPainter.DrawFooterBorderEx(ACanvas: TcxCanvas;
  const R: TRect; ABorders: TcxBorders);
begin
...
class procedure TcxUltraFlatLookAndFeelPainter.DrawGroupBoxFrame(ACanvas: TcxCanvas;
  R: TRect; AEnabled: Boolean; ACaptionPosition: TcxGroupBoxCaptionPosition;
  ABorders: TcxBorders = cxBordersAll);
const
...
class procedure TcxUltraFlatLookAndFeelPainter.DrawTrackBarTrackBounds(ACanvas: TcxCanvas; const ARect: TRect);
begin
  ACanvas.FrameRect(ARect, clWindowText);
end;

class procedure TcxUltraFlatLookAndFeelPainter.DrawTrackBarThumbBorderUpDown(ACanvas: TcxCanvas;
  const ALightPolyLine, AShadowPolyLine, ADarkPolyLine: TPointArray);
begin
...
class procedure TcxUltraFlatLookAndFeelPainter.DrawTrackBarThumbBorderBoth(ACanvas: TcxCanvas; const ARect: TRect);
begin
  ACanvas.FrameRect(ARect, clWindowText);
end;

class procedure TcxUltraFlatLookAndFeelPainter.DrawPrintPreviewBackground(
  ACanvas: TcxCanvas; const R: TRect); 
...
class function TcxUltraFlatLookAndFeelPainter.GetSplitterOuterColor(AHighlighted: Boolean): TColor;
begin
  if AHighlighted then
    Result := clHighlight
  else
...
class function TcxUltraFlatLookAndFeelPainter.GetSplitterSize(AHorizontal: Boolean): TSize;
begin
...
class function TcxOffice11LookAndFeelPainter.NeedRedrawOnResize: Boolean;
begin
  Result := True;
end;
...
class procedure TcxOffice11LookAndFeelPainter.DrawSeparator(ACanvas: TcxCanvas; const R: TRect; AIsVertical: Boolean);
var
  ABounds: TRect;
begin
...
class procedure TcxOffice11LookAndFeelPainter.LayoutViewDrawRecordCaption(
  ACanvas: TcxCanvas; const ABounds: TRect;
  APosition: TcxGroupBoxCaptionPosition; AState: TcxButtonState);
begin
  LayoutViewDrawRecordBorder(ACanvas, ABounds, AState, cxBordersAll);
...
class procedure TcxOffice11LookAndFeelPainter.DoDrawSizeGrip(ACanvas: TcxCanvas;
  const ARect: TRect);
begin
...
class function TcxOffice11LookAndFeelPainter.DefaultDateNavigatorHeaderHighlightTextColor: TColor;
begin
  Result := clHighlightText;
end;
...
class procedure TcxOffice11LookAndFeelPainter.DrawGroupBoxFrame(ACanvas: TcxCanvas;
  R: TRect; AEnabled: Boolean; ACaptionPosition: TcxGroupBoxCaptionPosition;
  ABorders: TcxBorders = cxBordersAll);
begin
  if AreVisualStylesAvailable([totButton]) then
    TcxWinXPLookAndFeelPainter.DrawGroupBoxFrame(ACanvas, R, AEnabled, ACaptionPosition, ABorders)
  else
    inherited DrawGroupBoxFrame(ACanvas, R, AEnabled, ACaptionPosition, ABorders);
end;

class function TcxOffice11LookAndFeelPainter.GroupBoxTextColor(
  AEnabled: Boolean; ACaptionPosition: TcxGroupBoxCaptionPosition): TColor;
begin
  if AreVisualStylesAvailable([totButton]) then
    Result := TcxWinXPLookAndFeelPainter.GroupBoxTextColor(AEnabled, ACaptionPosition)
  else
    Result := inherited GroupBoxTextColor(AEnabled, ACaptionPosition);
end;

class procedure TcxOffice11LookAndFeelPainter.DrawTrackBarTrackBounds(ACanvas: TcxCanvas; const ARect: TRect);
begin
  ACanvas.FrameRect(ARect, clBtnText);
end;

class procedure TcxOffice11LookAndFeelPainter.DrawTrackBarThumbBorderUpDown(ACanvas: TcxCanvas;
  const ALightPolyLine, AShadowPolyLine, ADarkPolyLine: TPointArray);
begin
  ACanvas.Pen.Color := clBtnText;
  ACanvas.Polyline(ALightPolyLine);
...
class procedure TcxOffice11LookAndFeelPainter.DrawTrackBarThumbBorderBoth(ACanvas: TcxCanvas; const ARect: TRect);
begin
  ACanvas.FrameRect(ARect, clBtnText);
end;
...
class procedure TcxOffice11LookAndFeelPainter.DrawLayoutControlBackground(
  ACanvas: TcxCanvas; const R: TRect);
begin
...
class procedure TcxOffice11LookAndFeelPainter.DrawDateNavigatorDateHeader(
  ACanvas: TcxCanvas; var R: TRect);
begin
  ACanvas.FillRect(R, DefaultDateNavigatorHeaderColor);
end;

class function TcxOffice11LookAndFeelPainter.GetSplitterInnerColor(AHighlighted: Boolean): TColor;
begin
  Result := dxOffice11BarSeparatorColor2;
end;

class function TcxOffice11LookAndFeelPainter.GetSplitterOuterColor(AHighlighted: Boolean): TColor;
begin
  if AHighlighted then
    Result := dxOffice11SelectedBorderColor
  else
...
class function TcxOffice11LookAndFeelPainter.GetSplitterSize(AHorizontal: Boolean): TSize;
begin
  Result := TcxStandardLookAndFeelPainter.GetSplitterSize(AHorizontal);
end;
