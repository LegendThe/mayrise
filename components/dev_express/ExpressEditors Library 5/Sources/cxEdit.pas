...
//    property GradientButtons;
  ...
  TcxCustomEditContainer = class(TcxContainer);
...
var
  ...
  begin
    ...
    cxDrawImage(ACanvas.Handle, cxRectBounds(AGlyphPosition.X, AGlyphPosition.Y, AGlyph.Width, AGlyph.Height), AContentRect,
      AGlyph, nil, -1, EnabledImageDrawModeMap[AButtonViewInfo.Data.State = ebsDisabled]);
  end;
...
procedure TcxCustomEditViewInfo.DrawEditButton(ACanvas: TcxCanvas;
  ...
  begin
    Result := (ButtonsInfo[AButtonVisibleIndex].Data.Kind = bkGlyph) and
      IsGlyphAssigned(ButtonsInfo[AButtonVisibleIndex].Glyph) or UseSkins;
  end;
...
procedure TcxCustomEditViewInfo.DrawUsualButtonBackground(ACanvas: TcxCanvas; AButtonViewInfo: TcxEditButtonViewInfo; const ARect: TRect; ABrushColor: TColor);
  ...
  begin
    AGradientDrawing := (AButtonViewInfo.Data.Style = btsOffice11) and
      ...
      (AButtonViewInfo.Data.State <> ebsDisabled) and not UseSkins;
...
procedure TcxDefaultEditStyleController.DefineProperties(Filer: TFiler);
begin
...
procedure TcxDefaultEditStyleController.ReadPixelsPerInch(Reader: TReader);
begin
  DefaultEditStyleController.PixelsPerInch := Reader.ReadInteger;
end;
...
procedure TcxDefaultEditStyleController.WritePixelsPerInch(Writer: TWriter);
begin
