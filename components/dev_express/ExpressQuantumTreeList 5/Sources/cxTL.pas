...
begin
  ...
  if (AImages <> nil) and cxInRange(ImageIndex, 0, AImages.Count - 1) then
    DoDrawImage(ACanvas, AImageAreaRect, Bitmap, AImages, ImageIndex, EnabledImageDrawModeMap[Enabled])
  else
    if Checked then
...
var
  ACF48FB75956621A29A8FF65069448E6E: TcxTreeListNode;
begin
  if (FocusedNode = nil) and (FocusedNodeIndex >= 0) then
  begin
    ACF48FB75956621A29A8FF65069448E6E := FindNearestFocusableNode(FocusedNodeIndex);
    if ACF48FB75956621A29A8FF65069448E6E <> nil then
      ACF48FB75956621A29A8FF65069448E6E.Focused := True;
  end;
end;
