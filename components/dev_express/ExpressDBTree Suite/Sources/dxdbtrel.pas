...
begin
  ...
  begin
    ...
    TcxFlatLookAndFeelPainter.CalculatePopupPanelClientRect(
      AClientRect, APanelRect, FGripRect, FCloseButtonRect, FCorner,
      cxRect(1, 1, 1, 1), GetSysPanelBorders);
...
begin
  inherited;
  if TCustomdxVTreeViewEdit(Owner).FListVisible then
    TcxFlatLookAndFeelPainter.DrawPopupNCPanel(Handle, FMouseAboveCloseButton,
      FCloseButtonIsTracking, FCorner, FCloseButtonRect, FGripRect, clWindowFrame);
end;
