...
var
  ...
  AC848C25D9266188A9D8FCF7826478A4D: TSQLTimeStamp;
begin
  case AField.DataType of
    ftString, ftGuid:
    ...
    ftTimeStamp:
    begin
      AC848C25D9266188A9D8FCF7826478A4D := GetTimeStampValue(ABuffer, AField);
      Result := VarSQLTimeStampCreate(AC848C25D9266188A9D8FCF7826478A4D);
    end;
    ftBCD:
    begin
