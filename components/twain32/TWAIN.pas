...
const CR_LF       : array[0..2] of char = (chr($0D), chr($0A), #0);
...
Type
  ...
  // Added 1.9
  TW_STR1024  = array[0..1026] of char;
  pTW_STR1024 = ^TW_STR1024;
  TW_UNI512   = array[0..255] of widechar;
...
type
 ...
 pTW_DECODEFUNCTION = ^TW_DECODEFUNCTION;
  ...
  Reserved        : TW_UINT32;
  // MCM 100898, Reserved above is the following union
  { union
      TW_UINT32 EOJ;
      TW_UINT32 Reserved;
  }
  ...
  // DAT_SETUPFILEXFER2. Sets up DS to app data transfer via a file.
  // Added 1.9
...
//------------------------------------------------------------------------------
  ...
  DAT_TWUNKIDENTITY      = $0000B; // TW_TWUNKIDENTITY
  ...
  // Added 1.9
  DAT_SETUPFILEXFER2     = $00301; // New file xfer operation
...
const
  ...
  TWRC_EXCEPTION         = 10; // (MCM) The source raised an exception.
