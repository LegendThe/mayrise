...
//----------------------------------------------------------------------------//
//
// $Log:  68829: uDSUserInterface.pas 
{
...
//const TwainApp = 'TWDSRC32'; // TWAIN drivers "application name".
...
type
  ...
  private
    ...
    procedure DoSendExit(var Msg    : TMessage);   message 1999;
  protected
  public
    { Public declarations }
    ...
    procedure GetSupportedCaps(Container : TtwnsContainer);
...
procedure TFormSource.GetSupportedCaps(Container : TtwnsContainer);
begin
...
begin
  ...
  then begin
       ...
       then begin
            ...
            pBmpInfo       := PBitmapInfo(@PChar(pBmpFileHeader)[SizeOf(TBitmapFileHeader)]);
            ...
            pBmp           := @PChar(pBmpFileHeader)[pBmpFileHeader^.bfoffBits];
            Result         := True;
       end;
  end;
