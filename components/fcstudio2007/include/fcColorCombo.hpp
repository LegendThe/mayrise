...
// (DO NOT EDIT: machine generated header) 'Fccolorcombo.pas' rev: 11.00
...
__published:
	...
	__property ColorAlignment  = {default=0};
	__property ColorMargin  = {default=2};
	...
	__property Font ;
	__property GreyScaleIncrement  = {default=15};
...
__published:
	...
	__property ColorDialogOptions  = {default=2};
