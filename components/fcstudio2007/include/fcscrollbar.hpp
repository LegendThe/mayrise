...
// (DO NOT EDIT: machine generated header) 'Fcscrollbar.pas' rev: 11.00
...
protected:
	...
	Types::TRect __fastcall GetSectionRect(TfcScrollBarHitTest Section, int DeltaX = 0x0, int DeltaY = 0x0);
