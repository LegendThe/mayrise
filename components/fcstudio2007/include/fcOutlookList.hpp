...
// (DO NOT EDIT: machine generated header) 'Fcoutlooklist.pas' rev: 11.00
...
public:
	TfcOutlookListItem* operator[](int Index) { return Items[Index]; }
...
public:
	...
	__property Graphics::TColor ItemDisabledTextColor = {read=FItemDisabledTextColor, write=SetItemDisabledTextColor, default=-16777201};
...
__published:
	...
	__property Images ;
	__property ItemDisabledTextColor  = {default=-16777201};
