...
// (DO NOT EDIT: machine generated header) 'Fctext.pas' rev: 11.00
...
__published:
	...
	__property Graphics::TColor ShadeColor = {read=FShadeColor, write=SetShadeColor, default=-16777200};
public:
...
__published:
	__property Graphics::TColor Color = {read=FColor, write=SetColor, default=-16777200};
	__property bool Enabled = {read=FEnabled, write=SetEnabled, default=0};
