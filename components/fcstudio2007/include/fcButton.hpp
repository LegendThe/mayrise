...
// (DO NOT EDIT: machine generated header) 'Fcbutton.pas' rev: 11.00
...
__published:
	__property Graphics::TColor Btn3DLight = {read=FBtn3dLight, write=SetBtn3DLight, default=-16777194};
	__property Graphics::TColor BtnHighlight = {read=FBtnHighlight, write=SetBtnHighlight, default=-16777196};
	__property Graphics::TColor BtnShadow = {read=FBtnShadow, write=SetBtnShadow, default=-16777200};
