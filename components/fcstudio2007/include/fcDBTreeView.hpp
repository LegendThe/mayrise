...
// (DO NOT EDIT: machine generated header) 'Fcdbtreeview.pas' rev: 11.00
...
typedef void __fastcall (__closure *TfcDBTreeSelectRecordEvent)(TfcDBCustomTreeView* TreeView, bool Selecting, bool &Accept);
...
private:
	...
	TfcDBTreeSelectRecordEvent FOnSelectRecord;
	int FLevelIndent;
...
public:
	...
	__property TfcDBTreeSelectRecordEvent OnMultiSelectRecord = {read=FOnSelectRecord, write=FOnSelectRecord};
...
__published:
	...
	__property Options  = {default=2018};
	...
	__property HideUpDownButtons  = {default=0};
