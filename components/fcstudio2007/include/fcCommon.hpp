...
// (DO NOT EDIT: machine generated header) 'Fccommon.pas' rev: 11.00
...
typedef TfcPolyGonPoints *PfcPolyGonPoints;
...
extern PACKAGE bool __fastcall fcIsVista(void);
extern PACKAGE void __fastcall fcFillEditThemeBackground(bool IsDroppedDown, bool MouseInControl, const Types::TRect &ARect, Graphics::TCanvas* FCanvas);
extern PACKAGE bool __fastcall fcIsVistaComCtrlVersion(void);
