...
// (DO NOT EDIT: machine generated header) 'Fccalculator.pas' rev: 11.00
...
protected:
	...
	virtual TButtonRecord __fastcall ButtonRecord(TfcCalcButtonType btnType, int aTop, int aLeft, int aWidth, int aHeight, AnsiString aCaption, Graphics::TColor aFontColor = (Graphics::TColor)(0x0), AnsiString aHint = "");
