...
// (DO NOT EDIT: machine generated header) 'Dfcstudiowin.pas' rev: 11.00

#ifndef DfcstudiowinHPP
#define DfcstudiowinHPP
...
#include <Fcfontcombo.hpp>	// Pascal unit
#include <Fccalculator.hpp>	// Pascal unit

//-- user supplied -----------------------------------------------------------

namespace Dfcstudiowin
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dfcstudiowin */
using namespace Dfcstudiowin;
#pragma pack(pop)
#pragma option pop
