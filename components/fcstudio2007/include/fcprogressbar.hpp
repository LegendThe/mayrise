...
// (DO NOT EDIT: machine generated header) 'Fcprogressbar.pas' rev: 11.00
...
__published:
	...
	__property Graphics::TColor BlockColor = {read=FBlockColor, write=SetBlockColor, default=-16777203};
