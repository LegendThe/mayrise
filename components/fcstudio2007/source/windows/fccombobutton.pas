...
//  TNumGlyphs = 1..4;
  ...
  protected
    ...
    function IsVistaTransparentButton: boolean; virtual;    
    function ParentMouseInControl: boolean; virtual;
    function ParentDroppedDown: boolean; virtual;
...
function TfcComboButton.IsVistaComboNonEditable: boolean;
begin
   result:= false;
end;

function TfcComboButton.IsVistaTransparentButton: boolean;
begin
   result:= false;
end;

function TfcComboButton.ParentMouseInControl: boolean;
begin
  result:=false;
end;

function TfcComboButton.ParentDroppedDown: boolean;
begin
  result:=false;
end;
...
//           if MouseInControl or (ParentMouseInControl and IsVista) then
       ...
       begin
         ...
         PaintRect.Right:= PaintRect.Right+1;
         PaintRect.Left:= PaintRect.Left+1;
         if fcIsVista then // Themes in vista for combo buttons are offset differntly
       ...
       if Glyph.Empty then
       begin
         if fcUseThemes(self) and fcIsVista then
         begin
            InflateRect(PaintRect, 1, 1);
