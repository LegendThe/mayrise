...
var
  ZippingOpenMode:word=fmOpenRead or fmShareDenyWrite;
//  ZippingOpenMode:word=fmOpenRead or fmShareDenyNone;
...
{!!OEM - End Added }
    ...
    {  OEMToAnsi(Buff, Buff);  }
    UncompressedStream := TFileStream.Create(StrPas(Buff),ZippingOpenMode);
